	...
	#define V_COMMIT_HASH "9553c5a"
#endif

#ifndef V_CURRENT_COMMIT_HASH
	#define V_CURRENT_COMMIT_HASH "086e9fd"
#endif
...
Option_void sqlite__DB_delete(sqlite__DB db, string table, orm__OrmQueryData where);
...
static inline Option_void sqlite__DB_delete_Interface_orm__OrmConnection_method_wrapper(sqlite__DB* db, string table, orm__OrmQueryData where) {
	return sqlite__DB_delete(*db, table, where);
}
static inline orm__Primitive sqlite__DB_last_id_Interface_orm__OrmConnection_method_wrapper(sqlite__DB* db) {
...
typedef Option_void (*_orm__OrmConnection_delete_fn)(void* _, string table, orm__OrmQueryData where);
...
typedef orm__Primitive (*_orm__OrmConnection_last_id_fn)(void* _);
...
struct _orm__OrmConnection_interface_methods {
	...
	_orm__OrmConnection_last_id_fn _method_last_id;
};
...
struct _orm__OrmConnection_interface_methods orm__OrmConnection_name_table[1] = {
	{
		...
		._method_last_id = (void*) sqlite__DB_last_id_Interface_orm__OrmConnection_method_wrapper,
...
static inline orm__Primitive time__Time_to_sumtype_orm__Primitive(time__Time* x) {
	...
	return (orm__Primitive){ ._time__Time = ptr, ._typ = 140};
}
...
VV_LOCAL_SYMBOL string orm__sql_field_name(orm__OrmTableField field) {
	...
	// FOR IN array
	for (int _t1349 = 0; _t1349 < field.attrs.len; ++_t1349) {
		StructAttribute attr = ((StructAttribute*)field.attrs.data)[_t1349];
...
orm__Primitive orm__bool_to_primitive(bool b) {
	orm__Primitive _t1351 = bool_to_sumtype_orm__Primitive(&b);
	return _t1351;
}

orm__Primitive orm__f32_to_primitive(f32 b) {
	orm__Primitive _t1352 = f32_to_sumtype_orm__Primitive(&b);
	return _t1352;
}

orm__Primitive orm__f64_to_primitive(f64 b) {
	orm__Primitive _t1353 = f64_to_sumtype_orm__Primitive(&b);
	return _t1353;
}

orm__Primitive orm__i8_to_primitive(i8 b) {
	orm__Primitive _t1354 = i8_to_sumtype_orm__Primitive(&b);
	return _t1354;
}

orm__Primitive orm__i16_to_primitive(i16 b) {
	orm__Primitive _t1355 = i16_to_sumtype_orm__Primitive(&b);
	return _t1355;
}

orm__Primitive orm__int_to_primitive(int b) {
	orm__Primitive _t1356 = int_to_sumtype_orm__Primitive(&b);
	return _t1356;
}

orm__Primitive orm__i64_to_primitive(i64 b) {
	orm__Primitive _t1357 = i64_to_sumtype_orm__Primitive(&b);
	return _t1357;
}

orm__Primitive orm__byte_to_primitive(byte b) {
	orm__Primitive _t1358 = byte_to_sumtype_orm__Primitive(&b);
	return _t1358;
}

orm__Primitive orm__u16_to_primitive(u16 b) {
	orm__Primitive _t1359 = u16_to_sumtype_orm__Primitive(&b);
	return _t1359;
}

orm__Primitive orm__u32_to_primitive(u32 b) {
	orm__Primitive _t1360 = u32_to_sumtype_orm__Primitive(&b);
	return _t1360;
}

orm__Primitive orm__u64_to_primitive(u64 b) {
	orm__Primitive _t1361 = u64_to_sumtype_orm__Primitive(&b);
	return _t1361;
}

orm__Primitive orm__string_to_primitive(string b) {
	orm__Primitive _t1362 = string_to_sumtype_orm__Primitive(&b);
	return _t1362;
}

orm__Primitive orm__time_to_primitive(time__Time b) {
	orm__Primitive _t1363 = time__Time_to_sumtype_orm__Primitive(&b);
	return _t1363;
}
...
bool sqlite__DB_select_defer_0 = false;
	...
	Option_sqlite__Stmt _t1364 = sqlite__DB_new_init_stmt(db, query);
	if (_t1364.state != 0) { /*or block*/ 
		Option_Array_Array_orm__Primitive _t1365;
		memcpy(&_t1365, &_t1364, sizeof(Option));
		return _t1365;
	}
 	sqlite__Stmt stmt =  (*(sqlite__Stmt*)_t1364.data);
	Option_void _t1366 = sqlite__sqlite_stmt_binder(stmt, data, query);
	...
	Option_void _t1368 = sqlite__sqlite_stmt_binder(stmt, where, query);
	if (_t1368.state != 0 && _t1368.err._typ != _IError_None___index) {
		Option_Array_Array_orm__Primitive _t1369;
		memcpy(&_t1369, &_t1368, sizeof(Option));
		return _t1369;
	};
	...
	if (config.is_count) {
		...
		if (!(step == _const_sqlite__sqlite_row || step == _const_sqlite__sqlite_ok || step == _const_sqlite__sqlite_done)) {
			Option_Array_Array_orm__Primitive _t1370 = (Option_Array_Array_orm__Primitive){ .state=2, .err=sqlite__DB_error_message(db, step, query), .data={0} };
			// Defer begin
		...
		Option_Array_Array_orm__Primitive _t1372;
		opt_ok(&(Array_Array_orm__Primitive[]) { ret }, (Option*)(&_t1372), sizeof(Array_Array_orm__Primitive));
		// Defer begin
		if (sqlite__DB_select_defer_0) {
			sqlite__Stmt_finalize(stmt);
		}
	...
	for (;;) {
		...
		for (int i = 0; i < config.types.len; ++i) {
			...
			Option_orm__Primitive _t1373 = sqlite__Stmt_sqlite_select_column(stmt, i, typ);
			if (_t1373.state != 0) { /*or block*/ 
			// Defer begin
			if (sqlite__DB_select_defer_0) {
				sqlite__Stmt_finalize(stmt);
			}
			// Defer end
				...
				memcpy(&_t1374, &_t1373, sizeof(Option));
				return _t1374;
			}
 			orm__Primitive primitive =  (*(orm__Primitive*)_t1373.data);
			array_push((array*)&row, _MOV((orm__Primitive[]){ primitive }));
		}
		array_push((array*)&ret, _MOV((Array_orm__Primitive[]){ row }));
	}
	Option_Array_Array_orm__Primitive _t1377;
	opt_ok(&(Array_Array_orm__Primitive[]) { ret }, (Option*)(&_t1377), sizeof(Array_Array_orm__Primitive));
	// Defer begin
	if (sqlite__DB_select_defer_0) {
		sqlite__Stmt_finalize(stmt);
	}
...
Option_void sqlite__DB_insert(sqlite__DB db, string table, orm__OrmQueryData data) {
	...
	Option_void _t1378 = sqlite__sqlite_stmt_worker(db, query, data, (orm__OrmQueryData){.fields = __new_array(0, 0, sizeof(string)),.data = __new_array(0, 0, sizeof(orm__Primitive)),.types = __new_array(0, 0, sizeof(int)),.kinds = __new_array(0, 0, sizeof(orm__OperationKind)),});
	if (_t1378.state != 0 && _t1378.err._typ != _IError_None___index) {
		Option_void _t1379;
		memcpy(&_t1379, &_t1378, sizeof(Option));
		return _t1379;
	};
	return (Option_void){0};
}
...
Option_void sqlite__DB_update(sqlite__DB db, string table, orm__OrmQueryData data, orm__OrmQueryData where) {
	...
	Option_void _t1380 = sqlite__sqlite_stmt_worker(db, query, data, where);
	if (_t1380.state != 0 && _t1380.err._typ != _IError_None___index) {
		Option_void _t1381;
		memcpy(&_t1381, &_t1380, sizeof(Option));
		return _t1381;
	};
	return (Option_void){0};
}
...
Option_void sqlite__DB_delete(sqlite__DB db, string table, orm__OrmQueryData where) {
	string query = orm__orm_stmt_gen(table, _SLIT("`"), orm__StmtKind_delete, true, _SLIT("?"), 1, (orm__OrmQueryData){.fields = __new_array(0, 0, sizeof(string)),.data = __new_array(0, 0, sizeof(orm__Primitive)),.types = __new_array(0, 0, sizeof(int)),.kinds = __new_array(0, 0, sizeof(orm__OperationKind)),}, where);
	Option_void _t1382 = sqlite__sqlite_stmt_worker(db, query, (orm__OrmQueryData){.fields = __new_array(0, 0, sizeof(string)),.data = __new_array(0, 0, sizeof(orm__Primitive)),.types = __new_array(0, 0, sizeof(int)),.kinds = __new_array(0, 0, sizeof(orm__OperationKind)),}, where);
	if (_t1382.state != 0 && _t1382.err._typ != _IError_None___index) {
		Option_void _t1383;
		memcpy(&_t1383, &_t1382, sizeof(Option));
		return _t1383;
	};
	return (Option_void){0};
}
...
orm__Primitive sqlite__DB_last_id(sqlite__DB db) {
	...
	orm__Primitive _t1384 = int_to_sumtype_orm__Primitive(&id);
	return _t1384;
}

Option_void sqlite__DB_create(sqlite__DB db, string table, Array_orm__OrmTableField fields) {
	Option_string _t1385 = orm__orm_table_gen(table, _SLIT("`"), true, 0, fields, (voidptr)sqlite__sqlite_type_from_v);
	if (_t1385.state != 0) { /*or block*/ 
		IError err = _t1385.err;
		return (Option_void){ .state=2, .err=err, .data={0} };
	}
 	string query =  (*(string*)_t1385.data);
	Option_void _t1387 = sqlite__sqlite_stmt_worker(db, query, (orm__OrmQueryData){.fields = __new_array(0, 0, sizeof(string)),.data = __new_array(0, 0, sizeof(orm__Primitive)),.types = __new_array(0, 0, sizeof(int)),.kinds = __new_array(0, 0, sizeof(orm__OperationKind)),}, (orm__OrmQueryData){.fields = __new_array(0, 0, sizeof(string)),.data = __new_array(0, 0, sizeof(orm__Primitive)),.types = __new_array(0, 0, sizeof(int)),.kinds = __new_array(0, 0, sizeof(orm__OperationKind)),});
...
Option_void sqlite__DB_drop(sqlite__DB db, string table) {
	...
	Option_void _t1389 = sqlite__sqlite_stmt_worker(db, query, (orm__OrmQueryData){.fields = __new_array(0, 0, sizeof(string)),.data = __new_array(0, 0, sizeof(orm__Primitive)),.types = __new_array(0, 0, sizeof(int)),.kinds = __new_array(0, 0, sizeof(orm__OperationKind)),}, (orm__OrmQueryData){.fields = __new_array(0, 0, sizeof(string)),.data = __new_array(0, 0, sizeof(orm__Primitive)),.types = __new_array(0, 0, sizeof(int)),.kinds = __new_array(0, 0, sizeof(orm__OperationKind)),});
...
VV_LOCAL_SYMBOL Option_void sqlite__sqlite_stmt_worker(sqlite__DB db, string query, orm__OrmQueryData data, orm__OrmQueryData where) {
	Option_sqlite__Stmt _t1391 = sqlite__DB_new_init_stmt(db, query);
	if (_t1391.state != 0) { /*or block*/ 
		Option_void _t1392;
		memcpy(&_t1392, &_t1391, sizeof(Option));
		return _t1392;
	}
 	sqlite__Stmt stmt =  (*(sqlite__Stmt*)_t1391.data);
	Option_void _t1393 = sqlite__sqlite_stmt_binder(stmt, data, query);
	if (_t1393.state != 0 && _t1393.err._typ != _IError_None___index) {
		Option_void _t1394;
		memcpy(&_t1394, &_t1393, sizeof(Option));
		return _t1394;
	};
	Option_void _t1395 = sqlite__sqlite_stmt_binder(stmt, where, query);
	if (_t1395.state != 0 && _t1395.err._typ != _IError_None___index) {
		Option_void _t1396;
		memcpy(&_t1396, &_t1395, sizeof(Option));
		return _t1396;
	};
	Option_void _t1397 = sqlite__Stmt_orm_step(stmt, query);
	if (_t1397.state != 0 && _t1397.err._typ != _IError_None___index) {
		Option_void _t1398;
		memcpy(&_t1398, &_t1397, sizeof(Option));
		return _t1398;
	};
	sqlite__Stmt_finalize(stmt);
	return (Option_void){0};
...
VV_LOCAL_SYMBOL Option_void sqlite__sqlite_stmt_binder(sqlite__Stmt stmt, orm__OrmQueryData d, string query) {
	int c = 1;
	// FOR IN array
	for (int _t1399 = 0; _t1399 < d.data.len; ++_t1399) {
		orm__Primitive data = ((orm__Primitive*)d.data.data)[_t1399];
		int err = 0;
		if (data._typ == 5 /* i8 */) {
		...
		else if (data._typ == 140 /* time.Time */) {
...
VV_LOCAL_SYMBOL Option_orm__Primitive sqlite__Stmt_sqlite_select_column(sqlite__Stmt stmt, int idx, int typ) {
	...
	Option_orm__Primitive _t1402;
	opt_ok(&(orm__Primitive[]) { primitive }, (Option*)(&_t1402), sizeof(orm__Primitive));
	return _t1402;
}

VV_LOCAL_SYMBOL Option_string sqlite__sqlite_type_from_v(int typ) {
	Option_string _t1404; /* if prepend */
	if ((Array_int_contains(_const_orm__nums, typ)) || typ < 0 || (Array_int_contains(_const_orm__num64, typ))) {
		opt_ok(&(string[]) { _SLIT("INTEGER") }, (Option*)(&_t1404), sizeof(string));
	} else if ((Array_int_contains(_const_orm__float, typ))) {
		opt_ok(&(string[]) { _SLIT("REAL") }, (Option*)(&_t1404), sizeof(string));
	} else if (typ == _const_orm__string) {
		opt_ok(&(string[]) { _SLIT("TEXT") }, (Option*)(&_t1404), sizeof(string));
	} else {
		_t1404.state = 2;
		_t1404.err = v_error( str_intp(2, _MOV((StrIntpData[]){{_SLIT("Unknown type "), 0xfe07, {.d_i32 = typ}}, {_SLIT0, 0, { .d_c = 0 }}})) );
	}
	Option_string _t1403 =  _t1404;
	return _t1403;
}

string sqlite__DB_str(sqlite__DB db) {
	string _t1405 = string__plus(string__plus(_SLIT("sqlite.DB{ conn: "), ptr_str(db.conn)), _SLIT(" }"));
	return _t1405;
}
...
Option_sqlite__DB sqlite__connect(string path) {
	...
	Option_sqlite__DB _t1407;
	opt_ok(&(sqlite__DB[]) { (sqlite__DB){.is_open = true,.conn = db,} }, (Option*)(&_t1407), sizeof(sqlite__DB));
	return _t1407;
}
...
Option_bool sqlite__DB_close(sqlite__DB* db) {
	...
	Option_bool _t1409;
	opt_ok(&(bool[]) { true }, (Option*)(&_t1409), sizeof(bool));
	return _t1409;
}
...
bool sqlite__DB_q_string_defer_0 = false;
	...
	string _t1412 = (val != ((byte*)(0)) ? (tos_clone(val)) : (_SLIT("")));
	// Defer begin
...
Option_sqlite__Row sqlite__DB_exec_one(sqlite__DB db, string query) {
	...
	Option_sqlite__Row _t1419;
	opt_ok(&(sqlite__Row[]) { (*(sqlite__Row*)/*ee elem_typ */array_get(rows, 0)) }, (Option*)(&_t1419), sizeof(sqlite__Row));
	return _t1419;
}

IError sqlite__DB_error_message(sqlite__DB db, int code, string query) {
	string msg = cstring_to_vstring(((char*)(sqlite3_errmsg(db.conn))));
	IError _t1420 = I_sqlite__SQLError_to_Interface_IError((sqlite__SQLError*)memdup(&(sqlite__SQLError){.msg =  str_intp(4, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = msg}}, {_SLIT(" ("), 0xfe07, {.d_i32 = code}}, {_SLIT(") ("), 0xfe10, {.d_s = query}}, {_SLIT(")"), 0, { .d_c = 0 }}})) ,.code = code,}, sizeof(sqlite__SQLError)));
	return _t1420;
}

int sqlite__DB_exec_none(sqlite__DB db, string query) {
	multi_return_Array_sqlite__Row_int mr_4750 = sqlite__DB_exec(db, query);
	int code = mr_4750.arg1;
	return code;
}
...
VV_LOCAL_SYMBOL Option_sqlite__Stmt sqlite__DB_new_init_stmt(sqlite__DB db, string query) {
	...
	if (err != _const_sqlite__sqlite_ok) {
		return (Option_sqlite__Stmt){ .state=2, .err=sqlite__DB_error_message(db, err, query), .data={0} };
	}
	Option_sqlite__Stmt _t1424;
	opt_ok(&(sqlite__Stmt[]) { (sqlite__Stmt){.stmt = stmt,.db = &db,} }, (Option*)(&_t1424), sizeof(sqlite__Stmt));
	return _t1424;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_bind_int(sqlite__Stmt stmt, int idx, int v) {
	int _t1425 = sqlite3_bind_int(stmt.stmt, idx, v);
	return _t1425;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_bind_i64(sqlite__Stmt stmt, int idx, i64 v) {
	int _t1426 = sqlite3_bind_int64(stmt.stmt, idx, v);
	return _t1426;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_bind_f64(sqlite__Stmt stmt, int idx, f64 v) {
	int _t1427 = sqlite3_bind_double(stmt.stmt, idx, v);
	return _t1427;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_bind_text(sqlite__Stmt stmt, int idx, string s) {
	int _t1428 = sqlite3_bind_text(stmt.stmt, idx, s.str, s.len, 0);
	return _t1428;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_get_int(sqlite__Stmt stmt, int idx) {
	int _t1429 = sqlite3_column_int(stmt.stmt, idx);
	return _t1429;
}

VV_LOCAL_SYMBOL i64 sqlite__Stmt_get_i64(sqlite__Stmt stmt, int idx) {
	i64 _t1430 = sqlite3_column_int64(stmt.stmt, idx);
	return _t1430;
}

VV_LOCAL_SYMBOL f64 sqlite__Stmt_get_f64(sqlite__Stmt stmt, int idx) {
	f64 _t1431 = sqlite3_column_double(stmt.stmt, idx);
	return _t1431;
}

VV_LOCAL_SYMBOL string sqlite__Stmt_get_text(sqlite__Stmt stmt, int idx) {
	byte* b = sqlite3_column_text(stmt.stmt, idx);
	string _t1432 = byte_vstring(b);
	return _t1432;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_get_count(sqlite__Stmt stmt) {
	int _t1433 = sqlite3_column_count(stmt.stmt);
	return _t1433;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_step(sqlite__Stmt stmt) {
	int _t1434 = sqlite3_step(stmt.stmt);
	return _t1434;
}
...
VV_LOCAL_SYMBOL bool main__can_use_relative_paths(void) {
	string _t1437 = os__getenv(_SLIT("VERROR_PATHS"));
		bool _t1436 = ((string__eq(_t1437, _SLIT("absolute"))) ? (false) : (true));
	return _t1436;
}
...
VV_LOCAL_SYMBOL void main__cb_propagate_test_error(int line_nr, string file, string mod, string fn_name, string errmsg) {
	...
	if (os__is_file(file)) {
		Option_Array_string _t1438 = os__read_lines(file);
		if (_t1438.state != 0) { /*or block*/ 
			IError err = _t1438.err;
			*(Array_string*) _t1438.data = __new_array_with_default(line_nr + 1, 0, sizeof(string), &(string[]){_SLIT("")});
		}
 		Array_string source_lines =  (*(Array_string*)_t1438.data);
...
VV_LOCAL_SYMBOL void main__test_orm_sqlite(void) {
	Option_sqlite__DB _t1439 = sqlite__connect(_SLIT("test.sqlite"));
	if (_t1439.state != 0) { /*or block*/ 
		IError err = _t1439.err;
		v_panic(IError_str(err));
	}
 	sqlite__DB db =  (*(sqlite__DB*)_t1439.data);
	main__Module mod = (main__Module){.id = 0,.name = _SLIT("V ORM"),.nr_downloads = 100,.user = (main__User){.id = 0,.age = 17,.name = _SLIT("Louis Schmieder"),.is_customer = false,.skipped_string = _SLIT("abc"),},};
	main__Module mod1 = (main__Module){.id = 0,.name = _SLIT("V ORM"),.nr_downloads = 100,.user = (main__User){.id = 0,.age = 17,.name = _SLIT("ABC Schmieder"),.is_customer = false,.skipped_string = _SLIT("abc"),},};
	
	// orm
	orm__OrmConnection _t1440 = (orm__OrmConnection){._sqlite__DB = &db, ._typ = _orm__OrmConnection_sqlite__DB_index};
	Option_void _t1441 = orm__OrmConnection_name_table[_t1440._typ]._method_create(_t1440._object, _SLIT("Module"), new_array_from_c_array(4, 4, sizeof(orm__OrmTableField), _MOV((orm__OrmTableField[4]){(orm__OrmTableField){.name = _SLIT("id"),.typ = 7,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(2, 2, sizeof(StructAttribute), _MOV((StructAttribute[2]){(StructAttribute){.name = _SLIT("primary"),.has_arg = 0,.arg = _SLIT(""),.kind = 0,},(StructAttribute){.name = _SLIT("sql"),.has_arg = 1,.arg = _SLIT("serial"),.kind = 0,},}))},(orm__OrmTableField){.name = _SLIT("name"),.typ = 18,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},(orm__OrmTableField){.name = _SLIT("nr_downloads"),.typ = 7,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},(orm__OrmTableField){.name = _SLIT("user"),.typ = 84,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},})));
	if (_t1441.state != 0 && _t1441.err._typ != _IError_None___index) { v_panic(IError_str(_t1441.err)); }
	Option_void _t1442 = orm__OrmConnection_name_table[_t1440._typ]._method_create(_t1440._object, _SLIT("userlist"), new_array_from_c_array(4, 4, sizeof(orm__OrmTableField), _MOV((orm__OrmTableField[4]){(orm__OrmTableField){.name = _SLIT("id"),.typ = 7,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(2, 2, sizeof(StructAttribute), _MOV((StructAttribute[2]){(StructAttribute){.name = _SLIT("primary"),.has_arg = 0,.arg = _SLIT(""),.kind = 0,},(StructAttribute){.name = _SLIT("sql"),.has_arg = 1,.arg = _SLIT("serial"),.kind = 0,},}))},(orm__OrmTableField){.name = _SLIT("age"),.typ = 7,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},(orm__OrmTableField){.name = _SLIT("name"),.typ = 18,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(1, 1, sizeof(StructAttribute), _MOV((StructAttribute[1]){(StructAttribute){.name = _SLIT("sql"),.has_arg = 1,.arg = _SLIT("username"),.kind = 1,},}))},(orm__OrmTableField){.name = _SLIT("is_customer"),.typ = 16,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},})));
	if (_t1442.state != 0 && _t1442.err._typ != _IError_None___index) { v_panic(IError_str(_t1442.err)); }
	
	// orm
	orm__OrmConnection _t1443 = (orm__OrmConnection){._sqlite__DB = &db, ._typ = _orm__OrmConnection_sqlite__DB_index};
	Array_orm__Primitive _t1445 = new_array_from_c_array(0, 0, sizeof(orm__Primitive), _MOV((orm__Primitive[0]){}));
	Array_orm__Primitive _t1447 = new_array_from_c_array(0, 0, sizeof(orm__Primitive), _MOV((orm__Primitive[0]){}));
	Option_void _t1446 = orm__OrmConnection_name_table[_t1443._typ]._method_insert(_t1443._object, _SLIT("userlist"), (orm__OrmQueryData){.fields = new_array_from_c_array(3, 3, sizeof(string), _MOV((string[3]){_SLIT("age"),_SLIT("username"),_SLIT("is_customer"),})),.data = new_array_from_c_array(3, 3, sizeof(orm__Primitive), _MOV((orm__Primitive[3]){orm__int_to_primitive(mod.user.age),orm__string_to_primitive(mod.user.name),orm__bool_to_primitive(mod.user.is_customer),})),.types = new_array_from_c_array(0, 0, sizeof(int), _MOV((int[0]){})),.kinds = new_array_from_c_array(0, 0, sizeof(orm__OperationKind), _MOV((orm__OperationKind[0]){})),});
	if (_t1446.state != 0 && _t1446.err._typ != _IError_None___index) { v_panic(IError_str(_t1446.err)); }
	array_push(&_t1445, _MOV((orm__Primitive[]){orm__OrmConnection_name_table[_t1443._typ]._method_last_id(_t1443._object)}));
	Option_void _t1444 = orm__OrmConnection_name_table[_t1443._typ]._method_insert(_t1443._object, _SLIT("Module"), (orm__OrmQueryData){.fields = new_array_from_c_array(3, 3, sizeof(string), _MOV((string[3]){_SLIT("name"),_SLIT("nr_downloads"),_SLIT("user_id"),})),.data = new_array_from_c_array(3, 3, sizeof(orm__Primitive), _MOV((orm__Primitive[3]){orm__string_to_primitive(mod.name),orm__int_to_primitive(mod.nr_downloads),(*(orm__Primitive*) array_get(_t1445, 0)),})),.types = new_array_from_c_array(0, 0, sizeof(int), _MOV((int[0]){})),.kinds = new_array_from_c_array(0, 0, sizeof(orm__OperationKind), _MOV((orm__OperationKind[0]){})),});
	if (_t1444.state != 0 && _t1444.err._typ != _IError_None___index) { v_panic(IError_str(_t1444.err)); }
	Option_void _t1448 = orm__OrmConnection_name_table[_t1443._typ]._method_update(_t1443._object, _SLIT("Module"), (orm__OrmQueryData){.fields = new_array_from_c_array(1, 1, sizeof(string), _MOV((string[1]){_SLIT("nr_downloads"),})),.data = new_array_from_c_array(1, 1, sizeof(orm__Primitive), _MOV((orm__Primitive[1]){orm__int_to_primitive(101),})),},(orm__OrmQueryData){.fields = new_array_from_c_array(1, 1, sizeof(string), _MOV((string[1]){_SLIT("id"),})),.data = new_array_from_c_array(1, 1, sizeof(orm__Primitive), _MOV((orm__Primitive[1]){orm__int_to_primitive(1),})),.kinds = new_array_from_c_array(1, 1, sizeof(orm__OperationKind), _MOV((orm__OperationKind[1]){orm__OperationKind_eq,})),});
	if (_t1448.state != 0 && _t1448.err._typ != _IError_None___index) { v_panic(IError_str(_t1448.err)); }

	// orm
	orm__OrmConnection _t1449 = (orm__OrmConnection){._sqlite__DB = &db, ._typ = _orm__OrmConnection_sqlite__DB_index};
	Option_Array_Array_orm__Primitive _o_t1450 = orm__OrmConnection_name_table[_t1449._typ]._method_select(_t1449._object, (orm__OrmSelectConfig){.table = _SLIT("Module"),.is_count = false,.has_where = true,.has_order = false,.has_limit = false,.has_offset = false,.primary = _SLIT("id"),.fields = new_array_from_c_array(4, 4, sizeof(string), _MOV((string[4]){_SLIT("id"),_SLIT("name"),_SLIT("nr_downloads"),_SLIT("user_id"),})),.types = new_array_from_c_array(4, 4, sizeof(int), _MOV((int[4]){7,18,7,7,})),},(orm__OrmQueryData) {.data = new_array_from_c_array(0, 0, sizeof(orm__Primitive), _MOV((orm__Primitive[0]){}))},(orm__OrmQueryData){.fields = new_array_from_c_array(1, 1, sizeof(string), _MOV((string[1]){_SLIT("id"),})),.data = new_array_from_c_array(1, 1, sizeof(orm__Primitive), _MOV((orm__Primitive[1]){orm__int_to_primitive(1),})),.kinds = new_array_from_c_array(1, 1, sizeof(orm__OperationKind), _MOV((orm__OperationKind[1]){orm__OperationKind_eq,})),});
	if (_o_t1450.state != 0 && _o_t1450.err._typ != _IError_None___index) { v_panic(IError_str(_o_t1450.err)); }
	Array_Array_orm__Primitive _t1450 = (*(Array_Array_orm__Primitive*)_o_t1450.data);
	int _t1452 = 0;
	main__Module _t1451 = (main__Module){.id = 0, .name = (string){.str=(byteptr)"", .is_lit=1}, .nr_downloads = 0, .user = (main__User){.id = 0,.age = 0,.name = (string){.str=(byteptr)"", .is_lit=1},.is_customer = 0,.skipped_string = (string){.str=(byteptr)"", .is_lit=1},}};
	if (_t1450.len > 0) {
	_t1451.id = *((*(orm__Primitive*) array_get((*(Array_orm__Primitive*) array_get(_t1450, _t1452)), 0))._int);
	_t1451.name = *((*(orm__Primitive*) array_get((*(Array_orm__Primitive*) array_get(_t1450, _t1452)), 1))._string);
	_t1451.nr_downloads = *((*(orm__Primitive*) array_get((*(Array_orm__Primitive*) array_get(_t1450, _t1452)), 2))._int);
	Option_Array_Array_orm__Primitive _o_t1453 = orm__OrmConnection_name_table[_t1449._typ]._method_select(_t1449._object, (orm__OrmSelectConfig){.table = _SLIT("userlist"),.is_count = false,.has_where = true,.has_order = false,.has_limit = false,.has_offset = false,.primary = _SLIT("id"),.fields = new_array_from_c_array(4, 4, sizeof(string), _MOV((string[4]){_SLIT("id"),_SLIT("age"),_SLIT("username"),_SLIT("is_customer"),})),.types = new_array_from_c_array(4, 4, sizeof(int), _MOV((int[4]){7,7,18,16,})),},(orm__OrmQueryData) {.data = new_array_from_c_array(0, 0, sizeof(orm__Primitive), _MOV((orm__Primitive[0]){}))},(orm__OrmQueryData){.fields = new_array_from_c_array(1, 1, sizeof(string), _MOV((string[1]){_SLIT("id"),})),.data = new_array_from_c_array(1, 1, sizeof(orm__Primitive), _MOV((orm__Primitive[1]){(*(orm__Primitive*) array_get((*(Array_orm__Primitive*) array_get(_t1450, _t1452)), 3)),})),.kinds = new_array_from_c_array(1, 1, sizeof(orm__OperationKind), _MOV((orm__OperationKind[1]){orm__OperationKind_eq,})),});
	if (_o_t1453.state != 0 && _o_t1453.err._typ != _IError_None___index) { v_panic(IError_str(_o_t1453.err)); }
	Array_Array_orm__Primitive _t1453 = (*(Array_Array_orm__Primitive*)_o_t1453.data);
	int _t1455 = 0;
	main__User _t1454 = (main__User){.id = 0, .age = 0, .name = (string){.str=(byteptr)"", .is_lit=1}, .is_customer = 0, .skipped_string = (string){.str=(byteptr)"", .is_lit=1}};
	if (_t1453.len > 0) {
	_t1454.id = *((*(orm__Primitive*) array_get((*(Array_orm__Primitive*) array_get(_t1453, _t1455)), 0))._int);
	_t1454.age = *((*(orm__Primitive*) array_get((*(Array_orm__Primitive*) array_get(_t1453, _t1455)), 1))._int);
	_t1454.name = *((*(orm__Primitive*) array_get((*(Array_orm__Primitive*) array_get(_t1453, _t1455)), 2))._string);
	_t1454.is_customer = *((*(orm__Primitive*) array_get((*(Array_orm__Primitive*) array_get(_t1453, _t1455)), 3))._bool);
	}
	_t1451.user =  _t1454;
	}
		main__Module modl =  _t1451;
	;
	// assert
	if (modl.id == 1) {
		g_test_oks++;
		VAssertMetaInfo v_assert_meta_info__t1456 = {0};
		v_assert_meta_info__t1456.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1456.line_nr = 59;
		v_assert_meta_info__t1456.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1456.src = _SLIT("modl.id == 1");
		v_assert_meta_info__t1456.op = _SLIT("==");
		v_assert_meta_info__t1456.llabel = _SLIT("modl.id");
		v_assert_meta_info__t1456.rlabel = _SLIT("1");
		v_assert_meta_info__t1456.lvalue = int_str(modl.id) /* typeof: v.ast.SelectorExpr type: 7 */ ;
		v_assert_meta_info__t1456.rvalue = int_str(1) /* typeof: v.ast.IntegerLiteral type: 7 */ ;
		main__cb_assertion_ok(&v_assert_meta_info__t1456);
	} else {
		g_test_fails++;
		VAssertMetaInfo v_assert_meta_info__t1457 = {0};
		v_assert_meta_info__t1457.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1457.line_nr = 59;
		v_assert_meta_info__t1457.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1457.src = _SLIT("modl.id == 1");
		v_assert_meta_info__t1457.op = _SLIT("==");
		v_assert_meta_info__t1457.llabel = _SLIT("modl.id");
		v_assert_meta_info__t1457.rlabel = _SLIT("1");
		v_assert_meta_info__t1457.lvalue = int_str(modl.id) /* typeof: v.ast.SelectorExpr type: 7 */ ;
		v_assert_meta_info__t1457.rvalue = int_str(1) /* typeof: v.ast.IntegerLiteral type: 7 */ ;
		main__cb_assertion_failed(&v_assert_meta_info__t1457);
		longjmp(g_jump_buffer, 1);
		// TODO
		// Maybe print all vars in a test function if it fails?
	}
	// assert
	if (string__eq(modl.name, mod.name)) {
		g_test_oks++;
		VAssertMetaInfo v_assert_meta_info__t1458 = {0};
		v_assert_meta_info__t1458.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1458.line_nr = 60;
		v_assert_meta_info__t1458.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1458.src = _SLIT("modl.name == mod.name");
		v_assert_meta_info__t1458.op = _SLIT("==");
		v_assert_meta_info__t1458.llabel = _SLIT("modl.name");
		v_assert_meta_info__t1458.rlabel = _SLIT("mod.name");
		v_assert_meta_info__t1458.lvalue = modl.name /* typeof: v.ast.SelectorExpr type: 18 */ ;
		v_assert_meta_info__t1458.rvalue = mod.name /* typeof: v.ast.SelectorExpr type: 18 */ ;
		main__cb_assertion_ok(&v_assert_meta_info__t1458);
	} else {
		g_test_fails++;
		VAssertMetaInfo v_assert_meta_info__t1459 = {0};
		v_assert_meta_info__t1459.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1459.line_nr = 60;
		v_assert_meta_info__t1459.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1459.src = _SLIT("modl.name == mod.name");
		v_assert_meta_info__t1459.op = _SLIT("==");
		v_assert_meta_info__t1459.llabel = _SLIT("modl.name");
		v_assert_meta_info__t1459.rlabel = _SLIT("mod.name");
		v_assert_meta_info__t1459.lvalue = modl.name /* typeof: v.ast.SelectorExpr type: 18 */ ;
		v_assert_meta_info__t1459.rvalue = mod.name /* typeof: v.ast.SelectorExpr type: 18 */ ;
		main__cb_assertion_failed(&v_assert_meta_info__t1459);
		longjmp(g_jump_buffer, 1);
		// TODO
		// Maybe print all vars in a test function if it fails?
	}
	// assert
	if (modl.nr_downloads == 101) {
		g_test_oks++;
		VAssertMetaInfo v_assert_meta_info__t1460 = {0};
		v_assert_meta_info__t1460.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1460.line_nr = 61;
		v_assert_meta_info__t1460.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1460.src = _SLIT("modl.nr_downloads == 101");
		v_assert_meta_info__t1460.op = _SLIT("==");
		v_assert_meta_info__t1460.llabel = _SLIT("modl.nr_downloads");
		v_assert_meta_info__t1460.rlabel = _SLIT("101");
		v_assert_meta_info__t1460.lvalue = int_str(modl.nr_downloads) /* typeof: v.ast.SelectorExpr type: 7 */ ;
		v_assert_meta_info__t1460.rvalue = int_str(101) /* typeof: v.ast.IntegerLiteral type: 7 */ ;
		main__cb_assertion_ok(&v_assert_meta_info__t1460);
	} else {
		g_test_fails++;
		VAssertMetaInfo v_assert_meta_info__t1461 = {0};
		v_assert_meta_info__t1461.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1461.line_nr = 61;
		v_assert_meta_info__t1461.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1461.src = _SLIT("modl.nr_downloads == 101");
		v_assert_meta_info__t1461.op = _SLIT("==");
		v_assert_meta_info__t1461.llabel = _SLIT("modl.nr_downloads");
		v_assert_meta_info__t1461.rlabel = _SLIT("101");
		v_assert_meta_info__t1461.lvalue = int_str(modl.nr_downloads) /* typeof: v.ast.SelectorExpr type: 7 */ ;
		v_assert_meta_info__t1461.rvalue = int_str(101) /* typeof: v.ast.IntegerLiteral type: 7 */ ;
		main__cb_assertion_failed(&v_assert_meta_info__t1461);
		longjmp(g_jump_buffer, 1);
		// TODO
		// Maybe print all vars in a test function if it fails?
	}
	// assert
	if (modl.user.age == mod.user.age) {
		g_test_oks++;
		VAssertMetaInfo v_assert_meta_info__t1462 = {0};
		v_assert_meta_info__t1462.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1462.line_nr = 62;
		v_assert_meta_info__t1462.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1462.src = _SLIT("modl.user.age == mod.user.age");
		v_assert_meta_info__t1462.op = _SLIT("==");
		v_assert_meta_info__t1462.llabel = _SLIT("modl.user.age");
		v_assert_meta_info__t1462.rlabel = _SLIT("mod.user.age");
		v_assert_meta_info__t1462.lvalue = int_str(modl.user.age) /* typeof: v.ast.SelectorExpr type: 7 */ ;
		v_assert_meta_info__t1462.rvalue = int_str(mod.user.age) /* typeof: v.ast.SelectorExpr type: 7 */ ;
		main__cb_assertion_ok(&v_assert_meta_info__t1462);
	} else {
		g_test_fails++;
		VAssertMetaInfo v_assert_meta_info__t1463 = {0};
		v_assert_meta_info__t1463.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1463.line_nr = 62;
		v_assert_meta_info__t1463.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1463.src = _SLIT("modl.user.age == mod.user.age");
		v_assert_meta_info__t1463.op = _SLIT("==");
		v_assert_meta_info__t1463.llabel = _SLIT("modl.user.age");
		v_assert_meta_info__t1463.rlabel = _SLIT("mod.user.age");
		v_assert_meta_info__t1463.lvalue = int_str(modl.user.age) /* typeof: v.ast.SelectorExpr type: 7 */ ;
		v_assert_meta_info__t1463.rvalue = int_str(mod.user.age) /* typeof: v.ast.SelectorExpr type: 7 */ ;
		main__cb_assertion_failed(&v_assert_meta_info__t1463);
		longjmp(g_jump_buffer, 1);
		// TODO
		// Maybe print all vars in a test function if it fails?
	}
	// assert
	if (string__eq(modl.user.name, mod.user.name)) {
		g_test_oks++;
		VAssertMetaInfo v_assert_meta_info__t1464 = {0};
		v_assert_meta_info__t1464.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1464.line_nr = 63;
		v_assert_meta_info__t1464.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1464.src = _SLIT("modl.user.name == mod.user.name");
		v_assert_meta_info__t1464.op = _SLIT("==");
		v_assert_meta_info__t1464.llabel = _SLIT("modl.user.name");
		v_assert_meta_info__t1464.rlabel = _SLIT("mod.user.name");
		v_assert_meta_info__t1464.lvalue = modl.user.name /* typeof: v.ast.SelectorExpr type: 18 */ ;
		v_assert_meta_info__t1464.rvalue = mod.user.name /* typeof: v.ast.SelectorExpr type: 18 */ ;
		main__cb_assertion_ok(&v_assert_meta_info__t1464);
	} else {
		g_test_fails++;
		VAssertMetaInfo v_assert_meta_info__t1465 = {0};
		v_assert_meta_info__t1465.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1465.line_nr = 63;
		v_assert_meta_info__t1465.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1465.src = _SLIT("modl.user.name == mod.user.name");
		v_assert_meta_info__t1465.op = _SLIT("==");
		v_assert_meta_info__t1465.llabel = _SLIT("modl.user.name");
		v_assert_meta_info__t1465.rlabel = _SLIT("mod.user.name");
		v_assert_meta_info__t1465.lvalue = modl.user.name /* typeof: v.ast.SelectorExpr type: 18 */ ;
		v_assert_meta_info__t1465.rvalue = mod.user.name /* typeof: v.ast.SelectorExpr type: 18 */ ;
		main__cb_assertion_failed(&v_assert_meta_info__t1465);
		longjmp(g_jump_buffer, 1);
		// TODO
		// Maybe print all vars in a test function if it fails?
	}
	// assert
	if (modl.user.is_customer == mod.user.is_customer) {
		g_test_oks++;
		VAssertMetaInfo v_assert_meta_info__t1466 = {0};
		v_assert_meta_info__t1466.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1466.line_nr = 64;
		v_assert_meta_info__t1466.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1466.src = _SLIT("modl.user.is_customer == mod.user.is_customer");
		v_assert_meta_info__t1466.op = _SLIT("==");
		v_assert_meta_info__t1466.llabel = _SLIT("modl.user.is_customer");
		v_assert_meta_info__t1466.rlabel = _SLIT("mod.user.is_customer");
		v_assert_meta_info__t1466.lvalue = modl.user.is_customer ? _SLIT("true") : _SLIT("false") /* typeof: v.ast.SelectorExpr type: 16 */ ;
		v_assert_meta_info__t1466.rvalue = mod.user.is_customer ? _SLIT("true") : _SLIT("false") /* typeof: v.ast.SelectorExpr type: 16 */ ;
		main__cb_assertion_ok(&v_assert_meta_info__t1466);
	} else {
		g_test_fails++;
		VAssertMetaInfo v_assert_meta_info__t1467 = {0};
		v_assert_meta_info__t1467.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1467.line_nr = 64;
		v_assert_meta_info__t1467.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1467.src = _SLIT("modl.user.is_customer == mod.user.is_customer");
		v_assert_meta_info__t1467.op = _SLIT("==");
		v_assert_meta_info__t1467.llabel = _SLIT("modl.user.is_customer");
		v_assert_meta_info__t1467.rlabel = _SLIT("mod.user.is_customer");
		v_assert_meta_info__t1467.lvalue = modl.user.is_customer ? _SLIT("true") : _SLIT("false") /* typeof: v.ast.SelectorExpr type: 16 */ ;
		v_assert_meta_info__t1467.rvalue = mod.user.is_customer ? _SLIT("true") : _SLIT("false") /* typeof: v.ast.SelectorExpr type: 16 */ ;
		main__cb_assertion_failed(&v_assert_meta_info__t1467);
		longjmp(g_jump_buffer, 1);
		// TODO
		// Maybe print all vars in a test function if it fails?
	}
	// assert
	if ((modl.user.skipped_string).len == 0) {
		g_test_oks++;
		VAssertMetaInfo v_assert_meta_info__t1468 = {0};
		v_assert_meta_info__t1468.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1468.line_nr = 65;
		v_assert_meta_info__t1468.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1468.src = _SLIT("modl.user.skipped_string == ''");
		v_assert_meta_info__t1468.op = _SLIT("==");
		v_assert_meta_info__t1468.llabel = _SLIT("modl.user.skipped_string");
		v_assert_meta_info__t1468.rlabel = _SLIT("''");
		v_assert_meta_info__t1468.lvalue = modl.user.skipped_string /* typeof: v.ast.SelectorExpr type: 18 */ ;
		v_assert_meta_info__t1468.rvalue = _SLIT("") /* typeof: v.ast.StringLiteral type: 18 */ ;
		main__cb_assertion_ok(&v_assert_meta_info__t1468);
	} else {
		g_test_fails++;
		VAssertMetaInfo v_assert_meta_info__t1469 = {0};
		v_assert_meta_info__t1469.fpath = _SLIT("vlib/orm/orm_test.v");
		v_assert_meta_info__t1469.line_nr = 65;
		v_assert_meta_info__t1469.fn_name = _SLIT("main.test_orm_sqlite");
		v_assert_meta_info__t1469.src = _SLIT("modl.user.skipped_string == ''");
		v_assert_meta_info__t1469.op = _SLIT("==");
		v_assert_meta_info__t1469.llabel = _SLIT("modl.user.skipped_string");
		v_assert_meta_info__t1469.rlabel = _SLIT("''");
		v_assert_meta_info__t1469.lvalue = modl.user.skipped_string /* typeof: v.ast.SelectorExpr type: 18 */ ;
		v_assert_meta_info__t1469.rvalue = _SLIT("") /* typeof: v.ast.StringLiteral type: 18 */ ;
		main__cb_assertion_failed(&v_assert_meta_info__t1469);
		longjmp(g_jump_buffer, 1);
		// TODO
		// Maybe print all vars in a test function if it fails?
	}
