...
mut:
	...
	iidx    int
	pixels  &u32     = unsafe { &u32(vcalloc(pwidth * pheight * sizeof(u32))) }
	npixels &u32     = unsafe { &u32(vcalloc(pwidth * pheight * sizeof(u32))) } // all drawing happens here, results are swapped at the end
