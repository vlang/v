                            ...
                            case Secs1 < 604800 of
                                ...
                                false -> 
                                    case Secs1 < 31536000 of
                                        ...
                                        false -> begin
                                            Y = Secs1 div 3600 div 24 div 365,
                                            case Y == 1 of
...
'Time.year_day'(T) ->
    Yday = maps:get(day, T) + lists:nth(iclamp(0, maps:get(month, T) - 1, 12) + 1, [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365]),
...
unix_nanosecond(Abs_unix_timestamp, Nanosecond) ->
    Day_offset = Abs_unix_timestamp div 86400,
    ...
    Hour_ = element(1, calculate_time_from_second_offset(Abs_unix_timestamp rem 86400)),
    Minute_ = element(2, calculate_time_from_second_offset(Abs_unix_timestamp rem 86400)),
    Second_ = element(3, calculate_time_from_second_offset(Abs_unix_timestamp rem 86400)),
...
calculate_date_from_day_offset(Day_offset_) ->
    ...
    Day_of_era = Day_offset1 - Era * 146097,
