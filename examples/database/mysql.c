...
Option_bool mysql__Connection_connect(mysql__Connection* conn) {
	...
	Option_bool _t102;
	opt_ok(&(bool[]) { true }, (Option*)(&_t102), sizeof(bool));
	return _t102;
}
...
Option_mysql__Result mysql__Connection_query(mysql__Connection* conn, string q) {
	...
	Option_mysql__Result _t103;
	opt_ok(&(mysql__Result[]) { (mysql__Result){.result = res,} }, (Option*)(&_t103), sizeof(mysql__Result));
	return _t103;
}
...
Option_mysql__Result mysql__Connection_real_query(mysql__Connection* conn, string q) {
	...
	MYSQL_RES* res = mysql_store_result(conn->conn);
	Option_mysql__Result _t104;
	opt_ok(&(mysql__Result[]) { (mysql__Result){.result = res,} }, (Option*)(&_t104), sizeof(mysql__Result));
	return _t104;
}
...
Option_bool mysql__Connection_select_db(mysql__Connection* conn, string dbname) {
	...
	Option_bool _t105;
	opt_ok(&(bool[]) { true }, (Option*)(&_t105), sizeof(bool));
	return _t105;
}
...
Option_bool mysql__Connection_change_user(mysql__Connection* conn, string username, string password, string dbname) {
	...
	Option_bool _t106;
	opt_ok(&(bool[]) { ret }, (Option*)(&_t106), sizeof(bool));
	return _t106;
}

u64 mysql__Connection_affected_rows(mysql__Connection* conn) {
	 u64 _t107 = mysql_affected_rows(conn->conn);
...
Option_Array_string mysql__Connection_tables(mysql__Connection* conn, string wildcard) {
	...
	// FOR IN array
	Array_mysql__Row _t108 = mysql__Result_rows(res);
	for (int _t109 = 0; _t109 < _t108.len; ++_t109) {
		mysql__Row row = ((mysql__Row*)_t108.data)[_t109];
		array_push(&tables, _MOV((string[]){ string_clone((*(string*)/*ee elem_typ */array_get(row.vals, 0))) }));
	}
	Option_Array_string _t111;
	opt_ok(&(Array_string[]) { tables }, (Option*)(&_t111), sizeof(Array_string));
	return _t111;
}
...
Option_voidptr mysql__Connection_get_option(mysql__Connection* conn, int option_type) {
	...
	Option_voidptr _t113;
	opt_ok(&(voidptr[]) { ret }, (Option*)(&_t113), sizeof(voidptr));
	return _t113;
}
...
Option_bool mysql__Connection_refresh(mysql__Connection* conn, u32 options) {
	...
	Option_bool _t114;
	opt_ok(&(bool[]) { true }, (Option*)(&_t114), sizeof(bool));
	return _t114;
}
...
Option_bool mysql__Connection_reset(mysql__Connection* conn) {
	...
	Option_bool _t115;
	opt_ok(&(bool[]) { true }, (Option*)(&_t115), sizeof(bool));
	return _t115;
}
...
Option_bool mysql__Connection_ping(mysql__Connection* conn) {
	...
	Option_bool _t116;
	opt_ok(&(bool[]) { true }, (Option*)(&_t116), sizeof(bool));
	return _t116;
}
...
string mysql__Connection_info(mysql__Connection* conn) {
	 string _t117 = mysql__resolve_nil_str(mysql_info(conn->conn));
...
string mysql__Connection_get_host_info(mysql__Connection* conn) {
	 string _t118 = byteptr_vstring(mysql_get_host_info(conn->conn));
...
string mysql__Connection_get_server_info(mysql__Connection* conn) {
	 string _t119 = byteptr_vstring(mysql_get_server_info(conn->conn));
...
u64 mysql__Connection_get_server_version(mysql__Connection* conn) {
	 u64 _t120 = mysql_get_server_version(conn->conn);
...
string mysql__get_client_info(void) {
	 string _t122 = byteptr_vstring(mysql_get_client_info());
...
u64 mysql__get_client_version(void) {
	 u64 _t123 = mysql_get_client_version();
...
byteptr* mysql__Result_fetch_row(mysql__Result r) {
	 byteptr* _t124 = mysql_fetch_row(r.result);
...
u64 mysql__Result_n_rows(mysql__Result r) {
	 u64 _t125 = mysql_num_rows(r.result);
...
int mysql__Result_n_fields(mysql__Result r) {
	 int _t126 = mysql_num_fields(r.result);
...
VV_LOCAL_SYMBOL string mysql__get_error_msg(MYSQL* conn) {
	 string _t133 = byteptr_vstring(mysql_error(conn));
...
VV_LOCAL_SYMBOL string mysql__resolve_nil_str(byteptr ptr) {
	if (isnil(ptr)) {
	 ...
	 string _t136 = byteptr_vstring(ptr);
...
inline VV_LOCAL_SYMBOL string mysql__mystring(byteptr b) {
	{ // Unsafe block
		 string _t137 = byteptr_vstring(b);
...
VV_LOCAL_SYMBOL void main__main(void) {
	...
	Option_bool _t138 = mysql__Connection_connect(&conn);
	if (_t138.state != 0) { /*or block*/ 
		panic_optional_not_set(*_t138.err.msg);
	};
	Option_mysql__Result _t139 = mysql__Connection_query(&conn, _SLIT("show tables"));
	...
	for (int _t141 = 0; _t141 < _t140.len; ++_t141) {
		mysql__Row row = ((mysql__Row*)_t140.data)[_t141];
		println(Array_string_join(row.vals, _SLIT(", ")));
	}
