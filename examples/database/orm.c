	...
	#define V_CURRENT_COMMIT_HASH "61a3ace"
#endif
...
VV_LOCAL_SYMBOL void main__mysql(void) {
	...
	//name (18)
	_t171[0].buffer_type = MYSQL_TYPE_NULL;
	_t171[0].buffer = (char **) &mod.name;
	_t171[0].buffer_length = mod.name.len;
	_t171[0].is_null = 0;
	_t171[0].length = 0;
	//nr_downloads (7)
	...
	_t175[0].length = 0;
	//name (18)
	_t175[1].buffer_type = MYSQL_TYPE_NULL;
	_t175[1].buffer = (char **) &mod.creator.name;
	_t175[1].buffer_length = mod.creator.name.len;
	_t175[1].is_null = 0;
	_t175[1].length = 0;
	//is_customer (16)
