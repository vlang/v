...
fn init(mut state State) {
	...
	mut buffer := gfx.BufferDesc{}
	buffer.label = c'fsq vertices'
	buffer.data = unsafe { gfx.Range{&fsq_verts[0], sizeof(fsq_verts)} }
	state.bind.vertex_buffers[0] = gfx.make_buffer(&buffer)
