...
#include "rt_glsl_march.h"
#include "rt_glsl_puppy.h"
...
fn draw_cube_glsl_m(app App){
	...
	gfx.apply_uniforms(C.SG_SHADERSTAGE_VS, C.SLOT_vs_params_m, &res, int(sizeof(res)) )
...
fn draw_cube_glsl_p(app App){
	...
	// passing the view matrix as uniform
	// res is a 4x4 matrix of f32 thus: 4*16 byte of size
	gfx.apply_uniforms(C.SG_SHADERSTAGE_VS, C.SLOT_vs_params_p, &res, int(sizeof(res)) )
