	...
	#define V_CURRENT_COMMIT_HASH "149fc17"
#endif
...
static void main__main() {
	...
	{ // 2comptime $for {
		// method 0
		FunctionData method = (FunctionData){.name = tos_lit("method_one"),
		...
		// method 1
		method = (FunctionData){.name = tos_lit("method_two"),
		.attrs = new_array_from_c_array(0, 0, sizeof(string), _MOV((string[0]){})),
		.ret_type = tos_lit("void"),};
		{ // $if ret_type typecheck start
		} // typecheck end
		...
		// method 2
		method = (FunctionData){.name = tos_lit("method_three"),
		.attrs = new_array_from_c_array(0, 0, sizeof(string), _MOV((string[0]){})),
		...
		// method 3
		method = (FunctionData){.name = tos_lit("method_four"),
		.attrs = new_array_from_c_array(0, 0, sizeof(string), _MOV((string[0]){})),
		.ret_type = tos_lit("int"),};
		{ // $if ret_type typecheck start
			println(tos_lit("hi"));
