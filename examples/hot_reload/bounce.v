...
fn frame(mut game Game) {
	...
	game.gg.draw_rect_filled(window_width - width - game.x + 10, 200 - game.y + width, width,
		width, gg.rgb(228, 10, 55))
	game.gg.draw_rect_filled(game.x - 25, 250 - game.y, width, width, gg.rgb(28, 240, 55))
	game.gg.end()
}
