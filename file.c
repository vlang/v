	...
	#define V_COMMIT_HASH "d1f1c5a"
#endif

#ifndef V_CURRENT_COMMIT_HASH
	#define V_CURRENT_COMMIT_HASH "9d4697c"
#endif
...
VV_LOCAL_SYMBOL void main__m(int* x);
VV_LOCAL_SYMBOL void main__foo(int x);
...
VV_LOCAL_SYMBOL voidptr map_get_and_set(map* m, voidptr key, voidptr zero) {
	...
	if (!(false)) {
		...
		v_assert_meta_info__t2.fpath = _SLIT("/home/aprokurov/Projects/vlang/vlib/builtin/map.v");
