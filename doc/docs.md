...
be loaded *the first time* your program calls `embedded_file.to_string()` at runtime, making
...
and thus easier to distribute. In this case, `embedded_file.to_string()` will cause *no IO*,
