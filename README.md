...
```bash
# Download the V compiler's source translated to C and build it with Clang or GCC
curl https://raw.githubusercontent.com/vlang/vc/master/v.c | cc -xc -std=gnu11 -w -o v -
