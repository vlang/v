...
const test_cases = [
	...
	CompleteTestCase{
		...
		structure: [os.join_path('examples', 'ex1'), // Empty dir
			os.join_path('examples', 'ex2'), // Two files os.join_path('examples', 'ex2',
				'ex2_0.v'),
			os.join_path('examples', 'ex2', 'ex2_1.v'), os.join_path('examples', 'ex3'), // One file
	...
	CompleteTestCase{
		...
		structure: [os.join_path('sub0', 'ex1'), // Empty dir
			os.join_path('sub0', 'ex2'), // Two files os.join_path('sub0', 'ex2', 'ex2_0.v'),
			os.join_path('sub0', 'ex2', 'ex2_1.v'), os.join_path('sub0', 'ex3'), // One file
			os.join_path('sub0', 'ex3', 'ex3.v'), os.join_path('sub1', 'vex1'),
			os.join_path('sub1', 'vex2'), os.join_path('sub1', 'vex3'),
