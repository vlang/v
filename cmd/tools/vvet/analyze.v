...
struct VetAnalyze {
mut:
	repeated_expr_cutoff     map[string]int
	repeated_expr            map[string]map[string]map[string][]int
	potential_non_inlined    map[string]map[string]int
	call_counter             map[string]int
	unqualified_call_counter map[string]int
