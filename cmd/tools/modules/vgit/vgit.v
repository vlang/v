...
pub fn clone_or_pull( remote_git_url string, local_worktree_path string ) {
	...
	if os.is_dir( local_worktree_path ) && os.is_dir(os.path_join(local_worktree_path,'.git')) {
...
pub fn (vgit_context mut VGitContext) compile_oldv_if_needed() {
	...
	vgit_context.vexepath = os.realpath( os.path_join(vgit_context.path_v, vgit_context.vexename) )
