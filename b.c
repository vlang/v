	...
	#define V_CURRENT_COMMIT_HASH "c2a1c89"
#endif
...
Option_Array_Array_orm__Primitive sqlite__DB_select(sqlite__DB db, orm__OrmSelectConfig config, orm__OrmQueryData data, orm__OrmQueryData where) {
	...
	Option_void _t1349 = sqlite__sqlite_stmt_binder(stmt, data, query);
	if (_t1349.state != 0 && _t1349.err._typ != _IError_None___index) {
		Option_Array_Array_orm__Primitive _t1350;
		memcpy(&_t1350, &_t1349, sizeof(Option));
		return _t1350;
	};
	Option_void _t1351 = sqlite__sqlite_stmt_binder(stmt, where, query);
	if (_t1351.state != 0 && _t1351.err._typ != _IError_None___index) {
		Option_Array_Array_orm__Primitive _t1352;
		memcpy(&_t1352, &_t1351, sizeof(Option));
		return _t1352;
	};
	Array_Array_orm__Primitive ret = __new_array_with_default(0, 0, sizeof(Array_orm__Primitive), 0);
	if (config.is_count) {
		Option_void _t1353 = sqlite__Stmt_orm_step(stmt, query);
		if (_t1353.state != 0 && _t1353.err._typ != _IError_None___index) {
			Option_Array_Array_orm__Primitive _t1354;
			memcpy(&_t1354, &_t1353, sizeof(Option));
			return _t1354;
		};
		...
		Option_Array_Array_orm__Primitive _t1356;
		opt_ok(&(Array_Array_orm__Primitive[]) { ret }, (Option*)(&_t1356), sizeof(Array_Array_orm__Primitive));
		return _t1356;
	}
	for (;;) {
		...
		for (int i = 0; i < config.types.len; ++i) {
			...
			Option_orm__Primitive _t1357 = sqlite__Stmt_sqlite_select_column(stmt, i, typ);
			if (_t1357.state != 0) { /*or block*/ 
				Option_Array_Array_orm__Primitive _t1358;
				memcpy(&_t1358, &_t1357, sizeof(Option));
				return _t1358;
			}
 			orm__Primitive primitive =  (*(orm__Primitive*)_t1357.data);
	...
	eprintln(Array_Array_orm__Primitive_str(ret));
	Option_Array_Array_orm__Primitive _t1361;
	opt_ok(&(Array_Array_orm__Primitive[]) { ret }, (Option*)(&_t1361), sizeof(Array_Array_orm__Primitive));
	return _t1361;
}
...
Option_void sqlite__DB_insert(sqlite__DB db, string table, orm__OrmQueryData data) {
	...
	Option_void _t1362 = sqlite__sqlite_stmt_worker(db, query, data, (orm__OrmQueryData){.fields = __new_array(0, 0, sizeof(string)),.data = __new_array(0, 0, sizeof(orm__Primitive)),.types = __new_array(0, 0, sizeof(int)),.kinds = __new_array(0, 0, sizeof(orm__OperationKind)),});
...
Option_void sqlite__DB_update(sqlite__DB db, string table, orm__OrmQueryData data, orm__OrmQueryData where) {
	...
	Option_void _t1364 = sqlite__sqlite_stmt_worker(db, query, data, where);
...
Option_void sqlite__DB_delete(sqlite__DB db, string table, orm__OrmQueryData data, orm__OrmQueryData where) {
	...
	Option_void _t1366 = sqlite__sqlite_stmt_worker(db, query, data, where);
...
Option_void sqlite__DB_create(sqlite__DB db, string table, Array_orm__OrmTableField fields) {
	Option_string _t1368 = orm__orm_table_gen(table, _SLIT("`"), true, 0, fields, (voidptr)sqlite__sqlite_type_from_v);
	if (_t1368.state != 0) { /*or block*/ 
		IError err = _t1368.err;
		return (Option_void){ .state=2, .err=err, .data={0} };
	}
 	string query =  (*(string*)_t1368.data);
...
VV_LOCAL_SYMBOL Option_void sqlite__sqlite_stmt_worker(sqlite__DB db, string query, orm__OrmQueryData data, orm__OrmQueryData where) {
	sqlite__Stmt stmt = sqlite__DB_new_init_stmt(db, query);
	Option_void _t1372 = sqlite__sqlite_stmt_binder(stmt, data, query);
	if (_t1372.state != 0 && _t1372.err._typ != _IError_None___index) {
		Option_void _t1373;
		memcpy(&_t1373, &_t1372, sizeof(Option));
		return _t1373;
	};
	Option_void _t1374 = sqlite__sqlite_stmt_binder(stmt, where, query);
	if (_t1374.state != 0 && _t1374.err._typ != _IError_None___index) {
		Option_void _t1375;
		memcpy(&_t1375, &_t1374, sizeof(Option));
		return _t1375;
	};
	Option_void _t1376 = sqlite__Stmt_orm_step(stmt, query);
	if (_t1376.state != 0 && _t1376.err._typ != _IError_None___index) {
		Option_void _t1377;
		memcpy(&_t1377, &_t1376, sizeof(Option));
		return _t1377;
	};
...
VV_LOCAL_SYMBOL Option_void sqlite__sqlite_stmt_binder(sqlite__Stmt stmt, orm__OrmQueryData d, string query) {
	int c = 1;
	// FOR IN array
	for (int _t1378 = 0; _t1378 < d.data.len; ++_t1378) {
		orm__Primitive data = ((orm__Primitive*)d.data.data)[_t1378];
		eprintln(int_str(c));
...
VV_LOCAL_SYMBOL Option_orm__Primitive sqlite__Stmt_sqlite_select_column(sqlite__Stmt stmt, int idx, int typ) {
	...
	Option_orm__Primitive _t1381;
	opt_ok(&(orm__Primitive[]) { primitive }, (Option*)(&_t1381), sizeof(orm__Primitive));
	return _t1381;
}

VV_LOCAL_SYMBOL Option_string sqlite__sqlite_type_from_v(int typ) {
	Option_string _t1383; /* if prepend */
	if ((Array_int_contains(_const_orm__nums, typ)) || typ < 0 || (Array_int_contains(_const_orm__num64, typ))) {
		opt_ok(&(string[]) { _SLIT("INTEGER") }, (Option*)(&_t1383), sizeof(string));
	} else if ((Array_int_contains(_const_orm__float, typ))) {
		opt_ok(&(string[]) { _SLIT("REAL") }, (Option*)(&_t1383), sizeof(string));
	} else if (typ == _const_orm__string) {
		opt_ok(&(string[]) { _SLIT("TEXT") }, (Option*)(&_t1383), sizeof(string));
	} else {
		_t1383.state = 2;
		_t1383.err = v_error( str_intp(2, _MOV((StrIntpData[]){{_SLIT("Unknown type "), 0xfe07, {.d_i32 = typ}}, {_SLIT0, 0, { .d_c = 0 }}})) );
	}
	Option_string _t1382 =  _t1383;
	return _t1382;
}

string sqlite__DB_str(sqlite__DB db) {
	string _t1384 = string__plus(string__plus(_SLIT("sqlite.DB{ conn: "), ptr_str(db.conn)), _SLIT(" }"));
	return _t1384;
}
...
Option_sqlite__DB sqlite__connect(string path) {
	...
	Option_sqlite__DB _t1386;
	opt_ok(&(sqlite__DB[]) { (sqlite__DB){.is_open = true,.conn = db,} }, (Option*)(&_t1386), sizeof(sqlite__DB));
	return _t1386;
}
...
Option_bool sqlite__DB_close(sqlite__DB* db) {
	...
	Option_bool _t1388;
	opt_ok(&(bool[]) { true }, (Option*)(&_t1388), sizeof(bool));
	return _t1388;
}
...
bool sqlite__DB_q_string_defer_0 = false;
	...
	string _t1391 = (val != ((byte*)(0)) ? (tos_clone(val)) : (_SLIT("")));
	// Defer begin
...
Option_sqlite__Row sqlite__DB_exec_one(sqlite__DB db, string query) {
	...
	Option_sqlite__Row _t1398;
	opt_ok(&(sqlite__Row[]) { (*(sqlite__Row*)/*ee elem_typ */array_get(rows, 0)) }, (Option*)(&_t1398), sizeof(sqlite__Row));
	return _t1398;
}

IError sqlite__DB_error_message(sqlite__DB db, int code, string query) {
	string msg = cstring_to_vstring(((char*)(sqlite3_errmsg(db.conn))));
	IError _t1399 = I_sqlite__SQLError_to_Interface_IError((sqlite__SQLError*)memdup(&(sqlite__SQLError){.msg =  str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = msg}}, {_SLIT(" ("), 0xfe10, {.d_s = query}}, {_SLIT(")"), 0, { .d_c = 0 }}})) ,.code = code,}, sizeof(sqlite__SQLError)));
	return _t1399;
}
...
VV_LOCAL_SYMBOL sqlite__Stmt sqlite__DB_new_init_stmt(sqlite__DB db, string query) {
	sqlite__Stmt _t1402 = (sqlite__Stmt){.stmt = sqlite__DB_init_stmt(db, query),.db = &db,};
	return _t1402;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_bind_int(sqlite__Stmt stmt, int idx, int v) {
	int _t1403 = sqlite3_bind_int(stmt.stmt, idx, v);
	return _t1403;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_bind_i64(sqlite__Stmt stmt, int idx, i64 v) {
	int _t1404 = sqlite3_bind_int64(stmt.stmt, idx, v);
	return _t1404;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_bind_f64(sqlite__Stmt stmt, int idx, f64 v) {
	int _t1405 = sqlite3_bind_double(stmt.stmt, idx, v);
	return _t1405;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_bind_text(sqlite__Stmt stmt, int idx, string s) {
	int _t1406 = sqlite3_bind_text(stmt.stmt, idx, s.str, s.len, 0);
	return _t1406;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_get_int(sqlite__Stmt stmt, int idx) {
	int _t1407 = sqlite3_column_int(stmt.stmt, idx);
	return _t1407;
}

VV_LOCAL_SYMBOL i64 sqlite__Stmt_get_i64(sqlite__Stmt stmt, int idx) {
	i64 _t1408 = sqlite3_column_int64(stmt.stmt, idx);
	return _t1408;
}

VV_LOCAL_SYMBOL f64 sqlite__Stmt_get_f64(sqlite__Stmt stmt, int idx) {
	f64 _t1409 = sqlite3_column_double(stmt.stmt, idx);
	return _t1409;
}

VV_LOCAL_SYMBOL string sqlite__Stmt_get_text(sqlite__Stmt stmt, int idx) {
	byte* b = sqlite3_column_text(stmt.stmt, idx);
	string _t1410 = byte_vstring(b);
	return _t1410;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_get_count(sqlite__Stmt stmt) {
	int _t1411 = sqlite3_column_count(stmt.stmt);
	return _t1411;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_step(sqlite__Stmt stmt) {
	int _t1412 = sqlite3_step(stmt.stmt);
	return _t1412;
}
...
VV_LOCAL_SYMBOL bool main__can_use_relative_paths(void) {
	string _t1415 = os__getenv(_SLIT("VERROR_PATHS"));
		bool _t1414 = ((string__eq(_t1415, _SLIT("absolute"))) ? (false) : (true));
	return _t1414;
}
...
VV_LOCAL_SYMBOL void main__cb_propagate_test_error(int line_nr, string file, string mod, string fn_name, string errmsg) {
	...
	if (os__is_file(file)) {
		Option_Array_string _t1416 = os__read_lines(file);
		if (_t1416.state != 0) { /*or block*/ 
			IError err = _t1416.err;
			*(Array_string*) _t1416.data = __new_array_with_default(line_nr + 1, 0, sizeof(string), &(string[]){_SLIT("")});
		}
 		Array_string source_lines =  (*(Array_string*)_t1416.data);
...
VV_LOCAL_SYMBOL void main__test_orm_sqlite(void) {
	Option_sqlite__DB _t1417 = sqlite__connect(_SLIT(":memory:"));
	if (_t1417.state != 0) { /*or block*/ 
		IError err = _t1417.err;
		v_panic(IError_str(err));
	}
 	sqlite__DB db =  (*(sqlite__DB*)_t1417.data);
	main__User u = (main__User){.id = 0,.age = 10,.name = _SLIT("test"),.is_customer = 0,.skipped_string = (string){.str=(byteptr)"", .is_lit=1},};
	
	// orm
	orm__OrmConnection _t1418 = I_sqlite__DB_to_Interface_orm__OrmConnection(&db);
	Option_void _t1419 = orm__OrmConnection_name_table[_t1418._typ]._method_create(_t1418._object, _SLIT("Module"), new_array_from_c_array(4, 4, sizeof(orm__OrmTableField), _MOV((orm__OrmTableField[4]){(orm__OrmTableField){.name = _SLIT("id"),.typ = 7,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(2, 2, sizeof(StructAttribute), _MOV((StructAttribute[2]){(StructAttribute){.name = _SLIT("primary"),.has_arg = 0,.arg = _SLIT(""),.kind = 0,},(StructAttribute){.name = _SLIT("sql"),.has_arg = 1,.arg = _SLIT("serial"),.kind = 0,},}))},(orm__OrmTableField){.name = _SLIT("name"),.typ = 18,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},(orm__OrmTableField){.name = _SLIT("nr_downloads"),.typ = 7,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},(orm__OrmTableField){.name = _SLIT("user"),.typ = 84,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},})));
	if (_t1419.state != 0 && _t1419.err._typ != _IError_None___index) { v_panic(IError_str(_t1419.err)); }
	Option_void _t1420 = orm__OrmConnection_name_table[_t1418._typ]._method_create(_t1418._object, _SLIT("userlist"), new_array_from_c_array(4, 4, sizeof(orm__OrmTableField), _MOV((orm__OrmTableField[4]){(orm__OrmTableField){.name = _SLIT("id"),.typ = 7,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(2, 2, sizeof(StructAttribute), _MOV((StructAttribute[2]){(StructAttribute){.name = _SLIT("primary"),.has_arg = 0,.arg = _SLIT(""),.kind = 0,},(StructAttribute){.name = _SLIT("sql"),.has_arg = 1,.arg = _SLIT("serial"),.kind = 0,},}))},(orm__OrmTableField){.name = _SLIT("age"),.typ = 7,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},(orm__OrmTableField){.name = _SLIT("name"),.typ = 18,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(1, 1, sizeof(StructAttribute), _MOV((StructAttribute[1]){(StructAttribute){.name = _SLIT("sql"),.has_arg = 1,.arg = _SLIT("username"),.kind = 1,},}))},(orm__OrmTableField){.name = _SLIT("is_customer"),.typ = 16,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},})));
	if (_t1420.state != 0 && _t1420.err._typ != _IError_None___index) { v_panic(IError_str(_t1420.err)); }
	
	// orm
	orm__OrmConnection _t1421 = I_sqlite__DB_to_Interface_orm__OrmConnection(&db);
	Option_void _t1422 = orm__OrmConnection_name_table[_t1421._typ]._method_insert(_t1421._object, _SLIT("userlist"), (orm__OrmQueryData){.fields = new_array_from_c_array(3, 3, sizeof(string), _MOV((string[3]){_SLIT("age"),_SLIT("name"),_SLIT("is_customer"),})),.data = new_array_from_c_array(3, 3, sizeof(orm__Primitive), _MOV((orm__Primitive[3]){(orm__Primitive){._int = memdup(&u.age, sizeof(int)),._typ = 7},(orm__Primitive){._string = memdup(&u.name.str, sizeof(string)),._typ = 18},(orm__Primitive){._bool = memdup(&u.is_customer, sizeof(bool)),._typ = 16},})),.types = new_array_from_c_array(0, 0, sizeof(int), _MOV((int[0]){})),.kinds = new_array_from_c_array(0, 0, sizeof(orm__OperationKind), _MOV((orm__OperationKind[0]){})),});
	if (_t1422.state != 0 && _t1422.err._typ != _IError_None___index) { v_panic(IError_str(_t1422.err)); }
	
	// orm
	orm__OrmConnection _t1423 = I_sqlite__DB_to_Interface_orm__OrmConnection(&db);
	Option_void _t1424 = orm__OrmConnection_name_table[_t1423._typ]._method_drop(_t1423._object, _SLIT("Module"));
	if (_t1424.state != 0 && _t1424.err._typ != _IError_None___index) { v_panic(IError_str(_t1424.err)); }
	Option_void _t1425 = orm__OrmConnection_name_table[_t1423._typ]._method_drop(_t1423._object, _SLIT("userlist"));
	if (_t1425.state != 0 && _t1425.err._typ != _IError_None___index) { v_panic(IError_str(_t1425.err)); }
}
