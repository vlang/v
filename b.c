	...
	#define V_COMMIT_HASH "09e3099"
#endif

#ifndef V_CURRENT_COMMIT_HASH
	#define V_CURRENT_COMMIT_HASH "5c48f11"
#endif
...
static string Array_orm__Primitive_str(Array_orm__Primitive a); // auto
static string indent_Array_orm__Primitive_str(Array_orm__Primitive a, int indent_count); // auto
static string Array_Array_orm__Primitive_str(Array_Array_orm__Primitive a); // auto
static string indent_Array_Array_orm__Primitive_str(Array_Array_orm__Primitive a, int indent_count); // auto
static string Array_int_str(Array_int a); // auto
static string indent_Array_int_str(Array_int a, int indent_count); // auto
static string orm__OperationKind_str(orm__OperationKind it); // auto
static string Array_orm__OperationKind_str(Array_orm__OperationKind a); // auto
static string indent_Array_orm__OperationKind_str(Array_orm__OperationKind a, int indent_count); // auto
static string orm__OrmQueryData_str(orm__OrmQueryData it); // auto
static string indent_orm__OrmQueryData_str(orm__OrmQueryData it, int indent_count); // auto
...
Option_string orm__orm_table_gen(string table, string para, bool defaults, int def_unique_len, Array_orm__OrmTableField fields, Option_string (*sql_from_v)(int ));
...
Option_Array_Array_orm__Primitive sqlite__DB_select(sqlite__DB db, orm__OrmSelectConfig config, orm__OrmQueryData data, orm__OrmQueryData where);
Option_void sqlite__DB_insert(sqlite__DB db, string table, orm__OrmQueryData data);
Option_void sqlite__DB_update(sqlite__DB db, string table, orm__OrmQueryData data, orm__OrmQueryData where);
Option_void sqlite__DB_delete(sqlite__DB db, string table, orm__OrmQueryData data, orm__OrmQueryData where);
Option_void sqlite__DB_create(sqlite__DB db, string table, Array_orm__OrmTableField fields);
Option_void sqlite__DB_drop(sqlite__DB db, string table);
VV_LOCAL_SYMBOL Option_void sqlite__sqlite_stmt_worker(sqlite__DB db, string query, orm__OrmQueryData data, orm__OrmQueryData where);
VV_LOCAL_SYMBOL Option_void sqlite__sqlite_stmt_binder(sqlite__Stmt stmt, orm__OrmQueryData d, string query);
...
VV_LOCAL_SYMBOL sqlite__Stmt sqlite__DB_new_init_stmt(sqlite__DB db, string query);
...
// ^^^ number of types for interface IError: 3
...
static orm__OrmConnection I_sqlite__DB_to_Interface_orm__OrmConnection(sqlite__DB* x);
int _orm__OrmConnection_sqlite__DB_index = 0;
// ^^^ number of types for interface orm__OrmConnection: 1

// Methods wrapper for interface "orm__OrmConnection"
static inline Option_Array_Array_orm__Primitive sqlite__DB_select_Interface_orm__OrmConnection_method_wrapper(sqlite__DB* db, orm__OrmSelectConfig config, orm__OrmQueryData data, orm__OrmQueryData where) {
	return sqlite__DB_select(*db, config, data, where);
}
static inline Option_void sqlite__DB_insert_Interface_orm__OrmConnection_method_wrapper(sqlite__DB* db, string table, orm__OrmQueryData data) {
	return sqlite__DB_insert(*db, table, data);
}
static inline Option_void sqlite__DB_update_Interface_orm__OrmConnection_method_wrapper(sqlite__DB* db, string table, orm__OrmQueryData data, orm__OrmQueryData where) {
	return sqlite__DB_update(*db, table, data, where);
}
static inline Option_void sqlite__DB_delete_Interface_orm__OrmConnection_method_wrapper(sqlite__DB* db, string table, orm__OrmQueryData data, orm__OrmQueryData where) {
	return sqlite__DB_delete(*db, table, data, where);
}
static inline Option_void sqlite__DB_create_Interface_orm__OrmConnection_method_wrapper(sqlite__DB* db, string table, Array_orm__OrmTableField fields) {
	return sqlite__DB_create(*db, table, fields);
}
static inline Option_void sqlite__DB_drop_Interface_orm__OrmConnection_method_wrapper(sqlite__DB* db, string table) {
	return sqlite__DB_drop(*db, table);
}

typedef Option_Array_Array_orm__Primitive (*_orm__OrmConnection_select_fn)(void* _, orm__OrmSelectConfig config, orm__OrmQueryData data, orm__OrmQueryData where);
typedef Option_void (*_orm__OrmConnection_insert_fn)(void* _, string table, orm__OrmQueryData data);
typedef Option_void (*_orm__OrmConnection_update_fn)(void* _, string table, orm__OrmQueryData data, orm__OrmQueryData where);
typedef Option_void (*_orm__OrmConnection_delete_fn)(void* _, string table, orm__OrmQueryData data, orm__OrmQueryData where);
typedef Option_void (*_orm__OrmConnection_create_fn)(void* _, string table, Array_orm__OrmTableField fields);
typedef Option_void (*_orm__OrmConnection_drop_fn)(void* _, string talbe);

struct _orm__OrmConnection_interface_methods {
	_orm__OrmConnection_select_fn _method_select;
	_orm__OrmConnection_insert_fn _method_insert;
	_orm__OrmConnection_update_fn _method_update;
	_orm__OrmConnection_delete_fn _method_v_delete;
	_orm__OrmConnection_create_fn _method_create;
	_orm__OrmConnection_drop_fn _method_drop;
};

struct _orm__OrmConnection_interface_methods orm__OrmConnection_name_table[1] = {
	{
		._method_select = (void*) sqlite__DB_select_Interface_orm__OrmConnection_method_wrapper,
		._method_insert = (void*) sqlite__DB_insert_Interface_orm__OrmConnection_method_wrapper,
		._method_update = (void*) sqlite__DB_update_Interface_orm__OrmConnection_method_wrapper,
		._method_v_delete = (void*) sqlite__DB_delete_Interface_orm__OrmConnection_method_wrapper,
		._method_create = (void*) sqlite__DB_create_Interface_orm__OrmConnection_method_wrapper,
		._method_drop = (void*) sqlite__DB_drop_Interface_orm__OrmConnection_method_wrapper,
	},
};


// Casting functions for converting "sqlite__DB" to interface "orm__OrmConnection"
static inline orm__OrmConnection I_sqlite__DB_to_Interface_orm__OrmConnection(sqlite__DB* x) {
	return (orm__OrmConnection) {
		._sqlite__DB = x,
		._typ = _orm__OrmConnection_sqlite__DB_index,
	};
}
...
static string indent_orm__Primitive_str(orm__Primitive x, int indent_count) {
	switch(x._typ) {
		case 16: return str_intp(2, _MOV((StrIntpData[]){
				...
				{_SLIT("')"), 0, {.d_c = 0 }}
			}));		case 141: return str_intp(2, _MOV((StrIntpData[]){
...
static string Array_orm__Primitive_str(Array_orm__Primitive a) { return indent_Array_orm__Primitive_str(a, 0);}
static string indent_Array_orm__Primitive_str(Array_orm__Primitive a, int indent_count) {
	strings__Builder sb = strings__new_builder(a.len * 10);
	strings__Builder_write_string(&sb, _SLIT("["));
	for (int i = 0; i < a.len; ++i) {
		orm__Primitive it = *(orm__Primitive*)array_get(a, i);
		string x = indent_orm__Primitive_str(it, indent_count);
...
static string Array_Array_orm__Primitive_str(Array_Array_orm__Primitive a) { return indent_Array_Array_orm__Primitive_str(a, 0);}
static string indent_Array_Array_orm__Primitive_str(Array_Array_orm__Primitive a, int indent_count) {
	strings__Builder sb = strings__new_builder(a.len * 10);
	strings__Builder_write_string(&sb, _SLIT("["));
	for (int i = 0; i < a.len; ++i) {
		Array_orm__Primitive it = *(Array_orm__Primitive*)array_get(a, i);
		string x = indent_Array_orm__Primitive_str(it, indent_count);
		strings__Builder_write_string(&sb, x);
		if (i < a.len-1) {
			strings__Builder_write_string(&sb, _SLIT(", "));
		}
...
static string orm__OperationKind_str(orm__OperationKind it) { /* gen_str_for_enum */
	switch(it) {
		case orm__OperationKind_neq: return _SLIT("neq");
		case orm__OperationKind_eq: return _SLIT("eq");
		case orm__OperationKind_gt: return _SLIT("gt");
		case orm__OperationKind_lt: return _SLIT("lt");
		case orm__OperationKind_ge: return _SLIT("ge");
		case orm__OperationKind_le: return _SLIT("le");
		default: return _SLIT("unknown enum value");
	}
}
static string Array_orm__OperationKind_str(Array_orm__OperationKind a) { return indent_Array_orm__OperationKind_str(a, 0);}
static string indent_Array_orm__OperationKind_str(Array_orm__OperationKind a, int indent_count) {
	strings__Builder sb = strings__new_builder(a.len * 10);
	strings__Builder_write_string(&sb, _SLIT("["));
	for (int i = 0; i < a.len; ++i) {
		orm__OperationKind it = *(orm__OperationKind*)array_get(a, i);
		strings__Builder_write_string(&sb, _SLIT(""));
		string x = orm__OperationKind_str(  it);
		strings__Builder_write_string(&sb, x);
		if (i < a.len-1) {
			strings__Builder_write_string(&sb, _SLIT(", "));
		}
...
static string orm__OrmQueryData_str(orm__OrmQueryData it) { return indent_orm__OrmQueryData_str(it, 0);}
static string indent_orm__OrmQueryData_str(orm__OrmQueryData it, int indent_count) {
	string indents = _SLIT("");
	for (int i = 0; i < indent_count; ++i) {
		indents = string__plus(indents, _SLIT("    "));
	}
	return str_intp( 19, _MOV((StrIntpData[]){
		{_SLIT("orm.OrmQueryData{\n"), 0, {.d_c=0}},
		{_SLIT0, 0xfe10, {.d_s=indents}}, {_SLIT("    fields: "), 0, {.d_c=0}}, {_SLIT(""), 16, {.d_s=Array_string_str(it.fields)}}, {_SLIT(""), 0, {.d_c=0}},
		{_SLIT("\n"), 0xfe10, {.d_s=indents}}, {_SLIT("    data: "), 0, {.d_c=0}}, {_SLIT(""), 16, {.d_s=indent_Array_orm__Primitive_str(it.data, indent_count + 1)}}, {_SLIT(""), 0, {.d_c=0}},
		{_SLIT("\n"), 0xfe10, {.d_s=indents}}, {_SLIT("    types: "), 0, {.d_c=0}}, {_SLIT(""), 16, {.d_s=indent_Array_int_str(it.types, indent_count + 1)}}, {_SLIT(""), 0, {.d_c=0}},
		{_SLIT("\n"), 0xfe10, {.d_s=indents}}, {_SLIT("    kinds: "), 0, {.d_c=0}}, {_SLIT(""), 16, {.d_s=indent_Array_orm__OperationKind_str(it.kinds, indent_count + 1)}}, {_SLIT(""), 0, {.d_c=0}},
...
static inline orm__Primitive time__Time_to_sumtype_orm__Primitive(time__Time* x) {
	...
	return (orm__Primitive){ ._time__Time = ptr, ._typ = 141};
}
...
static char * v_typeof_interface_orm__OrmConnection(int sidx) { /* orm.OrmConnection */ 
	if (sidx == _orm__OrmConnection_sqlite__DB_index) return "sqlite.DB";
...
Option_void os__cp_all(string src, string dst, bool overwrite) {
	...
	if (_t844.state != 0) { /*or block*/ 
 	...
 	Array_string files =  (*(Array_string*)_t844.data);
	// FOR IN array
...
VV_LOCAL_SYMBOL Option_Array_ustring os__read_ulines(string path) {
	...
	if (_t860.state != 0) { /*or block*/ 
 	...
 	Array_string lines =  (*(Array_string*)_t860.data);
...
Option_void os__rmdir_all(string path) {
	...
	if (_t887.state != 0) { /*or block*/ 
 	...
 	Array_string items =  (*(Array_string*)_t887.data);
	// FOR IN array
...
bool os__is_dir_empty(string path) {
	...
	if (_t894.state != 0) { /*or block*/ 
 	...
 	Array_string items =  (*(Array_string*)_t894.data);
	return items.len == 0;
}
...
Option_void os__write_file_array(string path, array buffer) {
	...
	if (_t931.state != 0) { /*or block*/ 
 	...
 	os__File f =  (*(os__File*)_t931.data);
	...
	if (!os__is_abs_path(exepath)) {
		if (string_contains(exepath, _const_os__path_separator)) {
			...
			if (_t934.state != 0) { /*or block*/ 
 			...
 			string foundpath =  (*(string*)_t934.data);
			if (foundpath.len > 0) {
				exepath = foundpath;
			}
		}
...
Array_string os__walk_ext(string path, string ext) {
	...
	if (_t952.state != 0) { /*or block*/ 
 	...
 	Array_string files =  (*(Array_string*)_t952.data);
	Array_string res = __new_array_with_default(0, 0, sizeof(string), 0);
...
void os__walk(string path, void (*f)(string )) {
	...
	if (_t958.state != 0) { /*or block*/ 
 	...
 	Array_string files =  (*(Array_string*)_t958.data);
...
bool os__Command_start_defer_0 = false;
	string pcmd = string__plus(c->path, _SLIT(" 2>&1"));
...
strings__textscanner__TextScanner strings__textscanner__new(string input) {
	strings__textscanner__TextScanner _t1118 = (strings__textscanner__TextScanner){.input = input,.ilen = input.len,.pos = 0,};
	return _t1118;
}
...
inline int strings__textscanner__TextScanner_peek(strings__textscanner__TextScanner* ss) {
	if (ss->pos < ss->ilen) {
		int _t1122 = ss->input.str[ ss->pos];
		return _t1122;
	}
	int _t1123 = -1;
	return _t1123;
...
inline int strings__textscanner__TextScanner_peek_n(strings__textscanner__TextScanner* ss, int n) {
	if (ss->pos + n < ss->ilen) {
		int _t1124 = ss->input.str[ ss->pos + n];
		return _t1124;
	}
	int _t1125 = -1;
	return _t1125;
...
string time__Time_format(time__Time t) {
	string _t1126 = time__Time_get_fmt_str(t, time__FormatDelimiter_hyphen, time__FormatTime_hhmm24, time__FormatDate_yyyymmdd);
	return _t1126;
}

string time__Time_format_ss(time__Time t) {
	string _t1127 = time__Time_get_fmt_str(t, time__FormatDelimiter_hyphen, time__FormatTime_hhmmss24, time__FormatDate_yyyymmdd);
	return _t1127;
}

string time__Time_format_ss_milli(time__Time t) {
	string _t1128 = time__Time_get_fmt_str(t, time__FormatDelimiter_hyphen, time__FormatTime_hhmmss24_milli, time__FormatDate_yyyymmdd);
	return _t1128;
}

string time__Time_format_ss_micro(time__Time t) {
	string _t1129 = time__Time_get_fmt_str(t, time__FormatDelimiter_hyphen, time__FormatTime_hhmmss24_micro, time__FormatDate_yyyymmdd);
	return _t1129;
}

string time__Time_hhmm(time__Time t) {
	string _t1130 = time__Time_get_fmt_time_str(t, time__FormatTime_hhmm24);
	return _t1130;
}

string time__Time_hhmmss(time__Time t) {
	string _t1131 = time__Time_get_fmt_time_str(t, time__FormatTime_hhmmss24);
	return _t1131;
}

string time__Time_hhmm12(time__Time t) {
	string _t1132 = time__Time_get_fmt_time_str(t, time__FormatTime_hhmm12);
	return _t1132;
}

string time__Time_ymmdd(time__Time t) {
	string _t1133 = time__Time_get_fmt_date_str(t, time__FormatDelimiter_hyphen, time__FormatDate_yyyymmdd);
	return _t1133;
}

string time__Time_ddmmy(time__Time t) {
	string _t1134 = time__Time_get_fmt_date_str(t, time__FormatDelimiter_dot, time__FormatDate_ddmmyyyy);
	return _t1134;
}

string time__Time_md(time__Time t) {
	string _t1135 = time__Time_get_fmt_date_str(t, time__FormatDelimiter_space, time__FormatDate_mmmd);
	return _t1135;
}
...
string time__Time_clean(time__Time t) {
	...
	if (t.month == znow.month && t.year == znow.year && t.day == znow.day) {
		string _t1136 = time__Time_get_fmt_time_str(t, time__FormatTime_hhmm24);
		return _t1136;
	}
	if (t.year == znow.year) {
		string _t1137 = time__Time_get_fmt_str(t, time__FormatDelimiter_space, time__FormatTime_hhmm24, time__FormatDate_mmmd);
		return _t1137;
	}
	string _t1138 = time__Time_format(t);
	return _t1138;
}
...
string time__Time_clean12(time__Time t) {
	time__Time znow = time__now();
	if (t.month == znow.month && t.year == znow.year && t.day == znow.day) {
		string _t1139 = time__Time_get_fmt_time_str(t, time__FormatTime_hhmm12);
		return _t1139;
	}
	if (t.year == znow.year) {
		string _t1140 = time__Time_get_fmt_str(t, time__FormatDelimiter_space, time__FormatTime_hhmm12, time__FormatDate_mmmd);
		return _t1140;
	}
	string _t1141 = time__Time_format(t);
	return _t1141;
}
...
string time__Time_get_fmt_str(time__Time t, time__FormatDelimiter fmt_dlmtr, time__FormatTime fmt_time, time__FormatDate fmt_date) {
	if (fmt_date == time__FormatDate_no_date) {
		if (fmt_time == time__FormatTime_no_time) {
			...
			string _t1147 = time__Time_get_fmt_time_str(t, fmt_time);
			return _t1147;
		}
	} else {
		if (fmt_time != time__FormatTime_no_time) {
			string _t1148 = string__plus(string__plus(time__Time_get_fmt_date_str(t, fmt_dlmtr, fmt_date), _SLIT(" ")), time__Time_get_fmt_time_str(t, fmt_time));
			return _t1148;
		} else {
			string _t1149 = time__Time_get_fmt_date_str(t, fmt_dlmtr, fmt_date);
			return _t1149;
		}
	}
	return (string){.str=(byteptr)"", .is_lit=1};
...
inline bool time__Time__eq(time__Time t1, time__Time t2) {
	bool _t1151 = t1.v_unix == t2.v_unix && t1.microsecond == t2.microsecond;
	return _t1151;
}

// Attr: [inline]
inline bool time__Time__lt(time__Time t1, time__Time t2) {
	bool _t1152 = t1.v_unix < t2.v_unix || (t1.v_unix == t2.v_unix && t1.microsecond < t2.microsecond);
	return _t1152;
}
...
inline time__Duration time__Time__minus(time__Time lhs, time__Time rhs) {
	...
	time__Duration _t1153 = (((i64)(lhs_micro)) - ((i64)(rhs_micro))) * _const_time__microsecond;
	return _t1153;
}

Option_time__Time time__parse(string s) {
	Option_int _t1154 = string_index(s, _SLIT(" "));
	...
	Option_time__Time _t1157;
	opt_ok(&(time__Time[]) { res }, (Option*)(&_t1157), sizeof(time__Time));
	return _t1157;
}
...
Option_time__Time time__parse_rfc2822(string s) {
	...
	Option_int _t1159 = string_index(_const_time__months_string, (*(string*)/*ee elem_typ */array_get(fields, 2)));
	if (_t1159.state != 0) { /*or block*/ 
		IError err = _t1159.err;
		return (Option_time__Time){ .state=2, .err=v_error( str_intp(2, _MOV((StrIntpData[]){{_SLIT("Invalid time format: "), 0xfe10, {.d_s = s}}, {_SLIT0, 0, { .d_c = 0 }}})) ), .data={0} };
	}
 	int pos =  (*(int*)_t1159.data);
	int mm = pos / 3 + 1;
	{ // Unsafe block
		...
		Option_time__Time _t1161 = time__parse(tos(tmstr, count));
		return _t1161;
	}
...
VV_LOCAL_SYMBOL Option_multi_return_int_int_int time__parse_iso8601_date(string s) {
	...
	Option_multi_return_int_int_int _t1163;
	opt_ok(&(multi_return_int_int_int/*X*/[]) { (multi_return_int_int_int){.arg0=year, .arg1=month, .arg2=day} }, (Option*)(&_t1163), sizeof(multi_return_int_int_int));
	return _t1163;
}
...
VV_LOCAL_SYMBOL Option_multi_return_int_int_int_int_i64_bool time__parse_iso8601_time(string s) {
	...
	Option_multi_return_int_int_int_int_i64_bool _t1167;
	opt_ok(&(multi_return_int_int_int_int_i64_bool/*X*/[]) { (multi_return_int_int_int_int_i64_bool){.arg0=hour_, .arg1=minute_, .arg2=second_, .arg3=microsecond_, .arg4=unix_offset, .arg5=is_local_time} }, (Option*)(&_t1167), sizeof(multi_return_int_int_int_int_i64_bool));
	return _t1167;
}

Option_time__Time time__parse_iso8601(string s) {
	Option_int _t1168 = string_index(s, _SLIT("T"));
	if (_t1168.state != 0) { /*or block*/ 
		IError err = _t1168.err;
		*(int*) _t1168.data = -1;
	}
 	int t_i =  (*(int*)_t1168.data);
	...
	Option_multi_return_int_int_int _t1170 = time__parse_iso8601_date((*(string*)/*ee elem_typ */array_get(parts, 0)));
	if (_t1170.state != 0) { /*or block*/ 
		Option_time__Time _t1171;
		memcpy(&_t1171, &_t1170, sizeof(Option));
		return _t1171;
	}
 	Option_multi_return_int_int_int mr_3486 =  _t1170 /*U*/;
	...
	if (parts.len == 2) {
		Option_multi_return_int_int_int_int_i64_bool _t1172 = time__parse_iso8601_time((*(string*)/*ee elem_typ */array_get(parts, 1)));
		if (_t1172.state != 0) { /*or block*/ 
			Option_time__Time _t1173;
			memcpy(&_t1173, &_t1172, sizeof(Option));
			return _t1173;
		}
 		Option_multi_return_int_int_int_int_i64_bool mr_3728 =  _t1172 /*U*/;
	...
	if (is_local_time) {
		Option_time__Time _t1174;
		opt_ok(&(time__Time[]) { t }, (Option*)(&_t1174), sizeof(time__Time));
		return _t1174;
	}
	...
	Option_time__Time _t1175;
	opt_ok(&(time__Time[]) { t }, (Option*)(&_t1175), sizeof(time__Time));
	return _t1175;
}
...
time__StopWatch time__new_stopwatch(time__StopWatchOptions opts) {
	...
	time__StopWatch _t1176 = (time__StopWatch){.elapsed = 0U,.start = initial,.end = 0U,};
	return _t1176;
}
...
time__Duration time__StopWatch_elapsed(time__StopWatch t) {
	if (t.start > 0U) {
		if (t.end == 0U) {
			time__Duration _t1177 = ((((i64)(time__sys_mono_now() - t.start + t.elapsed))));
			return _t1177;
		} else {
			time__Duration _t1178 = ((((i64)(t.end - t.start + t.elapsed))));
			return _t1178;
		}
	}
	time__Duration _t1179 = ((((i64)(t.elapsed))));
	return _t1179;
}
...
time__Time time__now(void) {
	...
	{
		time__Time _t1180 = time__linux_now();
		return _t1180;
	}
	#endif
	time_t t = time(0);
	struct tm* now = localtime(&t);
	time__Time _t1181 = time__convert_ctime(*now, 0);
	return _t1181;
}
...
time__Time time__utc(void) {
	#if defined(__linux__) || defined(__ANDROID__)
	{
		time__Time _t1182 = time__linux_utc();
		return _t1182;
	}
	#endif
	time_t t = time(0);
	time(&t);
	time__Time _t1183 = time__unix2(((int)(t)), 0);
	return _t1183;
}
...
string time__Time_smonth(time__Time t) {
	...
	int i = t.month - 1;
	string _t1185 = string_substr(_const_time__months_string, i * 3, (i + 1) * 3);
	return _t1185;
}
...
time__Time time__new_time(time__Time t) {
	...
	time__Time _t1187 = (time__Time){t.year,t.month,t.day,t.hour,t.minute,t.second,t.microsecond,.v_unix = utime,};
	return _t1187;
}

// Attr: [inline]
inline int time__Time_unix_time(time__Time t) {
	int _t1188 = ((int)(t.v_unix));
	return _t1188;
}

// Attr: [inline]
inline u64 time__Time_unix_time_milli(time__Time t) {
	u64 _t1189 = t.v_unix * 1000U + ((u64)(t.microsecond / 1000));
	return _t1189;
}
...
time__Time time__Time_add(time__Time t, time__Duration d) {
	...
	time__Time _t1190 = time__unix2(((int)(v_unix)), ((int)(micro)));
	return _t1190;
}

time__Time time__Time_add_seconds(time__Time t, int seconds) {
	time__Time _t1191 = time__Time_add(t, seconds * _const_time__second);
	return _t1191;
}

time__Time time__Time_add_days(time__Time t, int days) {
	time__Time _t1192 = time__Time_add(t, days * 24 * _const_time__hour);
	return _t1192;
}
...
string time__Time_relative(time__Time t) {
	...
	if (secs <= 30U) {
		string _t1194 = _SLIT("now");
		return _t1194;
	}
	if (secs < 60U) {
		string _t1195 = _SLIT("1m");
		return _t1195;
	}
	if (secs < 3600U) {
		u64 m = secs / 60U;
		if (m == 1U) {
			string _t1196 = _SLIT("1 minute ago");
			return _t1196;
		}
		string _t1197 =  str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0xfe08, {.d_u64 = m}}, {_SLIT(" minutes ago"), 0, { .d_c = 0 }}})) ;
		return _t1197;
	}
	if (secs < 3600 * 24) {
		u64 h = secs / 3600U;
		if (h == 1U) {
			string _t1198 = _SLIT("1 hour ago");
			return _t1198;
		}
		string _t1199 =  str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0xfe08, {.d_u64 = h}}, {_SLIT(" hours ago"), 0, { .d_c = 0 }}})) ;
		return _t1199;
	}
	if (secs < 3600 * 24 * 5) {
		u64 d = secs / 3600U / 24U;
		if (d == 1U) {
			string _t1200 = _SLIT("1 day ago");
			return _t1200;
		}
		string _t1201 =  str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0xfe08, {.d_u64 = d}}, {_SLIT(" days ago"), 0, { .d_c = 0 }}})) ;
		return _t1201;
	}
...
string time__Time_relative_short(time__Time t) {
	...
	u64 secs = znow.v_unix - t.v_unix;
	if (secs <= 30U) {
		string _t1204 = _SLIT("now");
		return _t1204;
	}
	if (secs < 60U) {
		string _t1205 = _SLIT("1m");
		return _t1205;
	}
	if (secs < 3600U) {
		string _t1206 =  str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0xfe08, {.d_u64 = secs / 60U}}, {_SLIT("m"), 0, { .d_c = 0 }}})) ;
		return _t1206;
	}
	if (secs < 3600 * 24) {
		string _t1207 =  str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0xfe08, {.d_u64 = secs / 3600U}}, {_SLIT("h"), 0, { .d_c = 0 }}})) ;
		return _t1207;
	}
	if (secs < 3600 * 24 * 5) {
		string _t1208 =  str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0xfe08, {.d_u64 = secs / 3600U / 24U}}, {_SLIT("d"), 0, { .d_c = 0 }}})) ;
		return _t1208;
	}
	if (secs > 3600 * 24 * 10000) {
		string _t1209 = _SLIT("");
...
int time__day_of_week(int y, int m, int d) {
	...
	int _t1211 = (sy + sy / 4 - sy / 100 + sy / 400 + (*(int*)/*ee elem_typ */array_get(t, m - 1)) + d - 1) % 7 + 1;
	return _t1211;
}

int time__Time_day_of_week(time__Time t) {
	int _t1212 = time__day_of_week(t.year, t.month, t.day);
	return _t1212;
}

string time__Time_weekday_str(time__Time t) {
	int i = time__Time_day_of_week(t) - 1;
	string _t1213 = string_substr(_const_time__days_string, i * 3, (i + 1) * 3);
	return _t1213;
}

string time__Time_long_weekday_str(time__Time t) {
	int i = time__Time_day_of_week(t) - 1;
	string _t1214 = (*(string*)/*ee elem_typ */array_get(_const_time__long_days, i));
	return _t1214;
}
...
i64 time__ticks(void) {
	...
	#else
	{
		...
		gettimeofday(&ts, 0);
		i64 _t1215 = ((i64)(ts.tv_sec * ((u64)(1000U)) + (ts.tv_usec / ((u64)(1000U)))));
		return _t1215;
	}
	#endif
	return 0;
...
bool time__is_leap_year(int year) {
	bool _t1216 = (year % 4 == 0) && (year % 100 != 0 || year % 400 == 0);
	return _t1216;
}
...
Option_int time__days_in_month(int month, int year) {
	...
	Option_int _t1218;
	opt_ok(&(int[]) { res }, (Option*)(&_t1218), sizeof(int));
	return _t1218;
}

string time__Time_str(time__Time t) {
	string _t1219 = time__Time_format_ss(t);
	return _t1219;
}

VV_LOCAL_SYMBOL time__Time time__convert_ctime(struct tm t, int microsecond) {
	time__Time _t1220 = (time__Time){
		.year = t.tm_year + 1900,
		.month = t.tm_mon + 1,
		.day = t.tm_mday,
		.hour = t.tm_hour,
...
i64 time__Duration_microseconds(time__Duration d) {
	i64 _t1222 = ((i64)(d)) / 1000;
	return _t1222;
}

i64 time__Duration_milliseconds(time__Duration d) {
	i64 _t1223 = ((i64)(d)) / 1000000;
	return _t1223;
}
...
f64 time__Duration_seconds(time__Duration d) {
	...
	f64 _t1224 = ((f64)(sec)) + ((f64)(nsec)) / 1e9;
	return _t1224;
}
...
f64 time__Duration_minutes(time__Duration d) {
	...
	f64 _t1225 = ((f64)(min)) + ((f64)(nsec)) / (60 * 1e9);
	return _t1225;
}
...
f64 time__Duration_hours(time__Duration d) {
	...
	f64 _t1226 = ((f64)(hr)) + ((f64)(nsec)) / (60 * 60 * 1e9);
	return _t1226;
}
...
int time__offset(void) {
	...
	int _t1227 = ((int)(local.v_unix - t.v_unix));
	return _t1227;
}
...
time__Time time__darwin_now(void) {
	time__Time _t1229 = (time__Time){.year = 0,.month = 0,.day = 0,.hour = 0,.minute = 0,.second = 0,.microsecond = 0,.v_unix = 0,};
	return _t1229;
}

time__Time time__solaris_now(void) {
	time__Time _t1230 = (time__Time){.year = 0,.month = 0,.day = 0,.hour = 0,.minute = 0,.second = 0,.microsecond = 0,.v_unix = 0,};
	return _t1230;
}

time__Time time__darwin_utc(void) {
	time__Time _t1231 = (time__Time){.year = 0,.month = 0,.day = 0,.hour = 0,.minute = 0,.second = 0,.microsecond = 0,.v_unix = 0,};
	return _t1231;
}

time__Time time__solaris_utc(void) {
	time__Time _t1232 = (time__Time){.year = 0,.month = 0,.day = 0,.hour = 0,.minute = 0,.second = 0,.microsecond = 0,.v_unix = 0,};
	return _t1232;
}

VV_LOCAL_SYMBOL int time__make_unix_time(struct tm t) {
	int _t1233 = ((int)(timegm(&t)));
	return _t1233;
}
...
time__Time time__Time_local(time__Time t) {
	...
	time__Time _t1234 = time__convert_ctime(loc_tm, t.microsecond);
	return _t1234;
}
...
u64 time__sys_mono_now(void) {
	...
	#else
	{
		...
		u64 _t1235 = ((u64)(ts.tv_sec)) * 1000000000U + ((u64)(ts.tv_nsec));
		return _t1235;
	}
	#endif
	return 0;
...
inline VV_LOCAL_SYMBOL u64 time__vpc_now(void) {
	struct timespec ts = (struct timespec){.tv_sec = 0,.tv_nsec = 0,};
	clock_gettime(CLOCK_MONOTONIC, &ts);
	u64 _t1236 = ((u64)(ts.tv_sec)) * 1000000000U + ((u64)(ts.tv_nsec));
	return _t1236;
}
...
VV_LOCAL_SYMBOL time__Time time__linux_now(void) {
	...
	time__Time _t1237 = time__convert_ctime(loc_tm, ((int)(ts.tv_nsec / 1000)));
	return _t1237;
}
...
VV_LOCAL_SYMBOL time__Time time__linux_utc(void) {
	struct timespec ts = (struct timespec){.tv_sec = 0,.tv_nsec = 0,};
	clock_gettime(CLOCK_REALTIME, &ts);
	time__Time _t1238 = time__unix2(((int)(ts.tv_sec)), ((int)(ts.tv_nsec / 1000)));
	return _t1238;
}

time__Time time__win_now(void) {
	time__Time _t1239 = (time__Time){.year = 0,.month = 0,.day = 0,.hour = 0,.minute = 0,.second = 0,.microsecond = 0,.v_unix = 0,};
	return _t1239;
}

time__Time time__win_utc(void) {
	time__Time _t1240 = (time__Time){.year = 0,.month = 0,.day = 0,.hour = 0,.minute = 0,.second = 0,.microsecond = 0,.v_unix = 0,};
	return _t1240;
}
...
string term__format(string msg, string open, string close) {
	string _t1248 = string__plus(string__plus(string__plus(string__plus(string__plus(string__plus(_SLIT("\x1b["), open), _SLIT("m")), msg), _SLIT("\x1b[")), close), _SLIT("m"));
	return _t1248;
}

string term__format_rgb(int r, int g, int b, string msg, string open, string close) {
	string _t1249 = string__plus(string__plus(string__plus(string__plus(string__plus(string__plus(string__plus(string__plus(string__plus(string__plus(string__plus(string__plus(_SLIT("\x1b["), open), _SLIT(";2;")), int_str(r)), _SLIT(";")), int_str(g)), _SLIT(";")), int_str(b)), _SLIT("m")), msg), _SLIT("\x1b[")), close), _SLIT("m"));
	return _t1249;
}

string term__rgb(int r, int g, int b, string msg) {
	string _t1250 = term__format_rgb(r, g, b, msg, _SLIT("38"), _SLIT("39"));
	return _t1250;
}

string term__bg_rgb(int r, int g, int b, string msg) {
	string _t1251 = term__format_rgb(r, g, b, msg, _SLIT("48"), _SLIT("49"));
	return _t1251;
}

string term__hex(int hex, string msg) {
	string _t1252 = term__format_rgb(hex >> 16, (hex >> 8 & 0xFF), (hex & 0xFF), msg, _SLIT("38"), _SLIT("39"));
	return _t1252;
}

string term__bg_hex(int hex, string msg) {
	string _t1253 = term__format_rgb(hex >> 16, (hex >> 8 & 0xFF), (hex & 0xFF), msg, _SLIT("48"), _SLIT("49"));
	return _t1253;
}

string term__bg_black(string msg) {
	string _t1254 = term__format(msg, _SLIT("40"), _SLIT("49"));
	return _t1254;
}

string term__bright_bg_black(string msg) {
	string _t1255 = term__format(msg, _SLIT("100"), _SLIT("49"));
	return _t1255;
}

string term__bg_blue(string msg) {
	string _t1256 = term__format(msg, _SLIT("44"), _SLIT("49"));
	return _t1256;
}

string term__bright_bg_blue(string msg) {
	string _t1257 = term__format(msg, _SLIT("104"), _SLIT("49"));
	return _t1257;
}

string term__bg_cyan(string msg) {
	string _t1258 = term__format(msg, _SLIT("46"), _SLIT("49"));
	return _t1258;
}

string term__bright_bg_cyan(string msg) {
	string _t1259 = term__format(msg, _SLIT("106"), _SLIT("49"));
	return _t1259;
}

string term__bg_green(string msg) {
	string _t1260 = term__format(msg, _SLIT("42"), _SLIT("49"));
	return _t1260;
}

string term__bright_bg_green(string msg) {
	string _t1261 = term__format(msg, _SLIT("102"), _SLIT("49"));
	return _t1261;
}

string term__bg_magenta(string msg) {
	string _t1262 = term__format(msg, _SLIT("45"), _SLIT("49"));
	return _t1262;
}

string term__bright_bg_magenta(string msg) {
	string _t1263 = term__format(msg, _SLIT("105"), _SLIT("49"));
	return _t1263;
}

string term__bg_red(string msg) {
	string _t1264 = term__format(msg, _SLIT("41"), _SLIT("49"));
	return _t1264;
}

string term__bright_bg_red(string msg) {
	string _t1265 = term__format(msg, _SLIT("101"), _SLIT("49"));
	return _t1265;
}

string term__bg_white(string msg) {
	string _t1266 = term__format(msg, _SLIT("47"), _SLIT("49"));
	return _t1266;
}

string term__bright_bg_white(string msg) {
	string _t1267 = term__format(msg, _SLIT("107"), _SLIT("49"));
	return _t1267;
}

string term__bg_yellow(string msg) {
	string _t1268 = term__format(msg, _SLIT("43"), _SLIT("49"));
	return _t1268;
}

string term__bright_bg_yellow(string msg) {
	string _t1269 = term__format(msg, _SLIT("103"), _SLIT("49"));
	return _t1269;
}

string term__black(string msg) {
	string _t1270 = term__format(msg, _SLIT("30"), _SLIT("39"));
	return _t1270;
}

string term__bright_black(string msg) {
	string _t1271 = term__format(msg, _SLIT("90"), _SLIT("39"));
	return _t1271;
}

string term__blue(string msg) {
	string _t1272 = term__format(msg, _SLIT("34"), _SLIT("39"));
	return _t1272;
}

string term__bright_blue(string msg) {
	string _t1273 = term__format(msg, _SLIT("94"), _SLIT("39"));
	return _t1273;
}

string term__bold(string msg) {
	string _t1274 = term__format(msg, _SLIT("1"), _SLIT("22"));
	return _t1274;
}

string term__cyan(string msg) {
	string _t1275 = term__format(msg, _SLIT("36"), _SLIT("39"));
	return _t1275;
}

string term__bright_cyan(string msg) {
	string _t1276 = term__format(msg, _SLIT("96"), _SLIT("39"));
	return _t1276;
}

string term__dim(string msg) {
	string _t1277 = term__format(msg, _SLIT("2"), _SLIT("22"));
	return _t1277;
}

string term__green(string msg) {
	string _t1278 = term__format(msg, _SLIT("32"), _SLIT("39"));
	return _t1278;
}

string term__bright_green(string msg) {
	string _t1279 = term__format(msg, _SLIT("92"), _SLIT("39"));
	return _t1279;
}

string term__gray(string msg) {
	string _t1280 = term__bright_black(msg);
	return _t1280;
}

string term__hidden(string msg) {
	string _t1281 = term__format(msg, _SLIT("8"), _SLIT("28"));
	return _t1281;
}

string term__italic(string msg) {
	string _t1282 = term__format(msg, _SLIT("3"), _SLIT("23"));
	return _t1282;
}

string term__inverse(string msg) {
	string _t1283 = term__format(msg, _SLIT("7"), _SLIT("27"));
	return _t1283;
}

string term__magenta(string msg) {
	string _t1284 = term__format(msg, _SLIT("35"), _SLIT("39"));
	return _t1284;
}

string term__bright_magenta(string msg) {
	string _t1285 = term__format(msg, _SLIT("95"), _SLIT("39"));
	return _t1285;
}

string term__reset(string msg) {
	string _t1286 = term__format(msg, _SLIT("0"), _SLIT("0"));
	return _t1286;
}

string term__red(string msg) {
	string _t1287 = term__format(msg, _SLIT("31"), _SLIT("39"));
	return _t1287;
}

string term__bright_red(string msg) {
	string _t1288 = term__format(msg, _SLIT("91"), _SLIT("39"));
	return _t1288;
}

string term__strikethrough(string msg) {
	string _t1289 = term__format(msg, _SLIT("9"), _SLIT("29"));
	return _t1289;
}

string term__underline(string msg) {
	string _t1290 = term__format(msg, _SLIT("4"), _SLIT("24"));
	return _t1290;
}

string term__white(string msg) {
	string _t1291 = term__format(msg, _SLIT("37"), _SLIT("39"));
	return _t1291;
}

string term__bright_white(string msg) {
	string _t1292 = term__format(msg, _SLIT("97"), _SLIT("39"));
	return _t1292;
}

string term__yellow(string msg) {
	string _t1293 = term__format(msg, _SLIT("33"), _SLIT("39"));
	return _t1293;
}

string term__bright_yellow(string msg) {
	string _t1294 = term__format(msg, _SLIT("93"), _SLIT("39"));
	return _t1294;
}
...
bool term__can_show_color_on_stdout(void) {
	bool _t1295 = term__supports_escape_sequences(1);
	return _t1295;
}

bool term__can_show_color_on_stderr(void) {
	bool _t1296 = term__supports_escape_sequences(2);
	return _t1296;
}

string term__ok_message(string s) {
	if (term__can_show_color_on_stdout()) {
		string _t1297 = term__green( str_intp(2, _MOV((StrIntpData[]){{_SLIT(" "), 0xfe10, {.d_s = s}}, {_SLIT(" "), 0, { .d_c = 0 }}})) );
		return _t1297;
	}
	return s;
}
...
string term__fail_message(string s) {
	if (term__can_show_color_on_stdout()) {
		string _t1299 = term__inverse(term__bg_white(term__bold(term__red( str_intp(2, _MOV((StrIntpData[]){{_SLIT(" "), 0xfe10, {.d_s = s}}, {_SLIT(" "), 0, { .d_c = 0 }}})) ))));
		return _t1299;
	}
	return s;
}
...
string term__warn_message(string s) {
	if (term__can_show_color_on_stdout()) {
		string _t1301 = term__bright_yellow( str_intp(2, _MOV((StrIntpData[]){{_SLIT(" "), 0xfe10, {.d_s = s}}, {_SLIT(" "), 0, { .d_c = 0 }}})) );
		return _t1301;
	}
	return s;
}
...
string term__strip_ansi(string text) {
	...
	string _t1306 = Array_byte_bytestr(output);
	return _t1306;
}
...
string term__h_divider(string divider) {
	...
	string _t1307 = string_substr(result, 0, cols);
	return _t1307;
}
...
string term__header_left(string text, string divider) {
	...
	string _t1308 =  str_intp(4, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = hstart}}, {_SLIT(" "), 0xfe10, {.d_s = text}}, {_SLIT(" "), 0xfe10, {.d_s = hend}}, {_SLIT0, 0, { .d_c = 0 }}})) ;
	return _t1308;
}

string term__header(string text, string divider) {
	if (text.len == 0) {
		string _t1309 = term__h_divider(divider);
		return _t1309;
	}
	...
	if (ln.len == 1) {
		string _t1310 = string__plus(string__plus(string__plus(string__plus(ln, _SLIT(" ")), string_substr(text, 0, tlimit)), _SLIT(" ")), ln);
		return _t1310;
	}
	string _t1311 = string__plus(string__plus(string__plus(string__plus(string_substr(ln, 0, tstart), _SLIT(" ")), string_substr(text, 0, tlimit)), _SLIT(" ")), string_substr(ln, tstart + tlimit + 2, cols));
	return _t1311;
}
...
term__Coord term__get_cursor_position(void) {
	if (os__is_atty(1) <= 0 || string__eq(os__getenv(_SLIT("TERM")), _SLIT("dumb"))) {
		term__Coord _t1319 = (term__Coord){.x = 0,.y = 0,};
		return _t1319;
	}
	...
	term__Coord _t1320 = (term__Coord){.x = x,.y = y,};
	return _t1320;
}
...
string orm__orm_select_gen(orm__OrmSelectConfig orm, string para, bool num, string qm, int start_pos, orm__OrmQueryData where) {
	...
	if (orm.has_order) {
		...
		str = /*f*/string__plus(str,  str_intp(4, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = para}}, {_SLIT0, 0xfe10, {.d_s = orm.primary}}, {_SLIT0, 0xfe10, {.d_s = para}}, {_SLIT0, 0, { .d_c = 0 }}})) );
	}
	if (orm.has_limit) {
...
Option_string orm__orm_table_gen(string table, string para, bool defaults, int def_unique_len, Array_orm__OrmTableField fields, Option_string (*sql_from_v)(int )) {
	...
	// FOR IN array
	for (int _t1327 = 0; _t1327 < fields.len; ++_t1327) {
		orm__OrmTableField field = ((orm__OrmTableField*)fields.data)[_t1327];
		bool no_null = false;
		bool is_unique = false;
		bool is_skip = false;
		int unique_len = 0;
		// FOR IN array
		for (int _t1328 = 0; _t1328 < field.attrs.len; ++_t1328) {
			StructAttribute attr = ((StructAttribute*)field.attrs.data)[_t1328];
		...
		Option_string _t1330 = sql_from_v(orm__sql_field_type(field));
		if (_t1330.state != 0) { /*or block*/ 
			IError err = _t1330.err;
			field_name =  str_intp(2, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = field.name}}, {_SLIT("_id"), 0, { .d_c = 0 }}})) ;
			Option_string _t1331 = sql_from_v(8);
			if (_t1331.state != 0) { /*or block*/ 
				Option_string _t1332;
				memcpy(&_t1332, &_t1331, sizeof(Option));
				return _t1332;
			}
 			*(string*) _t1330.data =  (*(string*)_t1331.data);
		}
 		string ctyp =  (*(string*)_t1330.data);
		if ((ctyp).len == 0) {
	...
	if ((primary).len == 0) {
		return (Option_string){ .state=2, .err=v_error(_SLIT("A primary key is required")), .data={0} };
	}
	if (unique.len > 0) {
		// FOR IN map
		int _t1338 = unique.key_values.len;
		for (int _t1337 = 0; _t1337 < _t1338; ++_t1337 ) {
			int _t1339 = unique.key_values.len - _t1338;
			_t1338 = unique.key_values.len;
			if (_t1339 < 0) {
				_t1337 = -1;
				continue;
			}
			if (!DenseArray_has_index(&unique.key_values, _t1337)) {continue;}
			string k = /*key*/ *(string*)DenseArray_key(&unique.key_values, _t1337);
			k = string_clone(k);
			Array_string v = (*(Array_string*)DenseArray_value(&unique.key_values, _t1337));
			Array_string tmp = __new_array_with_default(0, 0, sizeof(string), 0);
			// FOR IN array
			for (int _t1340 = 0; _t1340 < v.len; ++_t1340) {
				string f = ((string*)v.data)[_t1340];
	...
	_PUSH_MANY(&fs, (unique_fields), _t1344, Array_string);
	str = /*f*/string__plus(str, Array_string_join(fs, _SLIT(", ")));
	str = /*f*/string__plus(str, _SLIT(");"));
	Option_string _t1345;
	opt_ok(&(string[]) { str }, (Option*)(&_t1345), sizeof(string));
	return _t1345;
}
...
VV_LOCAL_SYMBOL int orm__sql_field_type(orm__OrmTableField field) {
	...
	// FOR IN array
	for (int _t1347 = 0; _t1347 < field.attrs.len; ++_t1347) {
		StructAttribute attr = ((StructAttribute*)field.attrs.data)[_t1347];
...
orm__Primitive orm__bool_to_primitive(bool b) {
	orm__Primitive _t1349 = bool_to_sumtype_orm__Primitive(&b);
	return _t1349;
}

orm__Primitive orm__f32_to_primitive(f32 b) {
	orm__Primitive _t1350 = f32_to_sumtype_orm__Primitive(&b);
	return _t1350;
}

orm__Primitive orm__f64_to_primitive(f64 b) {
	orm__Primitive _t1351 = f64_to_sumtype_orm__Primitive(&b);
	return _t1351;
}

orm__Primitive orm__i8_to_primitive(i8 b) {
	orm__Primitive _t1352 = i8_to_sumtype_orm__Primitive(&b);
	return _t1352;
}

orm__Primitive orm__i16_to_primitive(i16 b) {
	orm__Primitive _t1353 = i16_to_sumtype_orm__Primitive(&b);
	return _t1353;
}

orm__Primitive orm__int_to_primitive(int b) {
	orm__Primitive _t1354 = int_to_sumtype_orm__Primitive(&b);
	return _t1354;
}

orm__Primitive orm__i64_to_primitive(i64 b) {
	orm__Primitive _t1355 = i64_to_sumtype_orm__Primitive(&b);
	return _t1355;
}

orm__Primitive orm__byte_to_primitive(byte b) {
	orm__Primitive _t1356 = byte_to_sumtype_orm__Primitive(&b);
	return _t1356;
}

orm__Primitive orm__u16_to_primitive(u16 b) {
	orm__Primitive _t1357 = u16_to_sumtype_orm__Primitive(&b);
	return _t1357;
}

orm__Primitive orm__u32_to_primitive(u32 b) {
	orm__Primitive _t1358 = u32_to_sumtype_orm__Primitive(&b);
	return _t1358;
}

orm__Primitive orm__u64_to_primitive(u64 b) {
	orm__Primitive _t1359 = u64_to_sumtype_orm__Primitive(&b);
	return _t1359;
}

orm__Primitive orm__string_to_primitive(string b) {
	orm__Primitive _t1360 = string_to_sumtype_orm__Primitive(&b);
	return _t1360;
}

orm__Primitive orm__time_to_primitive(time__Time b) {
	orm__Primitive _t1361 = time__Time_to_sumtype_orm__Primitive(&b);
	return _t1361;
}

Option_Array_Array_orm__Primitive sqlite__DB_select(sqlite__DB db, orm__OrmSelectConfig config, orm__OrmQueryData data, orm__OrmQueryData where) {
	string query = orm__orm_select_gen(config, _SLIT("`"), true, _SLIT("?"), 1, where);
	sqlite__Stmt stmt = sqlite__DB_new_init_stmt(db, query);
	Option_void _t1362 = sqlite__sqlite_stmt_binder(stmt, data, query);
	if (_t1362.state != 0 && _t1362.err._typ != _IError_None___index) {
		Option_Array_Array_orm__Primitive _t1363;
		memcpy(&_t1363, &_t1362, sizeof(Option));
		return _t1363;
	};
	Option_void _t1364 = sqlite__sqlite_stmt_binder(stmt, where, query);
	if (_t1364.state != 0 && _t1364.err._typ != _IError_None___index) {
		Option_Array_Array_orm__Primitive _t1365;
		memcpy(&_t1365, &_t1364, sizeof(Option));
		return _t1365;
	};
	Array_Array_orm__Primitive ret = __new_array_with_default(0, 0, sizeof(Array_orm__Primitive), 0);
	if (config.is_count) {
		Option_void _t1366 = sqlite__Stmt_orm_step(stmt, query);
		if (_t1366.state != 0 && _t1366.err._typ != _IError_None___index) {
			Option_Array_Array_orm__Primitive _t1367;
			memcpy(&_t1367, &_t1366, sizeof(Option));
			return _t1367;
		};
		array_push((array*)&ret, _MOV((Array_orm__Primitive[]){ new_array_from_c_array(1, 1, sizeof(orm__Primitive), _MOV((orm__Primitive[1]){int_to_sumtype_orm__Primitive(ADDR(int, (sqlite__Stmt_get_count(stmt))))})) }));
		Option_Array_Array_orm__Primitive _t1369;
		opt_ok(&(Array_Array_orm__Primitive[]) { ret }, (Option*)(&_t1369), sizeof(Array_Array_orm__Primitive));
		return _t1369;
	}
	for (;;) {
		eprintln(Array_Array_orm__Primitive_str(ret));
		...
		for (int i = 0; i < config.types.len; ++i) {
			...
			Option_orm__Primitive _t1370 = sqlite__Stmt_sqlite_select_column(stmt, i, typ);
			if (_t1370.state != 0) { /*or block*/ 
				Option_Array_Array_orm__Primitive _t1371;
				memcpy(&_t1371, &_t1370, sizeof(Option));
				return _t1371;
			}
 			orm__Primitive primitive =  (*(orm__Primitive*)_t1370.data);
	...
	eprintln(Array_Array_orm__Primitive_str(ret));
	Option_Array_Array_orm__Primitive _t1374;
	opt_ok(&(Array_Array_orm__Primitive[]) { ret }, (Option*)(&_t1374), sizeof(Array_Array_orm__Primitive));
	return _t1374;
}

Option_void sqlite__DB_insert(sqlite__DB db, string table, orm__OrmQueryData data) {
	string query = orm__orm_stmt_gen(table, _SLIT("`"), orm__StmtKind_insert, true, _SLIT("?"), 1, data, (orm__OrmQueryData){.fields = __new_array(0, 0, sizeof(string)),.data = __new_array(0, 0, sizeof(orm__Primitive)),.types = __new_array(0, 0, sizeof(int)),.kinds = __new_array(0, 0, sizeof(orm__OperationKind)),});
	eprintln(table);
	eprintln(orm__OrmQueryData_str(data));
	Option_void _t1375 = sqlite__sqlite_stmt_worker(db, query, data, (orm__OrmQueryData){.fields = __new_array(0, 0, sizeof(string)),.data = __new_array(0, 0, sizeof(orm__Primitive)),.types = __new_array(0, 0, sizeof(int)),.kinds = __new_array(0, 0, sizeof(orm__OperationKind)),});
	if (_t1375.state != 0 && _t1375.err._typ != _IError_None___index) {
		Option_void _t1376;
		memcpy(&_t1376, &_t1375, sizeof(Option));
		return _t1376;
	};
	return (Option_void){0};
}
...
Option_void sqlite__DB_update(sqlite__DB db, string table, orm__OrmQueryData data, orm__OrmQueryData where) {
	string query = orm__orm_stmt_gen(table, _SLIT("`"), orm__StmtKind_update, true, _SLIT("?"), 1, data, where);
	Option_void _t1377 = sqlite__sqlite_stmt_worker(db, query, data, where);
	if (_t1377.state != 0 && _t1377.err._typ != _IError_None___index) {
		Option_void _t1378;
		memcpy(&_t1378, &_t1377, sizeof(Option));
		return _t1378;
	};
	return (Option_void){0};
}
...
Option_void sqlite__DB_delete(sqlite__DB db, string table, orm__OrmQueryData data, orm__OrmQueryData where) {
	string query = orm__orm_stmt_gen(table, _SLIT("`"), orm__StmtKind_delete, true, _SLIT("?"), 1, data, where);
	Option_void _t1379 = sqlite__sqlite_stmt_worker(db, query, data, where);
	if (_t1379.state != 0 && _t1379.err._typ != _IError_None___index) {
		Option_void _t1380;
		memcpy(&_t1380, &_t1379, sizeof(Option));
		return _t1380;
	};
	return (Option_void){0};
}
...
Option_void sqlite__DB_create(sqlite__DB db, string table, Array_orm__OrmTableField fields) {
	Option_string _t1381 = orm__orm_table_gen(table, _SLIT("`"), true, 0, fields, (voidptr)sqlite__sqlite_type_from_v);
	if (_t1381.state != 0) { /*or block*/ 
		IError err = _t1381.err;
		return (Option_void){ .state=2, .err=err, .data={0} };
	}
 	string query =  (*(string*)_t1381.data);
	int err = sqlite__DB_exec_none(db, query);
	if (err != _const_sqlite__sqlite_ok && err != _const_sqlite__sqlite_done) {
		return (Option_void){ .state=2, .err=sqlite__DB_error_message(db, err, query), .data={0} };
	}
	return (Option_void){0};
}
...
VV_LOCAL_SYMBOL Option_void sqlite__sqlite_stmt_worker(sqlite__DB db, string query, orm__OrmQueryData data, orm__OrmQueryData where) {
	sqlite__Stmt stmt = sqlite__DB_new_init_stmt(db, query);
	Option_void _t1385 = sqlite__sqlite_stmt_binder(stmt, data, query);
	if (_t1385.state != 0 && _t1385.err._typ != _IError_None___index) {
		Option_void _t1386;
		memcpy(&_t1386, &_t1385, sizeof(Option));
		return _t1386;
	};
	Option_void _t1387 = sqlite__sqlite_stmt_binder(stmt, where, query);
	if (_t1387.state != 0 && _t1387.err._typ != _IError_None___index) {
		Option_void _t1388;
		memcpy(&_t1388, &_t1387, sizeof(Option));
		return _t1388;
	};
	Option_void _t1389 = sqlite__Stmt_orm_step(stmt, query);
	if (_t1389.state != 0 && _t1389.err._typ != _IError_None___index) {
		Option_void _t1390;
		memcpy(&_t1390, &_t1389, sizeof(Option));
		return _t1390;
	};
...
VV_LOCAL_SYMBOL Option_void sqlite__sqlite_stmt_binder(sqlite__Stmt stmt, orm__OrmQueryData d, string query) {
	int c = 1;
	// FOR IN array
	for (int _t1391 = 0; _t1391 < d.data.len; ++_t1391) {
		orm__Primitive data = ((orm__Primitive*)d.data.data)[_t1391];
		eprintln(int_str(c));
		eprintln(orm__Primitive_str(data));
		int err = 0;
		if (data._typ == 5 /* i8 */) {
		...
		else if (data._typ == 141 /* time.Time */) {
			err = sqlite__Stmt_bind_int(stmt, c, ((int)((*data._time__Time).v_unix)));
		};
		eprintln( str_intp(2, _MOV((StrIntpData[]){{_SLIT("error: "), 0xfe07, {.d_i32 = err}}, {_SLIT0, 0, { .d_c = 0 }}})) );
		if (err != 0) {
			return (Option_void){ .state=2, .err=sqlite__DB_error_message(/*rec*/*stmt.db, err, query), .data={0} };
		}
		c++;
	}
	return (Option_void){0};
...
VV_LOCAL_SYMBOL Option_orm__Primitive sqlite__Stmt_sqlite_select_column(sqlite__Stmt stmt, int idx, int typ) {
	...
	if ((Array_int_contains(_const_orm__nums, typ)) || typ == -1) {
		...
		primitive = time__Time_to_sumtype_orm__Primitive(ADDR(time__Time, (time__unix(sqlite__Stmt_get_int(stmt, idx)))));
	} else {
	...
	Option_orm__Primitive _t1394;
	opt_ok(&(orm__Primitive[]) { primitive }, (Option*)(&_t1394), sizeof(orm__Primitive));
	return _t1394;
}

VV_LOCAL_SYMBOL Option_string sqlite__sqlite_type_from_v(int typ) {
	Option_string _t1396; /* if prepend */
	if ((Array_int_contains(_const_orm__nums, typ)) || typ < 0 || (Array_int_contains(_const_orm__num64, typ))) {
		opt_ok(&(string[]) { _SLIT("INTEGER") }, (Option*)(&_t1396), sizeof(string));
	} else if ((Array_int_contains(_const_orm__float, typ))) {
		opt_ok(&(string[]) { _SLIT("REAL") }, (Option*)(&_t1396), sizeof(string));
	} else if (typ == _const_orm__string) {
		opt_ok(&(string[]) { _SLIT("TEXT") }, (Option*)(&_t1396), sizeof(string));
	} else {
		_t1396.state = 2;
		_t1396.err = v_error( str_intp(2, _MOV((StrIntpData[]){{_SLIT("Unknown type "), 0xfe07, {.d_i32 = typ}}, {_SLIT0, 0, { .d_c = 0 }}})) );
	}
	Option_string _t1395 =  _t1396;
	return _t1395;
}

string sqlite__DB_str(sqlite__DB db) {
	string _t1397 = string__plus(string__plus(_SLIT("sqlite.DB{ conn: "), ptr_str(db.conn)), _SLIT(" }"));
	return _t1397;
}
...
Option_sqlite__DB sqlite__connect(string path) {
	...
	if (code != 0) {
		return (Option_sqlite__DB){ .state=2, .err=I_sqlite__SQLError_to_Interface_IError((sqlite__SQLError*)memdup(&(sqlite__SQLError){.msg = cstring_to_vstring(((char*)(sqlite3_errstr(code)))),.code = code,}, sizeof(sqlite__SQLError))), .data={0} };
	}
	Option_sqlite__DB _t1399;
	opt_ok(&(sqlite__DB[]) { (sqlite__DB){.is_open = true,.conn = db,} }, (Option*)(&_t1399), sizeof(sqlite__DB));
	return _t1399;
}
...
Option_bool sqlite__DB_close(sqlite__DB* db) {
	...
	if (code == 0) {
		...
		return (Option_bool){ .state=2, .err=I_sqlite__SQLError_to_Interface_IError((sqlite__SQLError*)memdup(&(sqlite__SQLError){.msg = cstring_to_vstring(((char*)(sqlite3_errstr(code)))),.code = code,}, sizeof(sqlite__SQLError))), .data={0} };
	}
	Option_bool _t1401;
	opt_ok(&(bool[]) { true }, (Option*)(&_t1401), sizeof(bool));
	return _t1401;
}
...
bool sqlite__DB_q_string_defer_0 = false;
	...
	string _t1404 = (val != ((byte*)(0)) ? (tos_clone(val)) : (_SLIT("")));
	// Defer begin
...
Option_sqlite__Row sqlite__DB_exec_one(sqlite__DB db, string query) {
	multi_return_Array_sqlite__Row_int mr_4115 = sqlite__DB_exec(db, query);
	Array_sqlite__Row rows = mr_4115.arg0;
	int code = mr_4115.arg1;
	if (rows.len == 0) {
		return (Option_sqlite__Row){ .state=2, .err=I_sqlite__SQLError_to_Interface_IError((sqlite__SQLError*)memdup(&(sqlite__SQLError){.msg = _SLIT("No rows"),.code = code,}, sizeof(sqlite__SQLError))), .data={0} };
	} else if (code != 101) {
		return (Option_sqlite__Row){ .state=2, .err=I_sqlite__SQLError_to_Interface_IError((sqlite__SQLError*)memdup(&(sqlite__SQLError){.msg = cstring_to_vstring(((char*)(sqlite3_errstr(code)))),.code = code,}, sizeof(sqlite__SQLError))), .data={0} };
	}
	Option_sqlite__Row _t1411;
	opt_ok(&(sqlite__Row[]) { (*(sqlite__Row*)/*ee elem_typ */array_get(rows, 0)) }, (Option*)(&_t1411), sizeof(sqlite__Row));
	return _t1411;
}

IError sqlite__DB_error_message(sqlite__DB db, int code, string query) {
	string msg = cstring_to_vstring(((char*)(sqlite3_errmsg(db.conn))));
	IError _t1412 = I_sqlite__SQLError_to_Interface_IError((sqlite__SQLError*)memdup(&(sqlite__SQLError){.msg =  str_intp(3, _MOV((StrIntpData[]){{_SLIT0, 0xfe10, {.d_s = msg}}, {_SLIT(" ("), 0xfe10, {.d_s = query}}, {_SLIT(")"), 0, { .d_c = 0 }}})) ,.code = code,}, sizeof(sqlite__SQLError)));
	return _t1412;
}

int sqlite__DB_exec_none(sqlite__DB db, string query) {
	multi_return_Array_sqlite__Row_int mr_4742 = sqlite__DB_exec(db, query);
	int code = mr_4742.arg1;
	return code;
}
...
VV_LOCAL_SYMBOL sqlite__Stmt sqlite__DB_new_init_stmt(sqlite__DB db, string query) {
	sqlite__Stmt _t1415 = (sqlite__Stmt){.stmt = sqlite__DB_init_stmt(db, query),.db = &db,};
	return _t1415;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_bind_int(sqlite__Stmt stmt, int idx, int v) {
	int _t1416 = sqlite3_bind_int(stmt.stmt, idx, v);
	return _t1416;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_bind_i64(sqlite__Stmt stmt, int idx, i64 v) {
	int _t1417 = sqlite3_bind_int64(stmt.stmt, idx, v);
	return _t1417;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_bind_f64(sqlite__Stmt stmt, int idx, f64 v) {
	int _t1418 = sqlite3_bind_double(stmt.stmt, idx, v);
	return _t1418;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_bind_text(sqlite__Stmt stmt, int idx, string s) {
	int _t1419 = sqlite3_bind_text(stmt.stmt, idx, s.str, s.len, 0);
	return _t1419;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_get_int(sqlite__Stmt stmt, int idx) {
	int _t1420 = sqlite3_column_int(stmt.stmt, idx);
	return _t1420;
}

VV_LOCAL_SYMBOL i64 sqlite__Stmt_get_i64(sqlite__Stmt stmt, int idx) {
	i64 _t1421 = sqlite3_column_int64(stmt.stmt, idx);
	return _t1421;
}

VV_LOCAL_SYMBOL f64 sqlite__Stmt_get_f64(sqlite__Stmt stmt, int idx) {
	f64 _t1422 = sqlite3_column_double(stmt.stmt, idx);
	return _t1422;
}

VV_LOCAL_SYMBOL string sqlite__Stmt_get_text(sqlite__Stmt stmt, int idx) {
	byte* b = sqlite3_column_text(stmt.stmt, idx);
	string _t1423 = byte_vstring(b);
	return _t1423;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_get_count(sqlite__Stmt stmt) {
	int _t1424 = sqlite3_column_count(stmt.stmt);
	return _t1424;
}

VV_LOCAL_SYMBOL int sqlite__Stmt_step(sqlite__Stmt stmt) {
	int _t1425 = sqlite3_step(stmt.stmt);
	return _t1425;
}

VV_LOCAL_SYMBOL Option_void sqlite__Stmt_orm_step(sqlite__Stmt stmt, string query) {
	int res = sqlite__Stmt_step(stmt);
	if (res != _const_sqlite__sqlite_ok && res != _const_sqlite__sqlite_done) {
		return (Option_void){ .state=2, .err=sqlite__DB_error_message(/*rec*/*stmt.db, res, query), .data={0} };
	}
	return (Option_void){0};
}
...
VV_LOCAL_SYMBOL bool main__can_use_relative_paths(void) {
	string _t1428 = os__getenv(_SLIT("VERROR_PATHS"));
		bool _t1427 = ((string__eq(_t1428, _SLIT("absolute"))) ? (false) : (true));
	return _t1427;
}
...
VV_LOCAL_SYMBOL void main__cb_propagate_test_error(int line_nr, string file, string mod, string fn_name, string errmsg) {
	...
	if (os__is_file(file)) {
		Option_Array_string _t1429 = os__read_lines(file);
		if (_t1429.state != 0) { /*or block*/ 
			IError err = _t1429.err;
			*(Array_string*) _t1429.data = __new_array_with_default(line_nr + 1, 0, sizeof(string), &(string[]){_SLIT("")});
		}
 		Array_string source_lines =  (*(Array_string*)_t1429.data);
...
VV_LOCAL_SYMBOL void main__test_orm_sqlite(void) {
	Option_sqlite__DB _t1430 = sqlite__connect(_SLIT(":memory:"));
	if (_t1430.state != 0) { /*or block*/ 
		IError err = _t1430.err;
		v_panic(IError_str(err));
	}
 	sqlite__DB db =  (*(sqlite__DB*)_t1430.data);
	main__User u = (main__User){.id = 0,.age = 10,.name = _SLIT("test"),.is_customer = 0,.skipped_string = (string){.str=(byteptr)"", .is_lit=1},};
	
	// orm
	orm__OrmConnection _t1431 = I_sqlite__DB_to_Interface_orm__OrmConnection(&db);
	Option_void _t1432 = orm__OrmConnection_name_table[_t1431._typ]._method_create(_t1431._object, _SLIT("Module"), new_array_from_c_array(4, 4, sizeof(orm__OrmTableField), _MOV((orm__OrmTableField[4]){(orm__OrmTableField){.name = _SLIT("id"),.typ = 7,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(2, 2, sizeof(StructAttribute), _MOV((StructAttribute[2]){(StructAttribute){.name = _SLIT("primary"),.has_arg = 0,.arg = _SLIT(""),.kind = 0,},(StructAttribute){.name = _SLIT("sql"),.has_arg = 1,.arg = _SLIT("serial"),.kind = 0,},}))},(orm__OrmTableField){.name = _SLIT("name"),.typ = 18,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},(orm__OrmTableField){.name = _SLIT("nr_downloads"),.typ = 7,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},(orm__OrmTableField){.name = _SLIT("user"),.typ = 84,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},})));
	if (_t1432.state != 0 && _t1432.err._typ != _IError_None___index) { v_panic(IError_str(_t1432.err)); }
	Option_void _t1433 = orm__OrmConnection_name_table[_t1431._typ]._method_create(_t1431._object, _SLIT("userlist"), new_array_from_c_array(4, 4, sizeof(orm__OrmTableField), _MOV((orm__OrmTableField[4]){(orm__OrmTableField){.name = _SLIT("id"),.typ = 7,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(2, 2, sizeof(StructAttribute), _MOV((StructAttribute[2]){(StructAttribute){.name = _SLIT("primary"),.has_arg = 0,.arg = _SLIT(""),.kind = 0,},(StructAttribute){.name = _SLIT("sql"),.has_arg = 1,.arg = _SLIT("serial"),.kind = 0,},}))},(orm__OrmTableField){.name = _SLIT("age"),.typ = 7,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},(orm__OrmTableField){.name = _SLIT("username"),.typ = 18,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(1, 1, sizeof(StructAttribute), _MOV((StructAttribute[1]){(StructAttribute){.name = _SLIT("sql"),.has_arg = 1,.arg = _SLIT("username"),.kind = 1,},}))},(orm__OrmTableField){.name = _SLIT("is_customer"),.typ = 16,.is_time = 0,.default_val = (string){.str = (byteptr) "", .is_lit = 1},.attrs = new_array_from_c_array(0, 0, sizeof(StructAttribute), _MOV((StructAttribute[0]){}))},})));
	if (_t1433.state != 0 && _t1433.err._typ != _IError_None___index) { v_panic(IError_str(_t1433.err)); }
	
	// orm
	orm__OrmConnection _t1434 = I_sqlite__DB_to_Interface_orm__OrmConnection(&db);
	Option_void _t1435 = orm__OrmConnection_name_table[_t1434._typ]._method_insert(_t1434._object, _SLIT("userlist"), (orm__OrmQueryData){.fields = new_array_from_c_array(3, 3, sizeof(string), _MOV((string[3]){_SLIT("age"),_SLIT("username"),_SLIT("is_customer"),})),.data = new_array_from_c_array(3, 3, sizeof(orm__Primitive), _MOV((orm__Primitive[3]){orm__int_to_primitive(u.age),orm__string_to_primitive(u.name),orm__bool_to_primitive(u.is_customer),})),.types = new_array_from_c_array(0, 0, sizeof(int), _MOV((int[0]){})),.kinds = new_array_from_c_array(0, 0, sizeof(orm__OperationKind), _MOV((orm__OperationKind[0]){})),});
	if (_t1435.state != 0 && _t1435.err._typ != _IError_None___index) { v_panic(IError_str(_t1435.err)); }
	
	// orm
	orm__OrmConnection _t1436 = I_sqlite__DB_to_Interface_orm__OrmConnection(&db);
	Option_void _t1437 = orm__OrmConnection_name_table[_t1436._typ]._method_drop(_t1436._object, _SLIT("Module"));
	if (_t1437.state != 0 && _t1437.err._typ != _IError_None___index) { v_panic(IError_str(_t1437.err)); }
	Option_void _t1438 = orm__OrmConnection_name_table[_t1436._typ]._method_drop(_t1436._object, _SLIT("userlist"));
	if (_t1438.state != 0 && _t1438.err._typ != _IError_None___index) { v_panic(IError_str(_t1438.err)); }
}
