...
fn test_float_to_str() {
	test_cases_f32 := [
		f32_from_bits1(0x00000000),
		/*  +0 */
		f32_from_bits1(0x80000000),
		/*  -0 */
		f32_from_bits1(0xFFC00001),
		/*  sNan */
		f32_from_bits1(0xFF800001),
		/*  qNan */
		f32_from_bits1(0x7F800000),
		/*  +inf */
		f32_from_bits1(0xFF800000),
		/*  -inf */
		1,
		-1,
		10,
	...
	exp_result_f32 := [
		...
		'1.e+23',
		'1.1754944e-38',
		/*  aprox from 1.1754943508 × 10−38, */
		'3.4028235e+38',
		'3.8326058e+17',
	]
	test_cases_f64 := [
		f64_from_bits1(0x0000000000000000),
		/*  +0 */
		f64_from_bits1(0x8000000000000000),
		/*  -0 */
		f64_from_bits1(0x7FF0000000000001),
		/*  sNan */
		f64_from_bits1(0x7FF8000000000001),
		/*  qNan */
		f64_from_bits1(0x7FF0000000000000),
		/*  +inf */
		f64_from_bits1(0xFFF0000000000000),
		/*  -inf */
		1,
		-1,
		10,
		...
		-123.45,
		1e23,
		f64_from_bits1(0x0010000000000000),
		/*  smallest float64 */
		math.max_f32,
		383260575764816448,
		383260575764816448,
	...
	exp_result_f64 := [
		...
		'3.8326057576481645e+17',
		'1.23e+302',
		/*  this test is failed from C sprintf!! */
		'1.23e-298',
		'5.e-324',
		'-5.e-324',
	]
