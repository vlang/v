// FIPS 204 s. 5.4: HashML-DSA pre-hash support.
module mldsa
...
// FIPS 204 algo. 4/5: DER-encoded OID for each pre-hash function.
// All under arc 2.16.840.1.101.3.4.2 (joint-iso-itu-t(2) country(16) us(840) organization(1) gov(101) csor(3) nistAlgorithm(4) hashAlgs(2)).
...
// FIPS 204 algo. 4, lines 10-22: compute PH(M) for the given hash function.
