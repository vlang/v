...
fn test_pointer() {
	...
	assert json.encode(StructTypePointer[string]{ val: 0 }) == '{}' // REVIEW
	...
	assert json.encode(StructTypePointer[bool]{ val: 0 }) == '{}' // REVIEW
	...
	assert json.encode(StructTypePointer[int]{ val: 0 }) == '{}' // REVIEW
