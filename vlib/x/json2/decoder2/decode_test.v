...
fn test_precalculate_string_decoded_space() {
	assert precalculate_string_decoded_space('""')! == 0

	assert precalculate_string_decoded_space('"abcd"')! == 4

	assert precalculate_string_decoded_space('"ç"')! == 2

	assert precalculate_string_decoded_space('"\u001b"')! == 1

	assert precalculate_string_decoded_space('"\\u001b"')! == 1

	assert precalculate_string_decoded_space('"✔"')! == 3

	assert precalculate_string_decoded_space('"\\u2714"')! == 3

	assert precalculate_string_decoded_space('"te\\u2714st"')! == 7

	assert precalculate_string_decoded_space('"ひ"')! == 3

	assert precalculate_string_decoded_space('"\\u3072"')! == 3

	assert precalculate_string_decoded_space('"ü"')! == 2

	assert precalculate_string_decoded_space('"🐈"')! == 4
}
