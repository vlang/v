...
fn test_encode_struct_skipped_fields() {
	...
	assert json.encode(StructTypeSkippedFields4{
		...
		val1: 1
		val2: 1.0
	}) == '{"val1":1,"val2":1,"val3":"0000-01-01T00:00:00.000Z"}'

	assert json.encode(StructTypeSkippedFields5{
		val:  'string_val'
		val1: 1
		val2: 1.0
	}) == '{"val2":1,"val3":"0000-01-01T00:00:00.000Z"}'

	assert json.encode(StructTypeSkippedFields6{
		val:  'string_val'
		val1: 1
		val2: 1.0
	}) == '{"val1":1,"val3":"0000-01-01T00:00:00.000Z"}'

	assert json.encode(StructTypeSkippedFields7{
		val:  'string_val'
		val1: 1
		val2: 1.0
	}) == '{"val":"string_val","val3":"0000-01-01T00:00:00.000Z"}'
