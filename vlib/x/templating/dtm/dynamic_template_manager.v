...
//
fn (mut tm DynamicTemplateManager) check_tmpl_and_placeholders_size(
	f_path string,
	tmpl_var &map[string]DtmMultiTypeMap
) !(string, string, string, TemplateType) {
	mut html_file := ''
	mut file_name := ''
...
//
fn (mut tm DynamicTemplateManager) create_template_cache_and_display(
	tcs CacheRequest,
	last_template_mod i64,
	unique_time i64,
	file_path string,
	...
	current_content_checksum string,
...
fn (mut tm DynamicTemplateManager) parse_tmpl_file(
	file_path string,
	tmpl_name string,
	placeholders &map[string]DtmMultiTypeMap,
	is_compressed bool,
...
//
fn (mut tm DynamicTemplateManager) cache_request_route(
	is_cache_exist bool,
	neg_cache_delay_expiration i64,
	last_template_mod i64,
	test_current_template_mod i64,
	cache_del_exp i64,
	gen_at i64,
	c_time i64,
	content_checksum string,
