...
const (
	...
	//5,6,7,120
	isqrt_       = [f64(0.447213), 0.408248, 0.377964, 0.3535533]
...
fn test_isqrt(){
	mut rounds := u32(5)
	close_results := [isqrt(5, rounds), isqrt(6, rounds), isqrt(7, rounds), isqrt(8, rounds)]
	println(close_results)
	for i in 0..close_results.len{
		assert soclose(isqrt_[3], close_results[3], 1e-5)
	}
}
