...
mut:
	...
	task_count_mutex &Mutex [required] = &Mutex(0) // This mutex protects the task_count count in add()
	wait_blocker     &Waiter [required] = &Waiter(0) // This blocks the wait() until released by add()
}
