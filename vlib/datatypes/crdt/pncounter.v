...
// PN-Counter by one.
pub fn (mut pn PNCounter) increment() {
...
pub fn (mut pn PNCounter) decrement_value(decr int) {
...
pub fn (mut pn PNCounter) value() int {
...
pub fn (mut pn PNCounter) merge(pnpn PNCounter) {
