...
pub:
	tool DiffTool @[deprecated: 'use compare_files or compare_text'; deprecated_after: '2026-12-31']
	// Custom args used with the diff command.
	args string @[deprecated: 'use compare_files or compare_text'; deprecated_after: '2026-12-31']
	...
	env_overwrite_var ?string = 'VDIFF_CMD' @[deprecated: 'use compare_files or compare_text'; deprecated_after: '2026-12-31']
}
