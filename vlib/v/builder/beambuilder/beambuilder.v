...
pub fn start() {
	...
	builder.compile('build', prefs, compile_beam)
}

pub fn compile_beam(mut b builder.Builder) {
	...
	build_beam(mut b, files, name)
}

pub fn build_beam(mut b builder.Builder, v_files []string, out_file string) {
