...
fn test_all_parsed_nodes_have_valid_spans() {
	...
	real_files := [
		os.join_path(vroot, 'vlib', 'v', 'parser', 'parser.v'),
		os.join_path(vroot, 'vlib', 'v', 'types', 'checker.v'),
		os.join_path(vroot, 'vlib', 'v', 'gen', 'c', 'cleanc.v'),
		os.join_path(vroot, 'vlib', 'v', 'flat', 'flat.v'),
		os.join_path(vroot, 'vlib', 'v', 'token', 'token.v'),
