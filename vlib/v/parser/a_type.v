	...
	match p.tok.kind {
		...
		.ellipsis {
			...
			match name {
				...
				'voidptr' {
					return types.new_ti(.voidptr, 'voidptr', types.voidptr_type.idx, nr_muls)
				}
				'byteptr' {
					return types.new_ti(.byteptr, 'byteptr', types.byteptr_type.idx, nr_muls)
				}
				'charptr' {
					return types.new_ti(.charptr, 'charptr', types.charptr_type.idx, nr_muls)
				}
				'i8' {
					return types.new_ti(.i8, 'i8', types.i8_type.idx, nr_muls)
				}
				'i16' {
					return types.new_ti(.i16, 'i16', types.i16_type.idx, nr_muls)
				}
				'int' {
					return types.new_ti(.int, 'int', types.int_type.idx, nr_muls)
				}
				'i64' {
					return types.new_ti(.i64, 'i64', types.i64_type.idx, nr_muls)
				}
				'byte' {
					return types.new_ti(.byte, 'byte', types.byte_type.idx, nr_muls)
				}
				'u16' {
					return types.new_ti(.u16, 'u16', types.u16_type.idx, nr_muls)
				}
				'u32' {
					return types.new_ti(.u32, 'u32', types.u32_type.idx, nr_muls)
				}
				'u64' {
					return types.new_ti(.u64, 'u64', types.u64_type.idx, nr_muls)
				}
				'f32' {
					return types.new_ti(.f32, 'f32', types.f32_type.idx, nr_muls)
				}
				'f64' {
					return types.new_ti(.f64, 'f64', types.f64_type.idx, nr_muls)
				}
				'string' {
					return types.new_ti(.string, 'string', types.string_type.idx, nr_muls)
				}
				'char' {
					return types.new_ti(.char, 'char', types.charptr_type.idx, nr_muls)
				}
				'bool' {
					return types.new_ti(.bool, 'bool', types.bool_type.idx, nr_muls)
				}
