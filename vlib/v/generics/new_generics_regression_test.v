...
const expected_summsvc_generics = 'Summary for all V _test.v files: 96 failed, 175 passed, 271 total.'
const expected_summary_generics = 'Summary for all V _test.v files: 96 failed, 175 passed, 271 total.'
