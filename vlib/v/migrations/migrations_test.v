...
fn test_sqlite_add_column_rejects_unsupported_constraints() {
	...
	for default_sql in ['CURRENT_TIME', 'CURRENT_DATE', 'CURRENT_TIMESTAMP', "(datetime('now'))",
		...
		"(datetime('now')) /* now */", 'CURRENT_TIMESTAMP COLLATE binary', 'CURRENT_DATE\tCOLLATE binary',
		'CURRENT_TIME/* now */ COLLATE binary', '+CURRENT_TIMESTAMP', '- CURRENT_DATE',
		'+/* now */ CURRENT_TIME', '(CURRENT_TIMESTAMP) COLLATE binary',
