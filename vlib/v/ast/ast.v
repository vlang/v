...
pub:
	pos           token.Position
	expected_type table.Type/*table.Type*/ // TODO: remove once checker updated
	exprs         []Expr
}
...
// op    BinaryOp
	...
	pos        token.Position
	left       Expr
	left_type  table.Type/*table.Type*/
	right      Expr
	right_type table.Type/*table.Type*/
}
