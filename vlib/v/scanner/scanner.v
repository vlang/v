...
[inline]
fn (mut s Scanner) move_back() {
	s.pos--
	s.col--
}

[inline]
fn (mut s Scanner) move_by(how_many int) {
	s.pos += how_many
	s.col += how_many
}
