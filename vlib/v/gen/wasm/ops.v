...
pub fn (mut g Gen) as_numtype(a ValType) NumType {
...
pub fn (mut g Gen) get_wasm_type_int_literal(typ_ ast.Type) ValType {
...
pub fn (mut g Gen) get_wasm_type(typ_ ast.Type) ValType {
	typ := ast.mktyp(typ_)
