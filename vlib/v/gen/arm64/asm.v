...
// sub sp, sp, Xrm (extended register form: UXTX treats reg 31 as SP)
fn asm_sub_sp_reg(rm Reg) u32 {
	return 0xCB200000 | (u32(rm) << 16) | (3 << 13) | (31 << 5) | 31
}

// add sp, sp, Xrm (extended register form: UXTX treats reg 31 as SP)
fn asm_add_sp_reg(rm Reg) u32 {
	return 0x8B200000 | (u32(rm) << 16) | (3 << 13) | (31 << 5) | 31
}
