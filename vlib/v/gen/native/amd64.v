	...
	match var {
		ast.Ident {
			...
			match var_object {
				...
				ConstVar {
					c.cmp_var_reg(var_object as ConstVar, config)
				}
			}
		}
		LocalVar {
...
fn (mut c Amd64) cg_add_reg(a_reg Register, b_reg Register) {
