...
/** @namespace hello_hello1 */
const hello_hello1 = (function () {
	/**
	 * @function
	 * @returns {string}
	*/
...
const hello = (function (hello1) {
	...
	*/
	function excited() {
		return `${hello1.nested()} ${v_debugger()}!`;
	}
...
const main = (function (hl, hl1) {
	...
	*/
	...
	(async function() {
		...
		/** @type {number[]} */
		const arr = [1, 2, 3, 4, 5];
		for (let _tmp7 = 0; _tmp7 < arr.length; ++_tmp7) {
			const i = arr[_tmp7];
		}
	...
	*/
	function hello(game_on, ...dummy) {
		for (let _tmp8 = 0; _tmp8 < dummy.length; ++_tmp8) {
			const dd = dummy[_tmp8];
			/** @type {string} */
			const l = dd;
		}
