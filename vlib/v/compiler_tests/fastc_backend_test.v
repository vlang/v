...
const fastc_backend_v3_source = os.join_path(fastc_backend_v3_dir, 'v.v')
...
fn test_direct_fastc_compiler_entry_selects_selfhost_driver() {
	...
	linked_entry := os.join_path(linked_entry_dir, 'v.v')
	...
	ordinary_source := os.join_path(root, 'v.v')
...
')
	...
	assert !stdout_source.contains('=== V compiler benchmark ===')
	...
	assert !cross_stdout_source.contains('=== V compiler benchmark ===')
