...
const driver_cli_v3_src = os.join_path(driver_cli_v3_dir, 'v.v')
...
")!
	...
	unrelated_v3_source := os.join_path(root, 'v.v')
...
fn test_driver_accepts_dispatcher_arguments_and_runs_vsh_files() {
	...
	assert !showcc_build.output.contains('=== V compiler benchmark ==='), showcc_build.output
