...
fn test_public_key() ! {
	...
	C.EC_KEY_free(priv_key.key)
	C.EC_KEY_free(pub_key1.key)
	C.EC_KEY_free(pub_key2.key)
}
...
fn test_private_key_equal() ! {
	...
	C.EC_KEY_free(priv_key1.key)
	C.EC_KEY_free(priv_key2.key)
}
