...
// The overhead for representing it as an array of structs was ~28KB in .c, while with the flat array of ints, it is ~9KB.
// Given that xz can compress it to ~2KB, it could be probably represented in an even more compact way...
const rune_maps = [
	i32(0x41), 0x5A, 0, 32,
	0x61, 0x7A, -32, 0,
	0xB5, 0xB5, 743, 0,
