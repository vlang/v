...
fn test_tables() {
	...
	value = m.value('a.b.c.d.e').default_to(-1)
	assert value.int() == 1

	value = m.value('x.a.b.c.d.e').default_to(-1)
	assert value.int() == 1
	...
	for i := 0; i < arr.len; i++ {
		...
		value = entry.value('t.a.b').default_to(99)
	...
	value = arr0.value('t.a.b').default_to(99)
	assert value.int() == 1
	value = arr0.value('T.a.b').default_to(99)
	assert value.int() == 1

	arr1 := arr[1] as map[string]toml.Any
	value = arr1.value('t.a.b').default_to(99)
	assert value.int() == 2
	value = arr1.value('T.a.b').default_to(99)
	assert value.int() == 2
}
