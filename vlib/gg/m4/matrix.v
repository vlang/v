...
pub
const  precision  = f32(10e-7)  // default precision for the module
...
[direct_array_access]
pub
fn (x Mat4) is_equal(y Mat4) bool { unsafe{
	for c,value in x.e {
		if abs(value - y.e[c]) > precision {
			return false
		}
	}
	return true
...
[direct_array_access]
pub
fn (mut x Mat4) copy(y Mat4) { unsafe{
	x.e = [
...
[direct_array_access]
pub
fn (mut x Mat4) set_trace(v3 Vec4) { unsafe{
	x.e[0 ] = v3.e[0]
	x.e[5 ] = v3.e[1]
	x.e[10] = v3.e[2]
  x.e[15] = v3.e[3]	
...
[direct_array_access]
pub
fn (x Mat4) get_trace() Vec4 { unsafe{
	return Vec4{e:[
		x.e[0 ],
		x.e[5 ],
		x.e[10],
...
[direct_array_access]
pub
fn (mut x Mat4) set_f32(value f32) { unsafe{
	x.e = [
...
[direct_array_access]
pub
fn (mut x Mat4) set_row(row int, v3 Vec4) { unsafe{
	x.e[row*4    ] = v3.e[0]
	x.e[row*4 + 1] = v3.e[1]
	x.e[row*4 + 2] = v3.e[2]
  x.e[row*4 + 3] = v3.e[3]	
...
[direct_array_access]
pub
fn (x Mat4) get_row(row int) Vec4 { unsafe{
	return Vec4{e:[
	x.e[row*4    ]
	x.e[row*4 + 1]
	x.e[row*4 + 2]
...
[direct_array_access]
pub
fn (mut x Mat4) set_col(col int, v3 Vec4) { unsafe{
	x.e[col     ] = v3.e[0]
	x.e[col + 4 ] = v3.e[1]
	x.e[col + 8 ] = v3.e[2]
  x.e[col + 12] = v3.e[3]	
...
[direct_array_access]
pub
fn (x Mat4) get_col(col int) Vec4 { unsafe{
	return Vec4{e:[
	x.e[col     ]
	x.e[col + 4 ]
	x.e[col + 8 ]
...
[direct_array_access]
pub
fn (mut x Mat4) swap_col(col1 int, col2 int) { unsafe{
	v0 := x.e[col1     ]
	v1 := x.e[col1 + 4 ]
	v2 := x.e[col1 + 8 ]
  v3 := x.e[col1 + 12]
...
[direct_array_access]
pub
fn (mut x Mat4) swap_row(row1 int, row2 int) { unsafe{
	v0 := x.e[row1*4    ]
	v1 := x.e[row1*4 + 1]
	v2 := x.e[row1*4 + 2]
  v3 := x.e[row1*4 + 3]
...
[direct_array_access]
pub
fn (x Mat4) transpose() Mat4 { unsafe{
	return Mat4{e:[
...
[direct_array_access]
pub
fn (x Mat4) mul_scalar(s f32) Mat4 { unsafe{
	return Mat4{e:[
...
pub
fn add(a Mat4, b Mat4) Mat4 { unsafe{
	return a + b
}}

// Subtraction of matrix function
pub
fn sub(a Mat4, b Mat4) Mat4 { unsafe{
	return a - b
}}

// Multiplication of matrix function
pub
fn mul(a Mat4, b Mat4) Mat4 { unsafe{
	return a * b
}}
...
[direct_array_access]
pub
fn mul_vec(a Mat4, v Vec4) Vec4 { unsafe{
	return Vec4{e:[
...
[direct_array_access]
pub
fn det(x Mat4) f32 { unsafe{
	mut t := [6]f32{}
	x00 := x.f[0][0] x10 := x.f[1][0] x20 := x.f[2][0] x30 := x.f[3][0]
	x01 := x.f[0][1] x11 := x.f[1][1] x21 := x.f[2][1] x31 := x.f[3][1]
	x02 := x.f[0][2] x12 := x.f[1][2] x22 := x.f[2][2] x32 := x.f[3][2]
	x03 := x.f[0][3] x13 := x.f[1][3] x23 := x.f[2][3] x33 := x.f[3][3]
  ...
  t[5] = x02 * x13 - x03 * x12
	...
	return x00 * (x11 * t[0] - x21 * t[1] + x31 * t[2]) -
...
[direct_array_access]
pub
fn (x Mat4) inverse() Mat4 { unsafe{
	mut t := [6]f32{}
	mut det := f32(0)
	
	a := x.f[0][0] b := x.f[1][0] c := x.f[2][0] d := x.f[3][0]
	e := x.f[0][1] f := x.f[1][1] g := x.f[2][1] h := x.f[3][1]
	i := x.f[0][2] j := x.f[1][2] k := x.f[2][2] l := x.f[3][2]
	m := x.f[0][3] n := x.f[1][3] o := x.f[2][3] p := x.f[3][3]
  ...
  dest.f[3][3] =  a * t[2] - b * t[4] + c * t[5]
	...
	tmp := (a * dest.f[0][0] + b * dest.f[0][1] +
					c * dest.f[0][2] + d * dest.f[0][3])
...
[direct_array_access]
pub
fn rotate(angle f32, w Vec4) Mat4 { unsafe{
...
[direct_array_access]
pub
fn (x Mat4) translate(w Vec4) Mat4 { unsafe{
	return Mat4{e:[
