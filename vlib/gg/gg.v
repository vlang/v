...
fn gg_init_sokol_window(user_data voidptr) {
	...
	*/
	...
	pipdesc.blend.src_factor_rgb = int(C.SG_BLENDFACTOR_SRC_ALPHA)
	pipdesc.blend.dst_factor_rgb = int(C.SG_BLENDFACTOR_ONE_MINUS_SRC_ALPHA)
	...
	match e.typ {
		.key_down {
			if g.config.keydown_fn != voidptr(0) {
				...
				kdfn(e.key_code, u32(e.modifiers), g.config.user_data)
			}
		}
		.char {
