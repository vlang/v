...
fn test_print_v_files_in_stdout_mode() {
	check_parsing_files_in_folder('vlib/old/parser/testdata/stdout', '-print-v-files')
}

fn test_print_v_files_in_silent_mode() {
	check_parsing_files_in_folder('vlib/old/parser/testdata/silent', '-silent -print-v-files')
}

fn test_print_watched_files_in_silent_mode__used_by_vwatch() {
	check_parsing_files_in_folder('vlib/old/parser/testdata/silent', '-silent -print-watched-files')
}
