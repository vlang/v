...
typedef struct net__stream__NetInputStream net__stream__NetInputStream;
typedef struct net__stream__NetOutputStream net__stream__NetOutputStream;
typedef struct main__Test main__Test;
...
typedef array array_f32;
typedef array array_f64;
typedef _Interface net__stream__InputStream;
typedef _Interface net__stream__OutputStream;
...
struct net__stream__NetInputStream {
	net__Socket* sock;
};

struct net__stream__NetOutputStream {
	net__Socket* sock;
};
...
typedef struct {
	...
	net__Socket arg1;
	net__Socket arg2;
} multi_return_net__Socket_net__Socket_net__Socket;
...
string array_byte_str(array_byte a); // auto
string array_u16_str(array_u16 a); // auto
string array_u32_str(array_u32 a); // auto
string array_u64_str(array_u64 a); // auto
// variadic structs
struct varg_voidptr {
	int len;
	voidptr args[0];
...
net__stream__NetInputStream* net__stream__new_net_input_stream(net__Socket* sock);
int net__stream__NetInputStream_get_int(net__stream__NetInputStream* nis);
array_int net__stream__NetInputStream_get_ints(net__stream__NetInputStream* nis, u32 l);
i8 net__stream__NetInputStream_get_i8(net__stream__NetInputStream* nis);
array_i8 net__stream__NetInputStream_get_i8s(net__stream__NetInputStream* nis, u32 l);
i16 net__stream__NetInputStream_get_i16(net__stream__NetInputStream* nis);
array_i16 net__stream__NetInputStream_get_i16s(net__stream__NetInputStream* nis, u32 l);
i64 net__stream__NetInputStream_get_i64(net__stream__NetInputStream* nis);
array_i64 net__stream__NetInputStream_get_i64s(net__stream__NetInputStream* nis, u32 l);
byte net__stream__NetInputStream_get_byte(net__stream__NetInputStream* nis);
array_byte net__stream__NetInputStream_get_bytes(net__stream__NetInputStream* nis, u32 l);
u16 net__stream__NetInputStream_get_u16(net__stream__NetInputStream* nis);
array_u16 net__stream__NetInputStream_get_u16s(net__stream__NetInputStream* nis, u32 l);
u32 net__stream__NetInputStream_get_u32(net__stream__NetInputStream* nis);
array_u32 net__stream__NetInputStream_get_u32s(net__stream__NetInputStream* nis, u32 l);
u64 net__stream__NetInputStream_get_u64(net__stream__NetInputStream* nis);
array_u64 net__stream__NetInputStream_get_u64s(net__stream__NetInputStream* nis, u32 l);
f32 net__stream__NetInputStream_get_f32(net__stream__NetInputStream* nis);
array_f32 net__stream__NetInputStream_get_f32s(net__stream__NetInputStream* nis, u32 l);
f64 net__stream__NetInputStream_get_f64(net__stream__NetInputStream* nis);
array_f64 net__stream__NetInputStream_get_f64s(net__stream__NetInputStream* nis, u32 l);
string net__stream__NetInputStream_get_string(net__stream__NetInputStream* nis, u32 l);
void net__stream__NetInputStream_skip(net__stream__NetInputStream* nis, u32 l);
net__stream__NetOutputStream* net__stream__new_net_output_stream(net__Socket* sock);
Option_void net__stream__NetOutputStream_write_int(net__stream__NetOutputStream* nos, int d);
Option_void net__stream__NetOutputStream_write_ints(net__stream__NetOutputStream* nos, array_int d);
Option_void net__stream__NetOutputStream_write_i8(net__stream__NetOutputStream* nos, i8 d);
Option_void net__stream__NetOutputStream_write_i8s(net__stream__NetOutputStream* nos, array_i8 d);
Option_void net__stream__NetOutputStream_write_i16(net__stream__NetOutputStream* nos, i16 d);
Option_void net__stream__NetOutputStream_write_i16s(net__stream__NetOutputStream* nos, array_i16 d);
Option_void net__stream__NetOutputStream_write_i64(net__stream__NetOutputStream* nos, i64 d);
Option_void net__stream__NetOutputStream_write_i64s(net__stream__NetOutputStream* nos, array_i64 d);
Option_void net__stream__NetOutputStream_write_byte(net__stream__NetOutputStream* nos, byte d);
Option_void net__stream__NetOutputStream_write_bytes(net__stream__NetOutputStream* nos, array_byte d);
Option_void net__stream__NetOutputStream_write_u16(net__stream__NetOutputStream* nos, u16 d);
Option_void net__stream__NetOutputStream_write_u16s(net__stream__NetOutputStream* nos, array_u16 d);
Option_void net__stream__NetOutputStream_write_u32(net__stream__NetOutputStream* nos, u32 d);
Option_void net__stream__NetOutputStream_write_u32s(net__stream__NetOutputStream* nos, array_u32 d);
Option_void net__stream__NetOutputStream_write_u64(net__stream__NetOutputStream* nos, u64 d);
Option_void net__stream__NetOutputStream_write_u64s(net__stream__NetOutputStream* nos, array_u64 d);
Option_void net__stream__NetOutputStream_write_f32(net__stream__NetOutputStream* nos, f32 d);
Option_void net__stream__NetOutputStream_write_f32s(net__stream__NetOutputStream* nos, array_f32 d);
Option_void net__stream__NetOutputStream_write_f64(net__stream__NetOutputStream* nos, f64 d);
Option_void net__stream__NetOutputStream_write_f64s(net__stream__NetOutputStream* nos, array_f64 d);
Option_void net__stream__NetOutputStream_write_string(net__stream__NetOutputStream* nos, string d);
static void main__cb_assertion_failed(VAssertMetaInfo* i);
static void main__cb_assertion_ok(VAssertMetaInfo* i);
int g_test_oks = 0;
int g_test_fails = 0;
jmp_buf g_jump_buffer;
static multi_return_net__Socket_net__Socket_net__Socket main__setup();
static void main__test_arrays();
bool byte_arr_eq(array_byte a, array_byte b) {
	if (a.len != b.len) {
		return false;
	}
...
bool u16_arr_eq(array_u16 a, array_u16 b) {
	if (a.len != b.len) {
		return false;
	}
	for (int i = 0; i < a.len; ++i) {
		if (*((u16*)((byte*)a.data+(i*a.element_size))) != *((u16*)((byte*)b.data+(i*b.element_size)))) {
			return false;
		}
	}
	return true;
}
bool u32_arr_eq(array_u32 a, array_u32 b) {
	if (a.len != b.len) {
		return false;
	}
	for (int i = 0; i < a.len; ++i) {
		if (*((u32*)((byte*)a.data+(i*a.element_size))) != *((u32*)((byte*)b.data+(i*b.element_size)))) {
			return false;
		}
	}
	return true;
}
bool u64_arr_eq(array_u64 a, array_u64 b) {
	if (a.len != b.len) {
		return false;
	}
	for (int i = 0; i < a.len; ++i) {
		if (*((u64*)((byte*)a.data+(i*a.element_size))) != *((u64*)((byte*)b.data+(i*b.element_size)))) {
			return false;
		}
	}
	return true;
...
string array_u16_str(array_u16 a) {
	strings__Builder sb = strings__new_builder(a.len * 10);
	strings__Builder_write(&sb, tos_lit("["));
	for (int i = 0; i < a.len; ++i) {
		u16 it = (*(u16*)array_get(a, i));
		string x = u16_str(it);
		strings__Builder_write(&sb, x);
		if (i < a.len-1) {
			strings__Builder_write(&sb, tos_lit(", "));
...
string array_u32_str(array_u32 a) {
	strings__Builder sb = strings__new_builder(a.len * 10);
	strings__Builder_write(&sb, tos_lit("["));
	for (int i = 0; i < a.len; ++i) {
		u32 it = (*(u32*)array_get(a, i));
		string x = u32_str(it);
		strings__Builder_write(&sb, x);
		if (i < a.len-1) {
			strings__Builder_write(&sb, tos_lit(", "));
...
Option_string net__hostname() {
	...
	if (res != 0) {
		Option _t188 = v_error(_STR("net.hostname: failed with %"PRId32"", 1, res));
		return *(Option_string*)&_t188;
	}
	Option_string _t189;
	opt_ok2(&(string[]) { tos_clone(namebp) }, (OptionBase*)(&_t189), sizeof(string));
	return _t189;
}
...
Option_net__Socket net__new_socket(int family, int typ, int proto) {
	...
	if (sockfd == -1) {
		Option _t190 = v_error(tos_lit("net.socket: failed"));
		return *(Option_net__Socket*)&_t190;
	}
	net__Socket s = (net__Socket){.sockfd = sockfd,.family = family,.typ = typ,.proto = proto,.max_single_send_size = 64000,};
	Option_net__Socket _t191;
	opt_ok2(&(net__Socket[]) { s }, (OptionBase*)(&_t191), sizeof(net__Socket));
	return _t191;
}
...
Option_int net__Socket_setsockopt(net__Socket s, int level, int optname, int* optvalue) {
	...
	if (res < 0) {
		Option _t192 = v_error(_STR("net.setsocketopt: failed with %"PRId32"", 1, res));
		return *(Option_int*)&_t192;
	}
	Option_int _t193;
	opt_ok2(&(int[]) { res }, (OptionBase*)(&_t193), sizeof(int));
	return _t193;
}
...
Option_int net__Socket_bind(net__Socket s, int port) {
	...
	if (res < 0) {
		Option _t194 = v_error(_STR("net.bind: failed with %"PRId32"", 1, res));
		return *(Option_int*)&_t194;
	}
	Option_int _t195;
	opt_ok2(&(int[]) { res }, (OptionBase*)(&_t195), sizeof(int));
	return _t195;
}
...
Option_int net__Socket_listen(net__Socket s) {
	...
	if (res < 0) {
		Option _t196 = v_error(_STR("net.listen: failed with %"PRId32"", 1, res));
		return *(Option_int*)&_t196;
	}
// $if  debug {
#ifdef _VDEBUG
...
// } debug
	Option_int _t197;
	opt_ok2(&(int[]) { res }, (OptionBase*)(&_t197), sizeof(int));
	return _t197;
}
...
Option_int net__Socket_listen_backlog(net__Socket s, int backlog) {
	...
	if (res < 0) {
		Option _t198 = v_error(_STR("net.listen_backlog: failed with %"PRId32"", 1, res));
...
#endif
// } debug
	Option_net__Socket _t200 = net__new_socket(AF_INET, SOCK_STREAM, 0);
	if (!_t200.ok) {
		string err = _t200.v_error;
		int errcode = _t200.ecode;
		Option _t201 = v_error(err);
		return *(Option_net__Socket*)&_t201;
	}
	net__Socket s = *(net__Socket*)_t200.data;
	Option_int _t202 = net__Socket_bind(s, port);
	if (!_t202.ok) {
		string err = _t202.v_error;
		int errcode = _t202.ecode;
		Option _t203 = v_error(err);
		return *(Option_net__Socket*)&_t203;
	};
	Option_int _t204 = net__Socket_listen(s);
	if (!_t204.ok) {
		string err = _t204.v_error;
		int errcode = _t204.ecode;
		Option _t205 = v_error(err);
		return *(Option_net__Socket*)&_t205;
	};
	Option_net__Socket _t206;
	opt_ok2(&(net__Socket[]) { s }, (OptionBase*)(&_t206), sizeof(net__Socket));
	return _t206;
}
...
0
	...
	if (sockfd < 0) {
		Option _t207 = v_error(_STR("net.accept: failed with %"PRId32"", 1, sockfd));
		return *(Option_net__Socket*)&_t207;
	}
	net__Socket c = (net__Socket){.sockfd = sockfd,.family = s.family,.typ = s.typ,.proto = s.proto,.max_single_send_size = 64000,};
	Option_net__Socket _t208;
	opt_ok2(&(net__Socket[]) { c }, (OptionBase*)(&_t208), sizeof(net__Socket));
	return _t208;
}
...
Option_string net__Socket_peer_ip(net__Socket s) {
	...
	if (ok == -1) {
		Option _t209 = v_error(tos_lit("net.peer_ip: getpeername failed"));
		return *(Option_string*)&_t209;
	}
	charptr cstr = inet_ntop(AF_INET, &peeraddr.sin_addr, buf, /*SizeOfVar*/ sizeof(buf));
	if (cstr == 0) {
		Option _t210 = v_error(tos_lit("net.peer_ip: inet_ntop failed"));
		return *(Option_string*)&_t210;
	}
	Option_string _t211;
	opt_ok2(&(string[]) { cstring_to_vstring(cstr) }, (OptionBase*)(&_t211), sizeof(string));
	return _t211;
}
...
Option_int net__Socket_connect(net__Socket s, string address, int port) {
	...
	if (info_res != 0) {
		...
		Option _t212 = v_error(_STR("net.connect: getaddrinfo failed \"%.*s\000\"", 2, error_message));
		return *(Option_int*)&_t212;
	}
	int res = connect(s.sockfd, info->ai_addr, info->ai_addrlen);
	if (res < 0) {
		string error_message = os__get_error_msg(net__error_code());
		Option _t213 = v_error(_STR("net.connect: connect failed \"%.*s\000\"", 2, error_message));
		return *(Option_int*)&_t213;
	}
	Option_int _t214;
	opt_ok2(&(int[]) { res }, (OptionBase*)(&_t214), sizeof(int));
	return _t214;
}

Option_net__Socket net__dial(string address, int port) {
	Option_net__Socket _t215 = net__new_socket(AF_INET, SOCK_STREAM, 0);
	if (!_t215.ok) {
		string err = _t215.v_error;
		int errcode = _t215.ecode;
		Option _t216 = v_error(err);
		return *(Option_net__Socket*)&_t216;
	}
	net__Socket s = *(net__Socket*)_t215.data;
	Option_int _t217 = net__Socket_connect(s, address, port);
	if (!_t217.ok) {
		string err = _t217.v_error;
		int errcode = _t217.ecode;
		Option _t218 = v_error(err);
		return *(Option_net__Socket*)&_t218;
	};
	Option_net__Socket _t219;
	opt_ok2(&(net__Socket[]) { s }, (OptionBase*)(&_t219), sizeof(net__Socket));
	return _t219;
}
...
Option_int net__Socket_send(net__Socket s, byteptr buf, int len) {
	...
	while (1) {
		...
		if (sbytes < 0) {
			Option _t220 = v_error(_STR("net.send: failed with %"PRId32"", 1, sbytes));
			return *(Option_int*)&_t220;
		}
		dlen -= sbytes;
		if (dlen <= 0) {
			break;
	...
	Option_int _t221;
	opt_ok2(&(int[]) { len }, (OptionBase*)(&_t221), sizeof(int));
	return _t221;
}
...
// } windows
	if (res < 0) {
		Option _t222 = v_error(_STR("net.close: failed with %"PRId32"", 1, res));
		return *(Option_int*)&_t222;
	}
	Option_int _t223;
	opt_ok2(&(int[]) { 0 }, (OptionBase*)(&_t223), sizeof(int));
	return _t223;
}
...
Option_int net__Socket_write(net__Socket s, string str) {
	...
	if (res < 0) {
		Option _t224 = v_error(_STR("net.write: failed with %"PRId32"", 1, res));
		return *(Option_int*)&_t224;
	}
	Option_int _t225;
	opt_ok2(&(int[]) { res }, (OptionBase*)(&_t225), sizeof(int));
	return _t225;
}
...
net__stream__NetInputStream* net__stream__new_net_input_stream(net__Socket* sock) {
	return (net__stream__NetInputStream*)memdup(&(net__stream__NetInputStream){.sock = sock,}, sizeof(net__stream__NetInputStream));
}

int net__stream__NetInputStream_get_int(net__stream__NetInputStream* nis) {
	return ((int)(net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(int)).data));
}

array_int net__stream__NetInputStream_get_ints(net__stream__NetInputStream* nis, u32 l) {
	array_byte bytes = net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(int) * l);
	array_int ints = __new_array_with_default(0, 0, sizeof(int), 0);
	for (int i = 0; i < l; ++i) {
		int offs = ((int)(((u32)(i)) * /*SizeOfType*/ sizeof(int)));
		array_byte b = array_slice(bytes, offs, ((int)(((u32)(offs)) + /*SizeOfType*/ sizeof(int))));
		array_push(&ints, _MOV((int[]){ ((int)(encoding__binary__little_endian_u32(b))) }));
	}
	return ints;
}

i8 net__stream__NetInputStream_get_i8(net__stream__NetInputStream* nis) {
	return ((i8)(net__stream__NetInputStream_get_byte(nis)));
}

array_i8 net__stream__NetInputStream_get_i8s(net__stream__NetInputStream* nis, u32 l) {
	array_byte bytes = net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(i8) * l);
	array_i8 i8s = __new_array_with_default(0, 0, sizeof(i8), 0);
	for (int i = 0; i < l; ++i) {
		array_push(&i8s, _MOV((i8[]){ ((i8)((*(byte*)array_get(bytes, i)))) }));
	}
	return i8s;
}

i16 net__stream__NetInputStream_get_i16(net__stream__NetInputStream* nis) {
	return ((i16)(net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(i16)).data));
}

array_i16 net__stream__NetInputStream_get_i16s(net__stream__NetInputStream* nis, u32 l) {
	array_byte bytes = net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(i16) * l);
	array_i16 i16s = __new_array_with_default(0, 0, sizeof(i16), 0);
	for (int i = 0; i < l; ++i) {
		int offs = ((int)(((u32)(i)) * /*SizeOfType*/ sizeof(i16)));
		array_byte b = array_slice(bytes, offs, ((int)(((u32)(offs)) + /*SizeOfType*/ sizeof(i16))));
		array_push(&i16s, _MOV((i16[]){ ((i16)(encoding__binary__little_endian_u16(b))) }));
	}
	return i16s;
}

i64 net__stream__NetInputStream_get_i64(net__stream__NetInputStream* nis) {
	return ((i64)(net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(i64)).data));
}

array_i64 net__stream__NetInputStream_get_i64s(net__stream__NetInputStream* nis, u32 l) {
	array_byte bytes = net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(i64) * l);
	array_i64 i64s = __new_array_with_default(0, 0, sizeof(i64), 0);
	for (int i = 0; i < l; ++i) {
		int offs = ((int)(((u32)(i)) * /*SizeOfType*/ sizeof(i64)));
		array_byte b = array_slice(bytes, offs, ((int)(((u32)(offs)) + /*SizeOfType*/ sizeof(i64))));
		array_push(&i64s, _MOV((i64[]){ ((i64)(encoding__binary__little_endian_u64(b))) }));
	}
	return i64s;
}

byte net__stream__NetInputStream_get_byte(net__stream__NetInputStream* nis) {
	multi_return_byteptr_int mr_1654 = net__Socket_recv(/*rec*/*nis->sock, ((int)(/*SizeOfType*/ sizeof(byte))));
	byteptr ptr = mr_1654.arg0;
	{ // Unsafe block
		return ptr[0];
	}
}
...
array_byte net__stream__NetInputStream_get_bytes(net__stream__NetInputStream* nis, u32 l) {
	multi_return_byteptr_int mr_1788 = net__Socket_recv(/*rec*/*nis->sock, ((int)(l)));
	byteptr ptr = mr_1788.arg0;
	return string_bytes(tos2((byteptr)ptr));
}

u16 net__stream__NetInputStream_get_u16(net__stream__NetInputStream* nis) {
	return ((u16)(net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(u16)).data));
}

array_u16 net__stream__NetInputStream_get_u16s(net__stream__NetInputStream* nis, u32 l) {
	array_byte bytes = net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(u16) * l);
	println(int_str(bytes.len));
	println(u32_str(/*SizeOfType*/ sizeof(u16) * l));
	array_u16 u16s = __new_array_with_default(0, 0, sizeof(u16), 0);
	for (int i = 0; i < l; ++i) {
		int offs = ((int)(((u32)(i)) * /*SizeOfType*/ sizeof(u16)));
		array_byte b = array_slice(bytes, offs, ((int)(((u32)(offs)) + /*SizeOfType*/ sizeof(u16))));
		array_push(&u16s, _MOV((u16[]){ encoding__binary__little_endian_u16(b) }));
	}
	return u16s;
}

u32 net__stream__NetInputStream_get_u32(net__stream__NetInputStream* nis) {
	return ((u32)(net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(u32)).data));
}

array_u32 net__stream__NetInputStream_get_u32s(net__stream__NetInputStream* nis, u32 l) {
	array_byte bytes = net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(u32) * l);
	println(int_str(bytes.len));
	array_u32 u32s = __new_array_with_default(0, 0, sizeof(u32), 0);
	for (int i = 0; i < l; ++i) {
		println(int_str(i));
		int offs = ((int)(((u32)(i)) * /*SizeOfType*/ sizeof(u32)));
		array_byte b = array_slice(bytes, offs, ((int)(((u32)(offs)) + /*SizeOfType*/ sizeof(u32))));
		array_push(&u32s, _MOV((u32[]){ encoding__binary__little_endian_u32(b) }));
	}
	return u32s;
}

u64 net__stream__NetInputStream_get_u64(net__stream__NetInputStream* nis) {
	return ((u64)(net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(u64)).data));
}

array_u64 net__stream__NetInputStream_get_u64s(net__stream__NetInputStream* nis, u32 l) {
	array_byte bytes = net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(u64) * l);
	println(int_str(bytes.len));
	array_u64 u64s = __new_array_with_default(0, 0, sizeof(u64), 0);
	for (int i = 0; i < l; ++i) {
		int offs = ((int)(((u32)(i)) * /*SizeOfType*/ sizeof(u64)));
		array_byte b = array_slice(bytes, offs, ((int)(((u32)(offs)) + /*SizeOfType*/ sizeof(u64))));
		array_push(&u64s, _MOV((u64[]){ encoding__binary__little_endian_u64(b) }));
	}
	return u64s;
}

f32 net__stream__NetInputStream_get_f32(net__stream__NetInputStream* nis) {
	return ((f32)(net__stream__NetInputStream_get_int(nis)));
}

array_f32 net__stream__NetInputStream_get_f32s(net__stream__NetInputStream* nis, u32 l) {
	array_byte bytes = net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(f32) * l);
	array_f32 f32s = __new_array_with_default(0, 0, sizeof(f32), 0);
	for (int i = 0; i < l; ++i) {
		int offs = ((int)(((u32)(i)) * /*SizeOfType*/ sizeof(f32)));
		array_byte b = array_slice(bytes, offs, ((int)(((u32)(offs)) + /*SizeOfType*/ sizeof(f32))));
		f32* f = ((f32*)(b.data));
		{ // Unsafe block
			array_push(&f32s, _MOV((f32[]){ f[0] }));
		}
	}
	return f32s;
}
...
f64 net__stream__NetInputStream_get_f64(net__stream__NetInputStream* nis) {
	return ((f64)(net__stream__NetInputStream_get_i64(nis)));
}

array_f64 net__stream__NetInputStream_get_f64s(net__stream__NetInputStream* nis, u32 l) {
	array_byte bytes = net__stream__NetInputStream_get_bytes(nis, /*SizeOfType*/ sizeof(f64) * l);
	array_f64 f64s = __new_array_with_default(0, 0, sizeof(f64), 0);
	for (int i = 0; i < l; ++i) {
		int offs = ((int)(((u32)(i)) * /*SizeOfType*/ sizeof(f64)));
		array_byte b = array_slice(bytes, offs, ((int)(((u32)(offs)) + /*SizeOfType*/ sizeof(f64))));
		f64* f = ((f64*)(b.data));
		{ // Unsafe block
			array_push(&f64s, _MOV((f64[]){ f[0] }));
		}
	}
	return f64s;
}
...
string net__stream__NetInputStream_get_string(net__stream__NetInputStream* nis, u32 l) {
	return tos2((byteptr)net__stream__NetInputStream_get_bytes(nis, l).data);
}

void net__stream__NetInputStream_skip(net__stream__NetInputStream* nis, u32 l) {
	net__stream__NetInputStream_get_bytes(nis, l);
}


net__stream__NetOutputStream* net__stream__new_net_output_stream(net__Socket* sock) {
	return (net__stream__NetOutputStream*)memdup(&(net__stream__NetOutputStream){.sock = sock,}, sizeof(net__stream__NetOutputStream));
}

Option_void net__stream__NetOutputStream_write_int(net__stream__NetOutputStream* nos, int d) {
	Option_int _t235 = net__Socket_send(/*rec*/*nos->sock, ((byteptr)(d)), ((int)(/*SizeOfType*/ sizeof(int))));
	if (!_t235.ok) {
		return *(Option_void *)&_t235;
	};
	Option_void _t236 = {.ok = true};
	return _t236;
}

Option_void net__stream__NetOutputStream_write_ints(net__stream__NetOutputStream* nos, array_int d) {
	Option_int _t237 = net__Socket_send(/*rec*/*nos->sock, d.data, ((int)(/*SizeOfType*/ sizeof(int) * ((u32)(d.len)))));
	if (!_t237.ok) {
		return *(Option_void *)&_t237;
	};
	Option_void _t238 = {.ok = true};
	return _t238;
}

Option_void net__stream__NetOutputStream_write_i8(net__stream__NetOutputStream* nos, i8 d) {
	Option_int _t239 = net__Socket_send(/*rec*/*nos->sock, ((byteptr)(d)), ((int)(/*SizeOfType*/ sizeof(i8))));
	if (!_t239.ok) {
		return *(Option_void *)&_t239;
	};
	Option_void _t240 = {.ok = true};
	return _t240;
}

Option_void net__stream__NetOutputStream_write_i8s(net__stream__NetOutputStream* nos, array_i8 d) {
	Option_int _t241 = net__Socket_send(/*rec*/*nos->sock, d.data, ((int)(/*SizeOfType*/ sizeof(i8) * ((u32)(d.len)))));
	if (!_t241.ok) {
		return *(Option_void *)&_t241;
	};
	Option_void _t242 = {.ok = true};
	return _t242;
}

Option_void net__stream__NetOutputStream_write_i16(net__stream__NetOutputStream* nos, i16 d) {
	Option_int _t243 = net__Socket_send(/*rec*/*nos->sock, ((byteptr)(d)), ((int)(/*SizeOfType*/ sizeof(i16))));
	if (!_t243.ok) {
		return *(Option_void *)&_t243;
	};
	Option_void _t244 = {.ok = true};
	return _t244;
}

Option_void net__stream__NetOutputStream_write_i16s(net__stream__NetOutputStream* nos, array_i16 d) {
	Option_int _t245 = net__Socket_send(/*rec*/*nos->sock, d.data, ((int)(/*SizeOfType*/ sizeof(i16) * ((u32)(d.len)))));
	if (!_t245.ok) {
		return *(Option_void *)&_t245;
	};
	Option_void _t246 = {.ok = true};
	return _t246;
}

Option_void net__stream__NetOutputStream_write_i64(net__stream__NetOutputStream* nos, i64 d) {
	Option_int _t247 = net__Socket_send(/*rec*/*nos->sock, ((byteptr)(d)), ((int)(/*SizeOfType*/ sizeof(i64))));
	if (!_t247.ok) {
		return *(Option_void *)&_t247;
	};
	Option_void _t248 = {.ok = true};
	return _t248;
}

Option_void net__stream__NetOutputStream_write_i64s(net__stream__NetOutputStream* nos, array_i64 d) {
	Option_int _t249 = net__Socket_send(/*rec*/*nos->sock, d.data, ((int)(/*SizeOfType*/ sizeof(i64) * ((u32)(d.len)))));
	if (!_t249.ok) {
		return *(Option_void *)&_t249;
	};
	Option_void _t250 = {.ok = true};
	return _t250;
}

Option_void net__stream__NetOutputStream_write_byte(net__stream__NetOutputStream* nos, byte d) {
	Option_int _t251 = net__Socket_send(/*rec*/*nos->sock, ((byteptr)(d)), ((int)(/*SizeOfType*/ sizeof(byte))));
	if (!_t251.ok) {
		return *(Option_void *)&_t251;
	};
	Option_void _t252 = {.ok = true};
	return _t252;
}

Option_void net__stream__NetOutputStream_write_bytes(net__stream__NetOutputStream* nos, array_byte d) {
	Option_int _t253 = net__Socket_send(/*rec*/*nos->sock, d.data, ((int)(/*SizeOfType*/ sizeof(byte) * ((u32)(d.len)))));
	if (!_t253.ok) {
		return *(Option_void *)&_t253;
	};
	Option_void _t254 = {.ok = true};
	return _t254;
}

Option_void net__stream__NetOutputStream_write_u16(net__stream__NetOutputStream* nos, u16 d) {
	Option_int _t255 = net__Socket_send(/*rec*/*nos->sock, ((byteptr)(d)), ((int)(/*SizeOfType*/ sizeof(u16))));
	if (!_t255.ok) {
		return *(Option_void *)&_t255;
	};
	Option_void _t256 = {.ok = true};
	return _t256;
}

Option_void net__stream__NetOutputStream_write_u16s(net__stream__NetOutputStream* nos, array_u16 d) {
	Option_int _t257 = net__Socket_send(/*rec*/*nos->sock, d.data, ((int)(/*SizeOfType*/ sizeof(u16) * ((u32)(d.len)))));
	if (!_t257.ok) {
		return *(Option_void *)&_t257;
	};
	Option_void _t258 = {.ok = true};
	return _t258;
}

Option_void net__stream__NetOutputStream_write_u32(net__stream__NetOutputStream* nos, u32 d) {
	Option_int _t259 = net__Socket_send(/*rec*/*nos->sock, ((byteptr)(d)), ((int)(/*SizeOfType*/ sizeof(u32))));
	if (!_t259.ok) {
		return *(Option_void *)&_t259;
	};
	Option_void _t260 = {.ok = true};
	return _t260;
}
...
Option_void net__stream__NetOutputStream_write_u32s(net__stream__NetOutputStream* nos, array_u32 d) {
	...
	for (int _t262 = 0; _t262 < _t261.len; ++_t262) {
		u32 u = ((u32*)_t261.data)[_t262];
		array_byte tmp = __new_array_with_default(((int)(/*SizeOfType*/ sizeof(u32))), 0, sizeof(byte), 0);
		encoding__binary__big_endian_put_u32(&/*arr*/tmp, u);
		_PUSH_MANY(&bytes, (tmp), _t263, array_byte);
	}
	Option_int _t264 = net__Socket_send(/*rec*/*nos->sock, bytes.data, ((int)(/*SizeOfType*/ sizeof(u32) * ((u32)(d.len)))));
	if (!_t264.ok) {
		return *(Option_void *)&_t264;
	};
	Option_void _t265 = {.ok = true};
	return _t265;
}

Option_void net__stream__NetOutputStream_write_u64(net__stream__NetOutputStream* nos, u64 d) {
	Option_int _t266 = net__Socket_send(/*rec*/*nos->sock, ((byteptr)(d)), ((int)(/*SizeOfType*/ sizeof(u64))));
	if (!_t266.ok) {
		return *(Option_void *)&_t266;
	};
	Option_void _t267 = {.ok = true};
	return _t267;
}
...
Option_void net__stream__NetOutputStream_write_u64s(net__stream__NetOutputStream* nos, array_u64 d) {
	...
	for (int _t269 = 0; _t269 < _t268.len; ++_t269) {
		u64 u = ((u64*)_t268.data)[_t269];
		array_byte tmp = __new_array_with_default(((int)(/*SizeOfType*/ sizeof(u64))), 0, sizeof(byte), 0);
		encoding__binary__big_endian_put_u64(&/*arr*/tmp, u);
		_PUSH_MANY(&bytes, (tmp), _t270, array_byte);
	}
	Option_int _t271 = net__Socket_send(/*rec*/*nos->sock, bytes.data, ((int)(/*SizeOfType*/ sizeof(u64) * ((u32)(d.len)))));
	if (!_t271.ok) {
...
Option_void net__stream__NetOutputStream_write_f32(net__stream__NetOutputStream* nos, f32 d) {
	Option_int _t273 = net__Socket_send(/*rec*/*nos->sock, ((byteptr)(((int)(d)))), ((int)(/*SizeOfType*/ sizeof(f32))));
	if (!_t273.ok) {
		return *(Option_void *)&_t273;
	};
	Option_void _t274 = {.ok = true};
	return _t274;
}

Option_void net__stream__NetOutputStream_write_f32s(net__stream__NetOutputStream* nos, array_f32 d) {
	Option_int _t275 = net__Socket_send(/*rec*/*nos->sock, d.data, ((int)(/*SizeOfType*/ sizeof(f32) * ((u32)(d.len)))));
	if (!_t275.ok) {
		return *(Option_void *)&_t275;
	};
	Option_void _t276 = {.ok = true};
	return _t276;
}

Option_void net__stream__NetOutputStream_write_f64(net__stream__NetOutputStream* nos, f64 d) {
	Option_int _t277 = net__Socket_send(/*rec*/*nos->sock, ((byteptr)(((int)(d)))), ((int)(/*SizeOfType*/ sizeof(f64))));
	if (!_t277.ok) {
		return *(Option_void *)&_t277;
	};
	Option_void _t278 = {.ok = true};
	return _t278;
}

Option_void net__stream__NetOutputStream_write_f64s(net__stream__NetOutputStream* nos, array_f64 d) {
	Option_int _t279 = net__Socket_send(/*rec*/*nos->sock, d.data, ((int)(/*SizeOfType*/ sizeof(f64) * ((u32)(d.len)))));
	if (!_t279.ok) {
		return *(Option_void *)&_t279;
	};
	Option_void _t280 = {.ok = true};
	return _t280;
}

Option_void net__stream__NetOutputStream_write_string(net__stream__NetOutputStream* nos, string d) {
	Option_void _t281 = net__stream__NetOutputStream_write_bytes(nos, string_bytes(d));
	if (!_t281.ok && !_t281.is_none) {
		return *(Option_void *)&_t281;
	};
...
static void main__cb_assertion_failed(VAssertMetaInfo* i) {
	...
	bool use_relative_paths = (string_eq(os__getenv(tos_lit("VERROR_PATHS")), tos_lit("absolute"))) ? (false) : (true);
	string final_filename = (use_relative_paths ? (i->fpath) : (os__real_path(i->fpath)));
	string final_funcname = string_replace(string_replace(i->fn_name, tos_lit("main."), tos_lit("")), tos_lit("__"), tos_lit("."));
	...
	if (i->op.len > 0 && string_ne(i->op, tos_lit("call"))) {
		...
		string lpostfix = (string_eq(slvalue, i->llabel) ? (tos_lit(".")) : (_STR("<= `%.*s\000`", 2, i->llabel)));
		string rpostfix = (string_eq(srvalue, i->rlabel) ? (tos_lit(".")) : (_STR("<= `%.*s\000`", 2, i->rlabel)));
		if (use_color) {
			slvalue = term__bold(term__yellow(slvalue));
			srvalue = term__bold(term__yellow(srvalue));
		}
		eprintln(_STR("	 left value: %.*s\000 %.*s", 2, slvalue, lpostfix));
		eprintln(_STR("	right value: %.*s\000 %.*s", 2, srvalue, rpostfix));
	}
}
...
int main() {
	...
	if (!setjmp(g_jump_buffer)) main__test_arrays();


	return g_test_fails > 0;
}
static multi_return_net__Socket_net__Socket_net__Socket main__setup() {
	Option_net__Socket _t284 = net__listen(0);
	if (!_t284.ok) {
		string err = _t284.v_error;
		int errcode = _t284.ecode;
		v_panic(err);
	}
	net__Socket server = *(net__Socket*)_t284.data;
	int server_port = net__Socket_get_port(server);
	Option_net__Socket _t285 = net__dial(tos_lit("127.0.0.1"), server_port);
	if (!_t285.ok) {
		string err = _t285.v_error;
		int errcode = _t285.ecode;
		v_panic(err);
	}
	net__Socket client = *(net__Socket*)_t285.data;
	Option_net__Socket _t286 = net__Socket_accept(server);
	if (!_t286.ok) {
		string err = _t286.v_error;
		int errcode = _t286.ecode;
		v_panic(err);
	}
	net__Socket socket = *(net__Socket*)_t286.data;
	return (multi_return_net__Socket_net__Socket_net__Socket){.arg0=server, .arg1=client, .arg2=socket};
}

static void main__test_arrays() {
	multi_return_net__Socket_net__Socket_net__Socket mr_369 = main__setup();
	net__Socket c = mr_369.arg1;
	net__Socket s = mr_369.arg2;
	net__stream__NetOutputStream* nos = net__stream__new_net_output_stream((voidptr)&/*qq*/s);
	net__stream__NetInputStream* nis = net__stream__new_net_input_stream((voidptr)&/*qq*/c);
	array_byte a = new_array_from_c_array(4, 4, sizeof(byte), _MOV((byte[4]){((byte)(76)), 7, 43, 5}));
	Option_void _t287 = net__stream__NetOutputStream_write_bytes(nos, a);
	if (!_t287.ok && !_t287.is_none) {
		string err = _t287.v_error;
		int errcode = _t287.ecode;
		// assert
		if (false){
			g_test_oks++;
			VAssertMetaInfo v_assert_meta_info__t288;
			memset(&v_assert_meta_info__t288, 0, sizeof(VAssertMetaInfo));
			v_assert_meta_info__t288.fpath = tos_lit("net_stream_test.v");
			v_assert_meta_info__t288.line_nr = 25;
			v_assert_meta_info__t288.fn_name = tos_lit("main.test_arrays");
			v_assert_meta_info__t288.src = tos_lit("false");
			main__cb_assertion_ok(&v_assert_meta_info__t288);
		} else {
			g_test_fails++;
			VAssertMetaInfo v_assert_meta_info__t289;
			memset(&v_assert_meta_info__t289, 0, sizeof(VAssertMetaInfo));
			v_assert_meta_info__t289.fpath = tos_lit("net_stream_test.v");
			v_assert_meta_info__t289.line_nr = 25;
			v_assert_meta_info__t289.fn_name = tos_lit("main.test_arrays");
			v_assert_meta_info__t289.src = tos_lit("false");
			main__cb_assertion_failed(&v_assert_meta_info__t289);
			longjmp(g_jump_buffer, 1);
			// TODO
			// Maybe print all vars in a test function if it fails?
		}
	};
	array_byte c_a = net__stream__NetInputStream_get_bytes(nis, 4);
	// assert
	if (byte_arr_eq(a, c_a)){
		g_test_oks++;
		VAssertMetaInfo v_assert_meta_info__t290;
		memset(&v_assert_meta_info__t290, 0, sizeof(VAssertMetaInfo));
		v_assert_meta_info__t290.fpath = tos_lit("net_stream_test.v");
		v_assert_meta_info__t290.line_nr = 27;
		v_assert_meta_info__t290.fn_name = tos_lit("main.test_arrays");
		v_assert_meta_info__t290.src = tos_lit("a == c_a");
		v_assert_meta_info__t290.op = tos_lit("==");
		v_assert_meta_info__t290.llabel = tos_lit("a");
		v_assert_meta_info__t290.rlabel = tos_lit("c_a");
		v_assert_meta_info__t290.lvalue = array_byte_str(  a) /* typeof: v.ast.Ident type: 31 */ ;
		v_assert_meta_info__t290.rvalue = array_byte_str(  c_a) /* typeof: v.ast.Ident type: 31 */ ;
		main__cb_assertion_ok(&v_assert_meta_info__t290);
	} else {
		g_test_fails++;
		VAssertMetaInfo v_assert_meta_info__t291;
		memset(&v_assert_meta_info__t291, 0, sizeof(VAssertMetaInfo));
		v_assert_meta_info__t291.fpath = tos_lit("net_stream_test.v");
		v_assert_meta_info__t291.line_nr = 27;
		v_assert_meta_info__t291.fn_name = tos_lit("main.test_arrays");
		v_assert_meta_info__t291.src = tos_lit("a == c_a");
		v_assert_meta_info__t291.op = tos_lit("==");
		v_assert_meta_info__t291.llabel = tos_lit("a");
		v_assert_meta_info__t291.rlabel = tos_lit("c_a");
		v_assert_meta_info__t291.lvalue = array_byte_str(  a) /* typeof: v.ast.Ident type: 31 */ ;
		v_assert_meta_info__t291.rvalue = array_byte_str(  c_a) /* typeof: v.ast.Ident type: 31 */ ;
		main__cb_assertion_failed(&v_assert_meta_info__t291);
		longjmp(g_jump_buffer, 1);
		// TODO
		// Maybe print all vars in a test function if it fails?
	}
	array_u16 b = new_array_from_c_array(3, 3, sizeof(u16), _MOV((u16[3]){((u16)(546)), 3434, 33}));
	Option_void _t292 = net__stream__NetOutputStream_write_u16s(nos, b);
	if (!_t292.ok && !_t292.is_none) {
		string err = _t292.v_error;
		int errcode = _t292.ecode;
		// assert
		if (false){
			g_test_oks++;
			VAssertMetaInfo v_assert_meta_info__t293;
			memset(&v_assert_meta_info__t293, 0, sizeof(VAssertMetaInfo));
			v_assert_meta_info__t293.fpath = tos_lit("net_stream_test.v");
			v_assert_meta_info__t293.line_nr = 31;
			v_assert_meta_info__t293.fn_name = tos_lit("main.test_arrays");
			v_assert_meta_info__t293.src = tos_lit("false");
			main__cb_assertion_ok(&v_assert_meta_info__t293);
		} else {
			g_test_fails++;
			VAssertMetaInfo v_assert_meta_info__t294;
			memset(&v_assert_meta_info__t294, 0, sizeof(VAssertMetaInfo));
			v_assert_meta_info__t294.fpath = tos_lit("net_stream_test.v");
			v_assert_meta_info__t294.line_nr = 31;
			v_assert_meta_info__t294.fn_name = tos_lit("main.test_arrays");
			v_assert_meta_info__t294.src = tos_lit("false");
			main__cb_assertion_failed(&v_assert_meta_info__t294);
			longjmp(g_jump_buffer, 1);
			// TODO
			// Maybe print all vars in a test function if it fails?
		}
	};
	array_u16 c_b = net__stream__NetInputStream_get_u16s(nis, 3);
	// assert
	if (u16_arr_eq(b, c_b)){
		g_test_oks++;
		VAssertMetaInfo v_assert_meta_info__t295;
		memset(&v_assert_meta_info__t295, 0, sizeof(VAssertMetaInfo));
		v_assert_meta_info__t295.fpath = tos_lit("net_stream_test.v");
		v_assert_meta_info__t295.line_nr = 33;
		v_assert_meta_info__t295.fn_name = tos_lit("main.test_arrays");
		v_assert_meta_info__t295.src = tos_lit("b == c_b");
		v_assert_meta_info__t295.op = tos_lit("==");
		v_assert_meta_info__t295.llabel = tos_lit("b");
		v_assert_meta_info__t295.rlabel = tos_lit("c_b");
		v_assert_meta_info__t295.lvalue = array_u16_str(  b) /* typeof: v.ast.Ident type: 108 */ ;
		v_assert_meta_info__t295.rvalue = array_u16_str(  c_b) /* typeof: v.ast.Ident type: 108 */ ;
		main__cb_assertion_ok(&v_assert_meta_info__t295);
	} else {
		g_test_fails++;
		VAssertMetaInfo v_assert_meta_info__t296;
		memset(&v_assert_meta_info__t296, 0, sizeof(VAssertMetaInfo));
		v_assert_meta_info__t296.fpath = tos_lit("net_stream_test.v");
		v_assert_meta_info__t296.line_nr = 33;
		v_assert_meta_info__t296.fn_name = tos_lit("main.test_arrays");
		v_assert_meta_info__t296.src = tos_lit("b == c_b");
		v_assert_meta_info__t296.op = tos_lit("==");
		v_assert_meta_info__t296.llabel = tos_lit("b");
		v_assert_meta_info__t296.rlabel = tos_lit("c_b");
		v_assert_meta_info__t296.lvalue = array_u16_str(  b) /* typeof: v.ast.Ident type: 108 */ ;
		v_assert_meta_info__t296.rvalue = array_u16_str(  c_b) /* typeof: v.ast.Ident type: 108 */ ;
		main__cb_assertion_failed(&v_assert_meta_info__t296);
		longjmp(g_jump_buffer, 1);
		// TODO
		// Maybe print all vars in a test function if it fails?
	}
	array_u32 d = new_array_from_c_array(5, 5, sizeof(u32), _MOV((u32[5]){((u32)(10)), 34324, 454, 34, 352}));
	Option_void _t297 = net__stream__NetOutputStream_write_u32s(nos, d);
	if (!_t297.ok && !_t297.is_none) {
		string err = _t297.v_error;
		int errcode = _t297.ecode;
		// assert
		if (false){
			g_test_oks++;
			VAssertMetaInfo v_assert_meta_info__t298;
			memset(&v_assert_meta_info__t298, 0, sizeof(VAssertMetaInfo));
			v_assert_meta_info__t298.fpath = tos_lit("net_stream_test.v");
			v_assert_meta_info__t298.line_nr = 37;
			v_assert_meta_info__t298.fn_name = tos_lit("main.test_arrays");
			v_assert_meta_info__t298.src = tos_lit("false");
			main__cb_assertion_ok(&v_assert_meta_info__t298);
		} else {
			g_test_fails++;
			VAssertMetaInfo v_assert_meta_info__t299;
			memset(&v_assert_meta_info__t299, 0, sizeof(VAssertMetaInfo));
			v_assert_meta_info__t299.fpath = tos_lit("net_stream_test.v");
			v_assert_meta_info__t299.line_nr = 37;
			v_assert_meta_info__t299.fn_name = tos_lit("main.test_arrays");
			v_assert_meta_info__t299.src = tos_lit("false");
			main__cb_assertion_failed(&v_assert_meta_info__t299);
			longjmp(g_jump_buffer, 1);
			// TODO
			// Maybe print all vars in a test function if it fails?
		}
	};
	array_u32 c_d = net__stream__NetInputStream_get_u32s(nis, 5);
	// assert
	if (u32_arr_eq(d, c_d)){
		g_test_oks++;
		VAssertMetaInfo v_assert_meta_info__t300;
		memset(&v_assert_meta_info__t300, 0, sizeof(VAssertMetaInfo));
		v_assert_meta_info__t300.fpath = tos_lit("net_stream_test.v");
		v_assert_meta_info__t300.line_nr = 39;
		v_assert_meta_info__t300.fn_name = tos_lit("main.test_arrays");
		v_assert_meta_info__t300.src = tos_lit("d == c_d");
		v_assert_meta_info__t300.op = tos_lit("==");
		v_assert_meta_info__t300.llabel = tos_lit("d");
		v_assert_meta_info__t300.rlabel = tos_lit("c_d");
		v_assert_meta_info__t300.lvalue = array_u32_str(  d) /* typeof: v.ast.Ident type: 109 */ ;
		v_assert_meta_info__t300.rvalue = array_u32_str(  c_d) /* typeof: v.ast.Ident type: 109 */ ;
		main__cb_assertion_ok(&v_assert_meta_info__t300);
	} else {
		g_test_fails++;
		VAssertMetaInfo v_assert_meta_info__t301;
		memset(&v_assert_meta_info__t301, 0, sizeof(VAssertMetaInfo));
		v_assert_meta_info__t301.fpath = tos_lit("net_stream_test.v");
		v_assert_meta_info__t301.line_nr = 39;
		v_assert_meta_info__t301.fn_name = tos_lit("main.test_arrays");
		v_assert_meta_info__t301.src = tos_lit("d == c_d");
		v_assert_meta_info__t301.op = tos_lit("==");
		v_assert_meta_info__t301.llabel = tos_lit("d");
		v_assert_meta_info__t301.rlabel = tos_lit("c_d");
		v_assert_meta_info__t301.lvalue = array_u32_str(  d) /* typeof: v.ast.Ident type: 109 */ ;
		v_assert_meta_info__t301.rvalue = array_u32_str(  c_d) /* typeof: v.ast.Ident type: 109 */ ;
		main__cb_assertion_failed(&v_assert_meta_info__t301);
		longjmp(g_jump_buffer, 1);
		// TODO
		// Maybe print all vars in a test function if it fails?
	}
	array_u64 e = new_array_from_c_array(4, 4, sizeof(u64), _MOV((u64[4]){((u64)(32542)), 23213, 23244353, 324534534}));
	Option_void _t302 = net__stream__NetOutputStream_write_u64s(nos, e);
	if (!_t302.ok && !_t302.is_none) {
		string err = _t302.v_error;
		int errcode = _t302.ecode;
		// assert
		if (false){
			g_test_oks++;
			VAssertMetaInfo v_assert_meta_info__t303;
			memset(&v_assert_meta_info__t303, 0, sizeof(VAssertMetaInfo));
			v_assert_meta_info__t303.fpath = tos_lit("net_stream_test.v");
			v_assert_meta_info__t303.line_nr = 43;
			v_assert_meta_info__t303.fn_name = tos_lit("main.test_arrays");
			v_assert_meta_info__t303.src = tos_lit("false");
			main__cb_assertion_ok(&v_assert_meta_info__t303);
		} else {
			g_test_fails++;
			VAssertMetaInfo v_assert_meta_info__t304;
			memset(&v_assert_meta_info__t304, 0, sizeof(VAssertMetaInfo));
			v_assert_meta_info__t304.fpath = tos_lit("net_stream_test.v");
			v_assert_meta_info__t304.line_nr = 43;
			v_assert_meta_info__t304.fn_name = tos_lit("main.test_arrays");
			v_assert_meta_info__t304.src = tos_lit("false");
			main__cb_assertion_failed(&v_assert_meta_info__t304);
			longjmp(g_jump_buffer, 1);
			// TODO
			// Maybe print all vars in a test function if it fails?
		}
	};
	array_u64 c_e = net__stream__NetInputStream_get_u64s(nis, 4);
	// assert
	if (u64_arr_eq(e, c_e)){
		g_test_oks++;
		VAssertMetaInfo v_assert_meta_info__t305;
		memset(&v_assert_meta_info__t305, 0, sizeof(VAssertMetaInfo));
		v_assert_meta_info__t305.fpath = tos_lit("net_stream_test.v");
		v_assert_meta_info__t305.line_nr = 45;
		v_assert_meta_info__t305.fn_name = tos_lit("main.test_arrays");
		v_assert_meta_info__t305.src = tos_lit("e == c_e");
		v_assert_meta_info__t305.op = tos_lit("==");
		v_assert_meta_info__t305.llabel = tos_lit("e");
		v_assert_meta_info__t305.rlabel = tos_lit("c_e");
		v_assert_meta_info__t305.lvalue = array_u64_str(  e) /* typeof: v.ast.Ident type: 43 */ ;
		v_assert_meta_info__t305.rvalue = array_u64_str(  c_e) /* typeof: v.ast.Ident type: 43 */ ;
		main__cb_assertion_ok(&v_assert_meta_info__t305);
	} else {
		g_test_fails++;
		VAssertMetaInfo v_assert_meta_info__t306;
		memset(&v_assert_meta_info__t306, 0, sizeof(VAssertMetaInfo));
		v_assert_meta_info__t306.fpath = tos_lit("net_stream_test.v");
		v_assert_meta_info__t306.line_nr = 45;
		v_assert_meta_info__t306.fn_name = tos_lit("main.test_arrays");
		v_assert_meta_info__t306.src = tos_lit("e == c_e");
		v_assert_meta_info__t306.op = tos_lit("==");
		v_assert_meta_info__t306.llabel = tos_lit("e");
		v_assert_meta_info__t306.rlabel = tos_lit("c_e");
		v_assert_meta_info__t306.lvalue = array_u64_str(  e) /* typeof: v.ast.Ident type: 43 */ ;
		v_assert_meta_info__t306.rvalue = array_u64_str(  c_e) /* typeof: v.ast.Ident type: 43 */ ;
		main__cb_assertion_failed(&v_assert_meta_info__t306);
		longjmp(g_jump_buffer, 1);
		// TODO
		// Maybe print all vars in a test function if it fails?
	}
...
void _vinit() {
	...
	// Initializations for module net.stream :
