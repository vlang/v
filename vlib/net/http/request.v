...
pub mut:
	...
	validate                 bool = true // set to false to allow requests through even when their certificates are found to be invalid
	verify                   string // path to a rootca.pem file; empty uses net.mbedtls.system_or_default_ca_bundle_pem instead (the Linux system CA bundle if present, else the vendored default)
	cert                     string
	cert_key                 string
