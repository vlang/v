...
pub fn send_mail(mailserver string, port int, username string, password string, subject string, 
      from string , to string, body string, type_body string, debug bool )?{
...
fn send_text_body(socket net.Socket,subject string,from string ,to string,body string, debug bool)?{
...
fn send_html_body(socket net.Socket,subject string,from string ,to string ,body string, debug bool)? {
...
fn auth(client net.Socket,username string, password string, debug bool)? bool{
