...
const target_header_list :=  [csv.HeaderItem{
    label: 'a'
    column: 0
    htype: .int
}, csv.HeaderItem{
...
fn test_csv_string() {
	...
	// parse the temp file
	csvr = csv.csv_reader(file_path:file_path_str, mem_buf_size:64, end_line_len:csv.endline_crlf_len)!
	perform_test(mut csvr)!
	csvr.dispose_csv_reader()
	...
	// test crlf endline
	csvr = csv.csv_reader(scr_buf:txt3.str, scr_buf_len:txt3.len, end_line_len:csv.endline_crlf_len)!
