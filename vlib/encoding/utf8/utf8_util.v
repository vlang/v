...
fn up_low(s string, uppper_flag bool) string {
	...
	for {
		...
		if ch_len == 1 {
			...
			ch_index := find_char(u16(res), uppper_flag)
...
fn find_char( inCode u16, uppper_flag bool ) int {
	...
	if uppper_flag==true {
		...
		//C.printf("\nWe have a range index:[%d] ==> %d",low_to_up_index[ start_index<<1 ] ,low_to_up_index[ (start_index << 1) +1 ])

		mut index := low_to_up_index[ (start_index << 1) + 1 ]			// first index of our utf8 char range
		mut last_index := low_to_up_index[ ((start_index+1) << 1) + 1 ]	// last+1 index of our utf8 char range

		for {
			x:=unicode_con_table_low_to_up[index]	// get the utf8 char
			if x==inCode {
				//C.printf(" Found!\n")
				return int(index)
			}
			...
			//if  index>(unicode_con_table_low_to_up.len-1) {
				//C.printf(" Break in %d < %d!\n",index,last_index)
				break
			}
		}

		//C.printf("not found! %x",inCode)
	}else{
		//C.printf("\nLooking for: 0x%04x",inCode)
		...
		for {
			x:=unicode_con_table_up_to_low[index]	// get the utf8 char
			if x==inCode {
				//C.printf(" Found!\n")
				return int(index)
			}
			...
			// exit, we are out of our range
			if index>last_index || index>unicode_con_table_up_to_low.len {
...
unicode_con_table_low_to_up=[
u16(0x0061), 0x0041, //LATIN CAPITAL LETTER A	LATIN SMALL LETTER A
0x0062, 0x0042, //LATIN CAPITAL LETTER B	LATIN SMALL LETTER B
0x0063, 0x0043, //LATIN CAPITAL LETTER C	LATIN SMALL LETTER C
0x0064, 0x0044, //LATIN CAPITAL LETTER D	LATIN SMALL LETTER D
0x0065, 0x0045, //LATIN CAPITAL LETTER E	LATIN SMALL LETTER E
0x0066, 0x0046, //LATIN CAPITAL LETTER F	LATIN SMALL LETTER F
0x0067, 0x0047, //LATIN CAPITAL LETTER G	LATIN SMALL LETTER G
0x0068, 0x0048, //LATIN CAPITAL LETTER H	LATIN SMALL LETTER H
0x0069, 0x0049, //LATIN CAPITAL LETTER I	LATIN SMALL LETTER I
0x006A, 0x004A, //LATIN CAPITAL LETTER J	LATIN SMALL LETTER J
0x006B, 0x004B, //LATIN CAPITAL LETTER K	LATIN SMALL LETTER K
0x006C, 0x004C, //LATIN CAPITAL LETTER L	LATIN SMALL LETTER L
0x006D, 0x004D, //LATIN CAPITAL LETTER M	LATIN SMALL LETTER M
0x006E, 0x004E, //LATIN CAPITAL LETTER N	LATIN SMALL LETTER N
0x006F, 0x004F, //LATIN CAPITAL LETTER O	LATIN SMALL LETTER O
0x0070, 0x0050, //LATIN CAPITAL LETTER P	LATIN SMALL LETTER P
0x0071, 0x0051, //LATIN CAPITAL LETTER Q	LATIN SMALL LETTER Q
0x0072, 0x0052, //LATIN CAPITAL LETTER R	LATIN SMALL LETTER R
0x0073, 0x0053, //LATIN CAPITAL LETTER S	LATIN SMALL LETTER S
0x0074, 0x0054, //LATIN CAPITAL LETTER T	LATIN SMALL LETTER T
0x0075, 0x0055, //LATIN CAPITAL LETTER U	LATIN SMALL LETTER U
0x0076, 0x0056, //LATIN CAPITAL LETTER V	LATIN SMALL LETTER V
0x0077, 0x0057, //LATIN CAPITAL LETTER W	LATIN SMALL LETTER W
0x0078, 0x0058, //LATIN CAPITAL LETTER X	LATIN SMALL LETTER X
0x0079, 0x0059, //LATIN CAPITAL LETTER Y	LATIN SMALL LETTER Y
0x007A, 0x005A, //LATIN CAPITAL LETTER Z	LATIN SMALL LETTER Z
0x00E0, 0x00C0, //LATIN CAPITAL LETTER A GRAVE	LATIN SMALL LETTER A GRAVE
0x00E1, 0x00C1, //LATIN CAPITAL LETTER A ACUTE	LATIN SMALL LETTER A GRAVE
0x00E2, 0x00C2, //LATIN CAPITAL LETTER A CIRCUMFLEX	LATIN SMALL LETTER A GRAVE
0x00E3, 0x00C3, //LATIN CAPITAL LETTER A TILDE	LATIN SMALL LETTER A GRAVE
0x00E4, 0x00C4, //LATIN CAPITAL LETTER A DIAERESIS	LATIN SMALL LETTER A GRAVE
0x00E5, 0x00C5, //LATIN CAPITAL LETTER A RING	LATIN SMALL LETTER A GRAVE
0x00E6, 0x00C6, //LATIN CAPITAL LETTER A E	LATIN SMALL LETTER A GRAVE
0x00E7, 0x00C7, //LATIN CAPITAL LETTER C CEDILLA	LATIN SMALL LETTER A GRAVE
0x00E8, 0x00C8, //LATIN CAPITAL LETTER E GRAVE	LATIN SMALL LETTER A GRAVE
0x00E9, 0x00C9, //LATIN CAPITAL LETTER E ACUTE	LATIN SMALL LETTER A GRAVE
0x00EA, 0x00CA, //LATIN CAPITAL LETTER E CIRCUMFLEX	LATIN SMALL LETTER E CIRCUMFLEX
0x00EB, 0x00CB, //LATIN CAPITAL LETTER E DIAERESIS	LATIN SMALL LETTER E DIAERESIS
0x00EC, 0x00CC, //LATIN CAPITAL LETTER I GRAVE	LATIN SMALL LETTER I GRAVE
0x00ED, 0x00CD, //LATIN CAPITAL LETTER I ACUTE	LATIN SMALL LETTER I ACUTE
0x00EE, 0x00CE, //LATIN CAPITAL LETTER I CIRCUMFLEX	LATIN SMALL LETTER I CIRCUMFLEX
0x00EF, 0x00CF, //LATIN CAPITAL LETTER I DIAERESIS	LATIN SMALL LETTER I DIAERESIS
0x00F0, 0x00D0, //LATIN CAPITAL LETTER ETH	LATIN SMALL LETTER ETH
0x00F1, 0x00D1, //LATIN CAPITAL LETTER N TILDE	LATIN SMALL LETTER N TILDE
0x00F2, 0x00D2, //LATIN CAPITAL LETTER O GRAVE	LATIN SMALL LETTER O GRAVE
0x00F3, 0x00D3, //LATIN CAPITAL LETTER O ACUTE	LATIN SMALL LETTER O ACUTE
0x00F4, 0x00D4, //LATIN CAPITAL LETTER O CIRCUMFLEX	LATIN SMALL LETTER O CIRCUMFLEX
0x00F5, 0x00D5, //LATIN CAPITAL LETTER O TILDE	LATIN SMALL LETTER O TILDE
0x00F6, 0x00D6, //LATIN CAPITAL LETTER O DIAERESIS	LATIN SMALL LETTER O DIAERESIS
0x00F8, 0x00D8, //LATIN CAPITAL LETTER O SLASH	LATIN SMALL LETTER O SLASH
0x00F9, 0x00D9, //LATIN CAPITAL LETTER U GRAVE	LATIN SMALL LETTER U GRAVE
0x00FA, 0x00DA, //LATIN CAPITAL LETTER U ACUTE	LATIN SMALL LETTER U ACUTE
0x00FB, 0x00DB, //LATIN CAPITAL LETTER U CIRCUMFLEX	LATIN SMALL LETTER U CIRCUMFLEX
0x00FC, 0x00DC, //LATIN CAPITAL LETTER U DIAERESIS	LATIN SMALL LETTER U DIAERESIS
0x00FD, 0x00DD, //LATIN CAPITAL LETTER Y ACUTE	LATIN SMALL LETTER Y ACUTE
0x00FE, 0x00DE, //LATIN CAPITAL LETTER THORN	LATIN SMALL LETTER THORN
0x0101, 0x0100, //LATIN CAPITAL LETTER A WITH MACRON	LATIN SMALL LETTER A WITH MACRON
0x0103, 0x0102, //LATIN CAPITAL LETTER A WITH BREVE	LATIN SMALL LETTER A WITH BREVE
0x0105, 0x0104, //LATIN CAPITAL LETTER A WITH OGONEK	LATIN SMALL LETTER A WITH OGONEK
0x0107, 0x0106, //LATIN CAPITAL LETTER C WITH ACUTE	LATIN SMALL LETTER C WITH ACUTE
0x0109, 0x0108, //LATIN CAPITAL LETTER C WITH CIRCUMFLEX	LATIN SMALL LETTER C WITH CIRCUMFLEX
0x010B, 0x010A, //LATIN CAPITAL LETTER C WITH DOT ABOVE	LATIN SMALL LETTER C WITH DOT ABOVE
0x010D, 0x010C, //LATIN CAPITAL LETTER C WITH CARON	LATIN SMALL LETTER C WITH CARON
0x010F, 0x010E, //LATIN CAPITAL LETTER D WITH CARON	LATIN SMALL LETTER D WITH CARON
0x0111, 0x0110, //LATIN CAPITAL LETTER D WITH STROKE	LATIN SMALL LETTER D WITH STROKE
0x0113, 0x0112, //LATIN CAPITAL LETTER E WITH MACRON	LATIN SMALL LETTER E WITH MACRON
0x0115, 0x0114, //LATIN CAPITAL LETTER E WITH BREVE	LATIN SMALL LETTER E WITH BREVE
0x0117, 0x0116, //LATIN CAPITAL LETTER E WITH DOT ABOVE	LATIN SMALL LETTER E WITH DOT ABOVE
0x0119, 0x0118, //LATIN CAPITAL LETTER E WITH OGONEK	LATIN SMALL LETTER E WITH OGONEK
0x011B, 0x011A, //LATIN CAPITAL LETTER E WITH CARON	LATIN SMALL LETTER E WITH CARON
0x011D, 0x011C, //LATIN CAPITAL LETTER G WITH CIRCUMFLEX	LATIN SMALL LETTER G WITH CIRCUMFLEX
0x011F, 0x011E, //LATIN CAPITAL LETTER G WITH BREVE	LATIN SMALL LETTER G WITH BREVE
0x0121, 0x0120, //LATIN CAPITAL LETTER G WITH DOT ABOVE	LATIN SMALL LETTER G WITH DOT ABOVE
0x0123, 0x0122, //LATIN CAPITAL LETTER G WITH CEDILLA	LATIN SMALL LETTER G WITH CEDILLA
0x0125, 0x0124, //LATIN CAPITAL LETTER H WITH CIRCUMFLEX	LATIN SMALL LETTER H WITH CIRCUMFLEX
0x0127, 0x0126, //LATIN CAPITAL LETTER H WITH STROKE	LATIN SMALL LETTER H WITH STROKE
0x0129, 0x0128, //LATIN CAPITAL LETTER I WITH TILDE	LATIN SMALL LETTER I WITH TILDE
0x012B, 0x012A, //LATIN CAPITAL LETTER I WITH MACRON	LATIN SMALL LETTER I WITH MACRON
0x012D, 0x012C, //LATIN CAPITAL LETTER I WITH BREVE	LATIN SMALL LETTER I WITH BREVE
0x012F, 0x012E, //LATIN CAPITAL LETTER I WITH OGONEK	LATIN SMALL LETTER I WITH OGONEK
0x0069, 0x0130, //LATIN CAPITAL LETTER I WITH DOT ABOVE	LATIN SMALL LETTER I
0x0133, 0x0132, //LATIN CAPITAL LIGATURE IJ	LATIN SMALL LIGATURE IJ
0x0135, 0x0134, //LATIN CAPITAL LETTER J WITH CIRCUMFLEX	LATIN SMALL LETTER J WITH CIRCUMFLEX
0x0137, 0x0136, //LATIN CAPITAL LETTER K WITH CEDILLA	LATIN SMALL LETTER K WITH CEDILLA
0x013A, 0x0139, //LATIN CAPITAL LETTER L WITH ACUTE	LATIN SMALL LETTER L WITH ACUTE
0x013C, 0x013B, //LATIN CAPITAL LETTER L WITH CEDILLA	LATIN SMALL LETTER L WITH CEDILLA
0x013E, 0x013D, //LATIN CAPITAL LETTER L WITH CARON	LATIN SMALL LETTER L WITH CARON
0x0140, 0x013F, //LATIN CAPITAL LETTER L WITH MIDDLE DOT	LATIN SMALL LETTER L WITH MIDDLE DOT
0x0142, 0x0141, //LATIN CAPITAL LETTER L WITH STROKE	LATIN SMALL LETTER L WITH STROKE
0x0144, 0x0143, //LATIN CAPITAL LETTER N WITH ACUTE	LATIN SMALL LETTER N WITH ACUTE
0x0146, 0x0145, //LATIN CAPITAL LETTER N WITH CEDILLA	LATIN SMALL LETTER N WITH CEDILLA
0x0148, 0x0147, //LATIN CAPITAL LETTER N WITH CARON	LATIN SMALL LETTER N WITH CARON
0x014B, 0x014A, //LATIN CAPITAL LETTER ENG (SAMI)	LATIN SMALL LETTER ENG (SAMI)
0x014D, 0x014C, //LATIN CAPITAL LETTER O WITH MACRON	LATIN SMALL LETTER O WITH MACRON
0x014F, 0x014E, //LATIN CAPITAL LETTER O WITH BREVE	LATIN SMALL LETTER O WITH BREVE
0x0151, 0x0150, //LATIN CAPITAL LETTER O WITH DOUBLE ACUTE	LATIN SMALL LETTER O WITH DOUBLE ACUTE
0x0153, 0x0152, //LATIN CAPITAL LIGATURE OE	LATIN SMALL LIGATURE OE
0x0155, 0x0154, //LATIN CAPITAL LETTER R WITH ACUTE	LATIN SMALL LETTER R WITH ACUTE
0x0157, 0x0156, //LATIN CAPITAL LETTER R WITH CEDILLA	LATIN SMALL LETTER R WITH CEDILLA
0x0159, 0x0158, //LATIN CAPITAL LETTER R WITH CARON	LATIN SMALL LETTER R WITH CARON
0x015B, 0x015A, //LATIN CAPITAL LETTER S WITH ACUTE	LATIN SMALL LETTER S WITH ACUTE
0x015D, 0x015C, //LATIN CAPITAL LETTER S WITH CIRCUMFLEX	LATIN SMALL LETTER S WITH CIRCUMFLEX
0x015F, 0x015E, //LATIN CAPITAL LETTER S WITH CEDILLA	LATIN SMALL LETTER S WITH CEDILLA
0x0161, 0x0160, //LATIN CAPITAL LETTER S WITH CARON	LATIN SMALL LETTER S WITH CARON
0x0163, 0x0162, //LATIN CAPITAL LETTER T WITH CEDILLA	LATIN SMALL LETTER T WITH CEDILLA
0x0165, 0x0164, //LATIN CAPITAL LETTER T WITH CARON	LATIN SMALL LETTER T WITH CARON
0x0167, 0x0166, //LATIN CAPITAL LETTER T WITH STROKE	LATIN SMALL LETTER T WITH STROKE
0x0169, 0x0168, //LATIN CAPITAL LETTER U WITH TILDE	LATIN SMALL LETTER U WITH TILDE
0x016B, 0x016A, //LATIN CAPITAL LETTER U WITH MACRON	LATIN SMALL LETTER U WITH MACRON
0x016D, 0x016C, //LATIN CAPITAL LETTER U WITH BREVE	LATIN SMALL LETTER U WITH BREVE
0x016F, 0x016E, //LATIN CAPITAL LETTER U WITH RING ABOVE	LATIN SMALL LETTER U WITH RING ABOVE
0x0171, 0x0170, //LATIN CAPITAL LETTER U WITH DOUBLE ACUTE	LATIN SMALL LETTER U WITH DOUBLE ACUTE
0x0173, 0x0172, //LATIN CAPITAL LETTER U WITH OGONEK	LATIN SMALL LETTER U WITH OGONEK
0x0175, 0x0174, //LATIN CAPITAL LETTER W WITH CIRCUMFLEX	LATIN SMALL LETTER W WITH CIRCUMFLEX
0x0177, 0x0176, //LATIN CAPITAL LETTER Y WITH CIRCUMFLEX	LATIN SMALL LETTER Y WITH CIRCUMFLEX
0x00FF, 0x0178, //LATIN CAPITAL LETTER Y WITH DIAERESIS	LATIN SMALL LETTER Y DIAERESIS
0x017A, 0x0179, //LATIN CAPITAL LETTER Z WITH ACUTE	LATIN SMALL LETTER Z WITH ACUTE
0x017C, 0x017B, //LATIN CAPITAL LETTER Z WITH DOT ABOVE	LATIN SMALL LETTER Z WITH DOT ABOVE
0x017E, 0x017D, //LATIN CAPITAL LETTER Z WITH CARON	LATIN SMALL LETTER Z WITH CARON
0x0253, 0x0181, //LATIN CAPITAL LETTER B WITH HOOK	LATIN SMALL LETTER B WITH HOOK
0x0183, 0x0182, //LATIN CAPITAL LETTER B WITH TOPBAR	LATIN SMALL LETTER B WITH TOPBAR
0x0185, 0x0184, //LATIN CAPITAL LETTER TONE SIX	LATIN SMALL LETTER TONE SIX
0x0254, 0x0186, //LATIN CAPITAL LETTER OPEN O	LATIN SMALL LETTER OPEN O
0x0188, 0x0187, //LATIN CAPITAL LETTER C WITH HOOK	LATIN SMALL LETTER C WITH HOOK
0x0257, 0x018A, //LATIN CAPITAL LETTER D WITH HOOK	LATIN SMALL LETTER D WITH HOOK
0x018C, 0x018B, //LATIN CAPITAL LETTER D WITH TOPBAR	LATIN SMALL LETTER D WITH TOPBAR
0x0258, 0x018E, //LATIN CAPITAL LETTER REVERSED E	LATIN SMALL LETTER REVERSED E
0x0259, 0x018F, //LATIN CAPITAL LETTER SCHWA	LATIN SMALL LETTER SCHWA
0x025B, 0x0190, //LATIN CAPITAL LETTER OPEN E	LATIN SMALL LETTER OPEN E
0x0192, 0x0191, //LATIN CAPITAL LETTER F WITH HOOK	LATIN SMALL LETTER F WITH HOOK
0x0260, 0x0193, //LATIN CAPITAL LETTER G WITH HOOK	LATIN SMALL LETTER G WITH HOOK
0x0263, 0x0194, //LATIN CAPITAL LETTER GAMMA	LATIN SMALL LETTER GAMMA
0x0269, 0x0196, //LATIN CAPITAL LETTER IOTA	LATIN SMALL LETTER IOTA
0x0268, 0x0197, //LATIN CAPITAL LETTER I WITH STROKE	LATIN SMALL LETTER I WITH STROKE
0x0199, 0x0198, //LATIN CAPITAL LETTER K WITH HOOK	LATIN SMALL LETTER K WITH HOOK
0x026f, 0x019C, //LATIN CAPITAL LETTER TURNED M	LATIN SMALL LETTER TURNED M
0x0272, 0x019D, //LATIN CAPITAL LETTER N WITH LEFT HOOK	LATIN SMALL LETTER N WITH LEFT HOOK
0x0275, 0x019F, //LATIN CAPITAL LETTER O WITH MIDDLE TILDE	LATIN SMALL LETTER BARRED O
0x01A1, 0x01A0, //LATIN CAPITAL LETTER O WITH HORN	LATIN SMALL LETTER O WITH HORN
0x01A3, 0x01A2, //LATIN CAPITAL LETTER OI	LATIN SMALL LETTER OI
0x01A5, 0x01A4, //LATIN CAPITAL LETTER P WITH HOOK	LATIN SMALL LETTER P WITH HOOK
0x01A8, 0x01A7, //LATIN CAPITAL LETTER TONE TWO	LATIN SMALL LETTER TONE TWO
0x0283, 0x01A9, //LATIN CAPITAL LETTER ESH	LATIN SMALL LETTER ESH
0x01AD, 0x01AC, //LATIN CAPITAL LETTER T WITH HOOK	LATIN SMALL LETTER T WITH HOOK
0x0288, 0x01AE, //LATIN CAPITAL LETTER T WITH RETROFLEX HOOK	LATIN SMALL LETTER T WITH RETROFLEX HOOK
0x01B0, 0x01AF, //LATIN CAPITAL LETTER U WITH HORN	LATIN SMALL LETTER U WITH HORN
0x028A, 0x01B1, //LATIN CAPITAL LETTER UPSILON	LATIN SMALL LETTER UPSILON
0x028B, 0x01B2, //LATIN CAPITAL LETTER V WITH HOOK	LATIN SMALL LETTER V WITH HOOK
0x01B4, 0x01B3, //LATIN CAPITAL LETTER Y WITH HOOK	LATIN SMALL LETTER Y WITH HOOK
0x01B6, 0x01B5, //LATIN CAPITAL LETTER Z WITH STROKE	LATIN SMALL LETTER Z WITH STROKE
0x0292, 0x01B7, //LATIN CAPITAL LETTER EZH	LATIN SMALL LETTER EZH
0x01B9, 0x01B8, //LATIN CAPITAL LETTER EZH REVERSED	LATIN SMALL LETTER EZH REVERSED
0x01BD, 0x01BC, //LATIN CAPITAL LETTER TONE FIVE	LATIN SMALL LETTER TONE FIVE
0x01C6, 0x01C4, //LATIN CAPITAL LETTER DZ WITH CARON	LATIN SMALL LETTER DZ WITH CARON
0x01C6, 0x01C5, //LATIN CAPITAL LETTER D WITH SMALL LETTER Z WITH CARON	LATIN SMALL LETTER DZ WITH CARON
0x01C9, 0x01C7, //LATIN CAPITAL LETTER LJ	LATIN SMALL LETTER LJ
0x01C9, 0x01C8, //LATIN CAPITAL LETTER L WITH SMALL LETTER J	LATIN SMALL LETTER LJ
0x01CC, 0x01CA, //LATIN CAPITAL LETTER NJ	LATIN SMALL LETTER NJ
0x01CC, 0x01CB, //LATIN CAPITAL LETTER N WITH SMALL LETTER J	LATIN SMALL LETTER NJ
0x01CE, 0x01CD, //LATIN CAPITAL LETTER A WITH CARON	LATIN SMALL LETTER A WITH CARON
0x01D0, 0x01CF, //LATIN CAPITAL LETTER I WITH CARON	LATIN SMALL LETTER I WITH CARON
0x01D2, 0x01D1, //LATIN CAPITAL LETTER O WITH CARON	LATIN SMALL LETTER O WITH CARON
0x01D4, 0x01D3, //LATIN CAPITAL LETTER U WITH CARON	LATIN SMALL LETTER U WITH CARON
0x01D6, 0x01D5, //LATIN CAPITAL LETTER U WITH DIAERESIS AND MACRON	LATIN SMALL LETTER U WITH DIAERESIS AND MACRON
0x01D8, 0x01D7, //LATIN CAPITAL LETTER U WITH DIAERESIS AND ACUTE	LATIN SMALL LETTER U WITH DIAERESIS AND ACUTE
0x01DA, 0x01D9, //LATIN CAPITAL LETTER U WITH DIAERESIS AND CARON	LATIN SMALL LETTER U WITH DIAERESIS AND CARON
0x01DC, 0x01DB, //LATIN CAPITAL LETTER U WITH DIAERESIS AND GRAVE	LATIN SMALL LETTER U WITH DIAERESIS AND GRAVE
0x01DF, 0x01DE, //LATIN CAPITAL LETTER A WITH DIAERESIS AND MACRON	LATIN SMALL LETTER A WITH DIAERESIS AND MACRON
0x01E1, 0x01E0, //LATIN CAPITAL LETTER A WITH DOT ABOVE AND MACRON	LATIN SMALL LETTER A WITH DOT ABOVE AND MACRON
0x01E3, 0x01E2, //LATIN CAPITAL LIGATURE AE WITH MACRON	LATIN SMALL LIGATURE AE WITH MACRON
0x01E5, 0x01E4, //LATIN CAPITAL LETTER G WITH STROKE	LATIN SMALL LETTER G WITH STROKE
0x01E7, 0x01E6, //LATIN CAPITAL LETTER G WITH CARON	LATIN SMALL LETTER G WITH CARON
0x01E9, 0x01E8, //LATIN CAPITAL LETTER K WITH CARON	LATIN SMALL LETTER K WITH CARON
0x01EB, 0x01EA, //LATIN CAPITAL LETTER O WITH OGONEK	LATIN SMALL LETTER O WITH OGONEK
0x01ED, 0x01EC, //LATIN CAPITAL LETTER O WITH OGONEK AND MACRON	LATIN SMALL LETTER O WITH OGONEK AND MACRON
0x01EF, 0x01EE, //LATIN CAPITAL LETTER EZH WITH CARON	LATIN SMALL LETTER EZH WITH CARON
0x01F3, 0x01F1, //LATIN CAPITAL LETTER DZ	LATIN SMALL LETTER DZ
0x01F5, 0x01F4, //LATIN CAPITAL LETTER G WITH ACUTE	LATIN SMALL LETTER G WITH ACUTE
0x01FB, 0x01FA, //LATIN CAPITAL LETTER A WITH RING ABOVE AND ACUTE	LATIN SMALL LETTER A WITH RING ABOVE AND ACUTE
0x01FD, 0x01FC, //LATIN CAPITAL LIGATURE AE WITH ACUTE	LATIN SMALL LIGATURE AE WITH ACUTE
0x01FF, 0x01FE, //LATIN CAPITAL LETTER O WITH STROKE AND ACUTE	LATIN SMALL LETTER O WITH STROKE AND ACUTE
0x0201, 0x0200, //LATIN CAPITAL LETTER A WITH DOUBLE GRAVE	LATIN SMALL LETTER A WITH DOUBLE GRAVE
0x0203, 0x0202, //LATIN CAPITAL LETTER A WITH INVERTED BREVE	LATIN SMALL LETTER A WITH INVERTED BREVE
0x0205, 0x0204, //LATIN CAPITAL LETTER E WITH DOUBLE GRAVE	LATIN SMALL LETTER E WITH DOUBLE GRAVE
0x0207, 0x0206, //LATIN CAPITAL LETTER E WITH INVERTED BREVE	LATIN SMALL LETTER E WITH INVERTED BREVE
0x0209, 0x0208, //LATIN CAPITAL LETTER I WITH DOUBLE GRAVE	LATIN SMALL LETTER I WITH DOUBLE GRAVE
0x020B, 0x020A, //LATIN CAPITAL LETTER I WITH INVERTED BREVE	LATIN SMALL LETTER I WITH INVERTED BREVE
0x020D, 0x020C, //LATIN CAPITAL LETTER O WITH DOUBLE GRAVE	LATIN SMALL LETTER O WITH DOUBLE GRAVE
0x020F, 0x020E, //LATIN CAPITAL LETTER O WITH INVERTED BREVE	LATIN SMALL LETTER O WITH INVERTED BREVE
0x0211, 0x0210, //LATIN CAPITAL LETTER R WITH DOUBLE GRAVE	LATIN SMALL LETTER R WITH DOUBLE GRAVE
0x0213, 0x0212, //LATIN CAPITAL LETTER R WITH INVERTED BREVE	LATIN SMALL LETTER R WITH INVERTED BREVE
0x0215, 0x0214, //LATIN CAPITAL LETTER U WITH DOUBLE GRAVE	LATIN SMALL LETTER U WITH DOUBLE GRAVE
0x0217, 0x0216, //LATIN CAPITAL LETTER U WITH INVERTED BREVE	LATIN SMALL LETTER U WITH INVERTED BREVE
0x03AC, 0x0386, //GREEK CAPITAL LETTER ALPHA WITH TONOS	GREEK SMALL LETTER ALPHA WITH TONOS
0x03AD, 0x0388, //GREEK CAPITAL LETTER EPSILON WITH TONOS	GREEK SMALL LETTER EPSILON WITH TONOS
0x03AE, 0x0389, //GREEK CAPITAL LETTER ETA WITH TONOS	GREEK SMALL LETTER ETA WITH TONOS
0x03AF, 0x038A, //GREEK CAPITAL LETTER IOTA WITH TONOS	GREEK SMALL LETTER IOTA WITH TONOS
0x03CC, 0x038C, //GREEK CAPITAL LETTER OMICRON WITH TONOS	GREEK SMALL LETTER OMICRON WITH TONOS
0x03CD, 0x038E, //GREEK CAPITAL LETTER UPSILON WITH TONOS	GREEK SMALL LETTER UPSILON WITH TONOS
0x03CE, 0x038F, //GREEK CAPITAL LETTER OMEGA WITH TONOS	GREEK SMALL LETTER OMEGA WITH TONOS
0x03B1, 0x0391, //GREEK CAPITAL LETTER ALPHA	GREEK SMALL LETTER ALPHA
0x03B2, 0x0392, //GREEK CAPITAL LETTER BETA	GREEK SMALL LETTER BETA
0x03B3, 0x0393, //GREEK CAPITAL LETTER GAMMA	GREEK SMALL LETTER GAMMA
0x03B4, 0x0394, //GREEK CAPITAL LETTER DELTA	GREEK SMALL LETTER DELTA
0x03B5, 0x0395, //GREEK CAPITAL LETTER EPSILON	GREEK SMALL LETTER EPSILON
0x03B6, 0x0396, //GREEK CAPITAL LETTER ZETA	GREEK SMALL LETTER ZETA
0x03B7, 0x0397, //GREEK CAPITAL LETTER ETA	GREEK SMALL LETTER ETA
0x03B8, 0x0398, //GREEK CAPITAL LETTER THETA	GREEK SMALL LETTER THETA
0x03B9, 0x0399, //GREEK CAPITAL LETTER IOTA	GREEK SMALL LETTER IOTA
0x03BA, 0x039A, //GREEK CAPITAL LETTER KAPPA	GREEK SMALL LETTER KAPPA
0x03BB, 0x039B, //GREEK CAPITAL LETTER LAMDA	GREEK SMALL LETTER LAMDA
0x03BC, 0x039C, //GREEK CAPITAL LETTER MU	GREEK SMALL LETTER MU
0x03BD, 0x039D, //GREEK CAPITAL LETTER NU	GREEK SMALL LETTER NU
0x03BE, 0x039E, //GREEK CAPITAL LETTER XI	GREEK SMALL LETTER XI
0x03BF, 0x039F, //GREEK CAPITAL LETTER OMICRON	GREEK SMALL LETTER OMICRON
0x03C0, 0x03A0, //GREEK CAPITAL LETTER PI	GREEK SMALL LETTER PI
0x03C1, 0x03A1, //GREEK CAPITAL LETTER RHO	GREEK SMALL LETTER RHO
0x03C3, 0x03A3, //GREEK CAPITAL LETTER SIGMA	GREEK SMALL LETTER SIGMA
0x03C4, 0x03A4, //GREEK CAPITAL LETTER TAU	GREEK SMALL LETTER TAU
0x03C5, 0x03A5, //GREEK CAPITAL LETTER UPSILON	GREEK SMALL LETTER UPSILON
0x03C6, 0x03A6, //GREEK CAPITAL LETTER PHI	GREEK SMALL LETTER PHI
0x03C7, 0x03A7, //GREEK CAPITAL LETTER CHI	GREEK SMALL LETTER CHI
0x03C8, 0x03A8, //GREEK CAPITAL LETTER PSI	GREEK SMALL LETTER PSI
0x03C9, 0x03A9, //GREEK CAPITAL LETTER OMEGA	GREEK SMALL LETTER OMEGA
0x03CA, 0x03AA, //GREEK CAPITAL LETTER IOTA WITH DIALYTIKA	GREEK SMALL LETTER IOTA WITH DIALYTIKA
0x03CB, 0x03AB, //GREEK CAPITAL LETTER UPSILON WITH DIALYTIKA	GREEK SMALL LETTER UPSILON WITH DIALYTIKA
0x03E3, 0x03E2, //COPTIC CAPITAL LETTER SHEI	COPTIC SMALL LETTER SHEI
0x03E5, 0x03E4, //COPTIC CAPITAL LETTER FEI	COPTIC SMALL LETTER FEI
0x03E7, 0x03E6, //COPTIC CAPITAL LETTER KHEI	COPTIC SMALL LETTER KHEI
0x03E9, 0x03E8, //COPTIC CAPITAL LETTER HORI	COPTIC SMALL LETTER HORI
0x03EB, 0x03EA, //COPTIC CAPITAL LETTER GANGIA	COPTIC SMALL LETTER GANGIA
0x03ED, 0x03EC, //COPTIC CAPITAL LETTER SHIMA	COPTIC SMALL LETTER SHIMA
0x03EF, 0x03EE, //COPTIC CAPITAL LETTER DEI	COPTIC SMALL LETTER DEI
0x0451, 0x0401, //CYRILLIC CAPITAL LETTER IO	CYRILLIC SMALL LETTER IO
0x0452, 0x0402, //CYRILLIC CAPITAL LETTER DJE (SERBOCROATIAN)	CYRILLIC SMALL LETTER DJE (SERBOCROATIAN)
0x0453, 0x0403, //CYRILLIC CAPITAL LETTER GJE	CYRILLIC SMALL LETTER GJE
0x0454, 0x0404, //CYRILLIC CAPITAL LETTER UKRAINIAN IE	CYRILLIC SMALL LETTER UKRAINIAN IE
0x0455, 0x0405, //CYRILLIC CAPITAL LETTER DZE	CYRILLIC SMALL LETTER DZE
0x0456, 0x0406, //CYRILLIC CAPITAL LETTER BYELORUSSIAN_UKRAINIAN I	CYRILLIC SMALL LETTER BYELORUSSIAN-UKRAINIAN I
0x0457, 0x0407, //CYRILLIC CAPITAL LETTER YI (UKRAINIAN)	CYRILLIC SMALL LETTER YI (UKRAINIAN)
0x0458, 0x0408, //CYRILLIC CAPITAL LETTER JE	CYRILLIC SMALL LETTER JE
0x0459, 0x0409, //CYRILLIC CAPITAL LETTER LJE	CYRILLIC SMALL LETTER LJE
0x045A, 0x040A, //CYRILLIC CAPITAL LETTER NJE	CYRILLIC SMALL LETTER NJE
0x045B, 0x040B, //CYRILLIC CAPITAL LETTER TSHE (SERBOCROATIAN)	CYRILLIC SMALL LETTER TSHE (SERBOCROATIAN)
0x045C, 0x040C, //CYRILLIC CAPITAL LETTER KJE	CYRILLIC SMALL LETTER KJE
0x045E, 0x040E, //CYRILLIC CAPITAL LETTER SHORT U (BYELORUSSIAN)	CYRILLIC SMALL LETTER SHORT U (BYELORUSSIAN)
0x045F, 0x040F, //CYRILLIC CAPITAL LETTER DZHE	CYRILLIC SMALL LETTER DZHE
0x0430, 0x0410, //CYRILLIC CAPITAL LETTER A	CYRILLIC SMALL LETTER A
0x0431, 0x0411, //CYRILLIC CAPITAL LETTER BE	CYRILLIC SMALL LETTER BE
0x0432, 0x0412, //CYRILLIC CAPITAL LETTER VE	CYRILLIC SMALL LETTER VE
0x0433, 0x0413, //CYRILLIC CAPITAL LETTER GHE	CYRILLIC SMALL LETTER GHE
0x0434, 0x0414, //CYRILLIC CAPITAL LETTER DE	CYRILLIC SMALL LETTER DE
0x0435, 0x0415, //CYRILLIC CAPITAL LETTER IE	CYRILLIC SMALL LETTER IE
0x0436, 0x0416, //CYRILLIC CAPITAL LETTER ZHE	CYRILLIC SMALL LETTER ZHE
0x0437, 0x0417, //CYRILLIC CAPITAL LETTER ZE	CYRILLIC SMALL LETTER ZE
0x0438, 0x0418, //CYRILLIC CAPITAL LETTER I	CYRILLIC SMALL LETTER I
0x0439, 0x0419, //CYRILLIC CAPITAL LETTER SHORT I	CYRILLIC SMALL LETTER SHORT I
0x043A, 0x041A, //CYRILLIC CAPITAL LETTER KA	CYRILLIC SMALL LETTER KA
0x043B, 0x041B, //CYRILLIC CAPITAL LETTER EL	CYRILLIC SMALL LETTER EL
0x043C, 0x041C, //CYRILLIC CAPITAL LETTER EM	CYRILLIC SMALL LETTER EM
0x043D, 0x041D, //CYRILLIC CAPITAL LETTER EN	CYRILLIC SMALL LETTER EN
0x043E, 0x041E, //CYRILLIC CAPITAL LETTER O	CYRILLIC SMALL LETTER O
0x043F, 0x041F, //CYRILLIC CAPITAL LETTER PE	CYRILLIC SMALL LETTER PE
0x0440, 0x0420, //CYRILLIC CAPITAL LETTER ER	CYRILLIC SMALL LETTER ER
0x0441, 0x0421, //CYRILLIC CAPITAL LETTER ES	CYRILLIC SMALL LETTER ES
0x0442, 0x0422, //CYRILLIC CAPITAL LETTER TE	CYRILLIC SMALL LETTER TE
0x0443, 0x0423, //CYRILLIC CAPITAL LETTER U	CYRILLIC SMALL LETTER U
0x0444, 0x0424, //CYRILLIC CAPITAL LETTER EF	CYRILLIC SMALL LETTER EF
0x0445, 0x0425, //CYRILLIC CAPITAL LETTER HA	CYRILLIC SMALL LETTER HA
0x0446, 0x0426, //CYRILLIC CAPITAL LETTER TSE	CYRILLIC SMALL LETTER TSE
0x0447, 0x0427, //CYRILLIC CAPITAL LETTER CHE	CYRILLIC SMALL LETTER CHE
0x0448, 0x0428, //CYRILLIC CAPITAL LETTER SHA	CYRILLIC SMALL LETTER SHA
0x0449, 0x0429, //CYRILLIC CAPITAL LETTER SHCHA	CYRILLIC SMALL LETTER SHCHA
0x044A, 0x042A, //CYRILLIC CAPITAL LETTER HARD SIGN	CYRILLIC SMALL LETTER HARD SIGN
0x044B, 0x042B, //CYRILLIC CAPITAL LETTER YERU	CYRILLIC SMALL LETTER YERU
0x044C, 0x042C, //CYRILLIC CAPITAL LETTER SOFT SIGN	CYRILLIC SMALL LETTER SOFT SIGN
0x044D, 0x042D, //CYRILLIC CAPITAL LETTER E	CYRILLIC SMALL LETTER E
0x044E, 0x042E, //CYRILLIC CAPITAL LETTER YU	CYRILLIC SMALL LETTER YU
0x044F, 0x042F, //CYRILLIC CAPITAL LETTER YA	CYRILLIC SMALL LETTER YA
0x0461, 0x0460, //CYRILLIC CAPITAL LETTER OMEGA	CYRILLIC SMALL LETTER OMEGA
0x0463, 0x0462, //CYRILLIC CAPITAL LETTER YAT	CYRILLIC SMALL LETTER YAT
0x0465, 0x0464, //CYRILLIC CAPITAL LETTER IOTIFIED E	CYRILLIC SMALL LETTER IOTIFIED E
0x0467, 0x0466, //CYRILLIC CAPITAL LETTER LITTLE YUS	CYRILLIC SMALL LETTER LITTLE YUS
0x0469, 0x0468, //CYRILLIC CAPITAL LETTER IOTIFIED LITTLE YUS	CYRILLIC SMALL LETTER IOTIFIED LITTLE YUS
0x046B, 0x046A, //CYRILLIC CAPITAL LETTER BIG YUS	CYRILLIC SMALL LETTER BIG YUS
0x046D, 0x046C, //CYRILLIC CAPITAL LETTER IOTIFIED BIG YUS	CYRILLIC SMALL LETTER IOTIFIED BIG YUS
0x046F, 0x046E, //CYRILLIC CAPITAL LETTER KSI	CYRILLIC SMALL LETTER KSI
0x0471, 0x0470, //CYRILLIC CAPITAL LETTER PSI	CYRILLIC SMALL LETTER PSI
0x0473, 0x0472, //CYRILLIC CAPITAL LETTER FITA	CYRILLIC SMALL LETTER FITA
0x0475, 0x0474, //CYRILLIC CAPITAL LETTER IZHITSA	CYRILLIC SMALL LETTER IZHITSA
0x0477, 0x0476, //CYRILLIC CAPITAL LETTER IZHITSA WITH DOUBLE GRAVE ACCENT	CYRILLIC SMALL LETTER IZHITSA WITH DOUBLE GRAVE ACCENT
0x0479, 0x0478, //CYRILLIC CAPITAL LETTER UK	CYRILLIC SMALL LETTER UK
0x047B, 0x047A, //CYRILLIC CAPITAL LETTER ROUND OMEGA	CYRILLIC SMALL LETTER ROUND OMEGA
0x047D, 0x047C, //CYRILLIC CAPITAL LETTER OMEGA WITH TITLO	CYRILLIC SMALL LETTER OMEGA WITH TITLO
0x047F, 0x047E, //CYRILLIC CAPITAL LETTER OT	CYRILLIC SMALL LETTER OT
0x0481, 0x0480, //CYRILLIC CAPITAL LETTER KOPPA	CYRILLIC SMALL LETTER KOPPA
0x0491, 0x0490, //CYRILLIC CAPITAL LETTER GHE WITH UPTURN	CYRILLIC SMALL LETTER GHE WITH UPTURN
0x0493, 0x0492, //CYRILLIC CAPITAL LETTER GHE WITH STROKE	CYRILLIC SMALL LETTER GHE WITH STROKE
0x0495, 0x0494, //CYRILLIC CAPITAL LETTER GHE WITH MIDDLE HOOK	CYRILLIC SMALL LETTER GHE WITH MIDDLE HOOK
0x0497, 0x0496, //CYRILLIC CAPITAL LETTER ZHE WITH DESCENDER	CYRILLIC SMALL LETTER ZHE WITH DESCENDER
0x0499, 0x0498, //CYRILLIC CAPITAL LETTER ZE WITH DESCENDER	CYRILLIC SMALL LETTER ZE WITH DESCENDER
0x049B, 0x049A, //CYRILLIC CAPITAL LETTER KA WITH DESCENDER	CYRILLIC SMALL LETTER KA WITH DESCENDER
0x049D, 0x049C, //CYRILLIC CAPITAL LETTER KA WITH VERTICAL STROKE	CYRILLIC SMALL LETTER KA WITH VERTICAL STROKE
0x049F, 0x049E, //CYRILLIC CAPITAL LETTER KA WITH STROKE	CYRILLIC SMALL LETTER KA WITH STROKE
0x04A1, 0x04A0, //CYRILLIC CAPITAL LETTER BASHKIR KA	CYRILLIC SMALL LETTER EASHKIR KA
0x04A3, 0x04A2, //CYRILLIC CAPITAL LETTER EN WITH DESCENDER	CYRILLIC SMALL LETTER EN WITH DESCENDER
0x04A5, 0x04A4, //CYRILLIC CAPITAL LIGATURE EN GHF	CYRILLIC SMALL LIGATURE EN GHE
0x04A7, 0x04A6, //CYRILLIC CAPITAL LETTER PE WITH MIDDLE HOOK (ABKHASIAN)	CYRILLIC SMALL LETTER PE WITH MIDDLE HOOK (ABKHASIAN)
0x04A9, 0x04A8, //CYRILLIC CAPITAL LETTER ABKHASIAN HA	CYRILLIC SMALL LETTER ABKHASIAN HA
0x04AB, 0x04AA, //CYRILLIC CAPITAL LETTER ES WITH DESCENDER	CYRILLIC SMALL LETTER ES WITH DESCENDER
0x04AD, 0x04AC, //CYRILLIC CAPITAL LETTER TE WITH DESCENDER	CYRILLIC SMALL LETTER TE WITH DESCENDER
0x04AF, 0x04AE, //CYRILLIC CAPITAL LETTER STRAIGHT U	CYRILLIC SMALL LETTER STRAIGHT U
0x04B1, 0x04B0, //CYRILLIC CAPITAL LETTER STRAIGHT U WITH STROKE	CYRILLIC SMALL LETTER STRAIGHT U WITH STROKE
0x04B3, 0x04B2, //CYRILLIC CAPITAL LETTER HA WITH DESCENDER	CYRILLIC SMALL LETTER HA WITH DESCENDER
0x04B5, 0x04B4, //CYRILLIC CAPITAL LIGATURE TE TSE (ABKHASIAN)	CYRILLIC SMALL LIGATURE TE TSE (ABKHASIAN)
0x04B7, 0x04B6, //CYRILLIC CAPITAL LETTER CHE WITH DESCENDER	CYRILLIC SMALL LETTER CHE WITH DESCENDER
0x04B9, 0x04B8, //CYRILLIC CAPITAL LETTER CHE WITH VERTICAL STROKE	CYRILLIC SMALL LETTER CHE WITH VERTICAL STROKE
0x04BB, 0x04BA, //CYRILLIC CAPITAL LETTER SHHA	CYRILLIC SMALL LETTER SHHA
0x04BD, 0x04BC, //CYRILLIC CAPITAL LETTER ABKHASIAN CHE	CYRILLIC SMALL LETTER ABKHASIAN CHE
0x04BF, 0x04BE, //CYRILLIC CAPITAL LETTER ABKHASIAN CHE WITH DESCENDER	CYRILLIC SMALL LETTER ABKHASIAN CHE WITH DESCENDER
0x04C2, 0x04C1, //CYRILLIC CAPITAL LETTER ZHE WITH BREVE	CYRILLIC SMALL LETTER ZHE WITH BREVE
0x04C4, 0x04C3, //CYRILLIC CAPITAL LETTER KA WITH HOOK	CYRILLIC SMALL LETTER KA WITH HOOK
0x04C8, 0x04C7, //CYRILLIC CAPITAL LETTER EN WITH HOOK	CYRILLIC SMALL LETTER EN WITH HOOK
0x04CC, 0x04CB, //CYRILLIC CAPITAL LETTER KHAKASSIAN CHE	CYRILLIC SMALL LETTER KHAKASSIAN CHE
0x04D1, 0x04D0, //CYRILLIC CAPITAL LETTER A WITH BREVE	CYRILLIC SMALL LETTER A WITH BREVE
0x04D3, 0x04D2, //CYRILLIC CAPITAL LETTER A WITH DIAERESIS	CYRILLIC SMALL LETTER A WITH DIAERESIS
0x04D5, 0x04D4, //CYRILLIC CAPITAL LIGATURE A IE	CYRILLIC SMALL LIGATURE A IE
0x04D7, 0x04D6, //CYRILLIC CAPITAL LETTER IE WITH BREVE	CYRILLIC SMALL LETTER IE WITH BREVE
0x04D9, 0x04D8, //CYRILLIC CAPITAL LETTER SCHWA	CYRILLIC SMALL LETTER SCHWA
0x04DB, 0x04DA, //CYRILLIC CAPITAL LETTER SCHWA WITH DIAERESIS	CYRILLIC SMALL LETTER SCHWA WITH DIAERESIS
0x04DD, 0x04DC, //CYRILLIC CAPITAL LETTER ZHE WITH DIAERESIS	CYRILLIC SMALL LETTER ZHE WITH DIAERESIS
0x04DF, 0x04DE, //CYRILLIC CAPITAL LETTER ZE WITH DIAERESIS	CYRILLIC SMALL LETTER ZE WITH DIAERESIS
0x04E1, 0x04E0, //CYRILLIC CAPITAL LETTER ABKHASIAN DZE	CYRILLIC SMALL LETTER ABKHASIAN DZE
0x04E3, 0x04E2, //CYRILLIC CAPITAL LETTER I WITH MACRON	CYRILLIC SMALL LETTER I WITH MACRON
0x04E5, 0x04E4, //CYRILLIC CAPITAL LETTER I WITH DIAERESIS	CYRILLIC SMALL LETTER I WITH DIAERESIS
0x04E7, 0x04E6, //CYRILLIC CAPITAL LETTER O WITH DIAERESIS	CYRILLIC SMALL LETTER O WITH DIAERESIS
0x04E9, 0x04E8, //CYRILLIC CAPITAL LETTER BARRED O	CYRILLIC SMALL LETTER BARRED O
0x04EB, 0x04EA, //CYRILLIC CAPITAL LETTER BARRED O WITH DIAERESIS	CYRILLIC SMALL LETTER BARRED 0 WITH DIAERESIS
0x04EF, 0x04EE, //CYRILLIC CAPITAL LETTER U WITH MACRON	CYRILLIC SMALL LETTER U WITH MACRON
0x04F1, 0x04F0, //CYRILLIC CAPITAL LETTER U WITH DIAERESIS	CYRILLIC SMALL LETTER U WITH DIAERESIS
0x04F3, 0x04F2, //CYRILLIC CAPITAL LETTER U WITH DOUBLE ACUTE	CYRILLIC SMALL LETTER U WITH DOUBLE ACUTE
0x04F5, 0x04F4, //CYRILLIC CAPITAL LETTER CHE WITH DIAERESIS	CYRILLIC SMALL LETTER CHE WITH DIAERESIS
0x04F9, 0x04F8, //CYRILLIC CAPITAL LETTER YERU WITH DIAERESIS	CYRILLIC SMALL LETTER YERU WITH DIAERESIS
0x0561, 0x0531, //ARMENIAN CAPITAL LETTER AYB	ARMENIAN SMALL LETTER AYB
0x0562, 0x0532, //ARMENIAN CAPITAL LETTER BEN	ARMENIAN SMALL LETTER BEN
0x0563, 0x0533, //ARMENIAN CAPITAL LETTER GIM	ARMENIAN SMALL LETTER GIM
0x0564, 0x0534, //ARMENIAN CAPITAL LETTER DA	ARMENIAN SMALL LETTER DA
0x0565, 0x0535, //ARMENIAN CAPITAL LETTER ECH	ARMENIAN SMALL LETTER ECH
0x0566, 0x0536, //ARMENIAN CAPITAL LETTER ZA	ARMENIAN SMALL LETTER ZA
0x0567, 0x0537, //ARMENIAN CAPITAL LETTER EH	ARMENIAN SMALL LETTER EH
0x0568, 0x0538, //ARMENIAN CAPITAL LETTER ET	ARMENIAN SMALL LETTER ET
0x0569, 0x0539, //ARMENIAN CAPITAL LETTER TO	ARMENIAN SMALL LETTER TO
0x056A, 0x053A, //ARMENIAN CAPITAL LETTER ZHE	ARMENIAN SMALL LETTER ZHE
0x056B, 0x053B, //ARMENIAN CAPITAL LETTER INI	ARMENIAN SMALL LETTER INI
0x056C, 0x053C, //ARMENIAN CAPITAL LETTER LIWN	ARMENIAN SMALL LETTER LIWN
0x056D, 0x053D, //ARMENIAN CAPITAL LETTER XEH	ARMENIAN SMALL LETTER XEH
0x056E, 0x053E, //ARMENIAN CAPITAL LETTER CA	ARMENIAN SMALL LETTER CA
0x056F, 0x053F, //ARMENIAN CAPITAL LETTER KEN	ARMENIAN SMALL LETTER KEN
0x0570, 0x0540, //ARMENIAN CAPITAL LETTER HO	ARMENIAN SMALL LETTER HO
0x0571, 0x0541, //ARMENIAN CAPITAL LETTER JA	ARMENIAN SMALL LETTER JA
0x0572, 0x0542, //ARMENIAN CAPITAL LETTER GHAD	ARMENIAN SMALL LETTER GHAD
0x0573, 0x0543, //ARMENIAN CAPITAL LETTER CHEH	ARMENIAN SMALL LETTER CHEH
0x0574, 0x0544, //ARMENIAN CAPITAL LETTER MEN	ARMENIAN SMALL LETTER MEN
0x0575, 0x0545, //ARMENIAN CAPITAL LETTER YI	ARMENIAN SMALL LETTER YI
0x0576, 0x0546, //ARMENIAN CAPITAL LETTER NOW	ARMENIAN SMALL LETTER NOW
0x0577, 0x0547, //ARMENIAN CAPITAL LETTER SHA	ARMENIAN SMALL LETTER SNA
0x0578, 0x0548, //ARMENIAN CAPITAL LETTER VO	ARMENIAN SMALL LETTER VO
0x0579, 0x0549, //ARMENIAN CAPITAL LETTER CHA	ARMENIAN SMALL LETTER CHA
0x057A, 0x054A, //ARMENIAN CAPITAL LETTER PEH	ARMENIAN SMALL LETTER PEH
0x057B, 0x054B, //ARMENIAN CAPITAL LETTER JHEH	ARMENIAN SMALL LETTER JHEH
0x057C, 0x054C, //ARMENIAN CAPITAL LETTER RA	ARMENIAN SMALL LETTER RA
0x057D, 0x054D, //ARMENIAN CAPITAL LETTER SEH	ARMENIAN SMALL LETTER SEH
0x057E, 0x054E, //ARMENIAN CAPITAL LETTER VEW	ARMENIAN SMALL LETTER VEW
0x057F, 0x054F, //ARMENIAN CAPITAL LETTER TIWN	ARMENIAN SMALL LETTER TIWN
0x0580, 0x0550, //ARMENIAN CAPITAL LETTER REH	ARMENIAN SMALL LETTER REH
0x0581, 0x0551, //ARMENIAN CAPITAL LETTER CO	ARMENIAN SMALL LETTER CO
0x0582, 0x0552, //ARMENIAN CAPITAL LETTER YIWN	ARMENIAN SMALL LETTER YIWN
0x0583, 0x0553, //ARMENIAN CAPITAL LETTER PIWR	ARMENIAN SMALL LETTER PIWP
0x0584, 0x0554, //ARMENIAN CAPITAL LETTER KEH	ARMENIAN SMALL LETTER KEH
0x0585, 0x0555, //ARMENIAN CAPITAL LETTER OH	ARMENIAN SMALL LETTER OH
0x0586, 0x0556, //ARMENIAN CAPITAL LETTER FEH	ARMENIAN SMALL LETTER FEH
0x10D0, 0x10A0, //GEORGIAN CAPITAL LETTER AN (KHUTSURI)	GEORGIAN LETTER AN
0x10D1, 0x10A1, //GEORGIAN CAPITAL LETTER BAN (KHUTSURI)	GEORGIAN LETTER BAN
0x10D2, 0x10A2, //GEORGIAN CAPITAL LETTER GAN (KHUTSURI)	GEORGIAN LETTER GAN
0x10D3, 0x10A3, //GEORGIAN CAPITAL LETTER DON (KHUTSURI)	GEORGIAN LETTER DON
0x10D4, 0x10A4, //GEORGIAN CAPITAL LETTER EN (KHUTSURI)	GEORGIAN LETTER EN
0x10D5, 0x10A5, //GEORGIAN CAPITAL LETTER VIN (KHUTSURI)	GEORGIAN LETTER VIN
0x10D6, 0x10A6, //GEORGIAN CAPITAL LETTER ZEN (KHUTSURI)	GEORGIAN LETTER ZEN
0x10D7, 0x10A7, //GEORGIAN CAPITAL LETTER TAN (KHUTSURI)	GEORGIAN LETTER TAN
0x10D8, 0x10A8, //GEORGIAN CAPITAL LETTER IN (KHUTSURI)	GEORGIAN LETTER IN
0x10D9, 0x10A9, //GEORGIAN CAPITAL LETTER KAN (KHUTSURI)	GEORGIAN LETTER KAN
0x10DA, 0x10AA, //GEORGIAN CAPITAL LETTER LAS (KHUTSURI)	GEORGIAN LETTER LAS
0x10DB, 0x10AB, //GEORGIAN CAPITAL LETTER MAN (KHUTSURI)	GEORGIAN LETTER MAN
0x10DC, 0x10AC, //GEORGIAN CAPITAL LETTER NAR (KHUTSURI)	GEORGIAN LETTER NAR
0x10DD, 0x10AD, //GEORGIAN CAPITAL LETTER ON (KHUTSURI)	GEORGIAN LETTER ON
0x10DE, 0x10AE, //GEORGIAN CAPITAL LETTER PAR (KHUTSURI)	GEORGIAN LETTER PAR
0x10DF, 0x10AF, //GEORGIAN CAPITAL LETTER ZHAR (KHUTSURI)	GEORGIAN LETTER ZHAR
0x10E0, 0x10B0, //GEORGIAN CAPITAL LETTER RAE (KHUTSURI)	GEORGIAN LETTER RAE
0x10E1, 0x10B1, //GEORGIAN CAPITAL LETTER SAN (KHUTSURI)	GEORGIAN LETTER SAN
0x10E2, 0x10B2, //GEORGIAN CAPITAL LETTER TAR (KHUTSURI)	GEORGIAN LETTER TAR
0x10E3, 0x10B3, //GEORGIAN CAPITAL LETTER UN (KHUTSURI)	GEORGIAN LETTER UN
0x10E4, 0x10B4, //GEORGIAN CAPITAL LETTER PHAR (KHUTSURI)	GEORGIAN LETTER PHAR
0x10E5, 0x10B5, //GEORGIAN CAPITAL LETTER KHAR (KHUTSURI)	GEORGIAN LETTER KHAR
0x10E6, 0x10B6, //GEORGIAN CAPITAL LETTER GHAN (KHUTSURI)	GEORGIAN LETTER GHAN
0x10E7, 0x10B7, //GEORGIAN CAPITAL LETTER QAR (KHUTSURI)	GEORGIAN LETTER QAR
0x10E8, 0x10B8, //GEORGIAN CAPITAL LETTER SHIN (KHUTSURI)	GEORGIAN LETTER SHIN
0x10E9, 0x10B9, //GEORGIAN CAPITAL LETTER CHIN (KHUTSURI)	GEORGIAN LETTER CHIN
0x10EA, 0x10BA, //GEORGIAN CAPITAL LETTER CAN (KHUTSURI)	GEORGIAN LETTER CAN
0x10EB, 0x10BB, //GEORGIAN CAPITAL LETTER JIL (KHUTSURI)	GEORGIAN LETTER JIL
0x10EC, 0x10BC, //GEORGIAN CAPITAL LETTER CIL (KHUTSURI)	GEORGIAN LETTER CIL
0x10ED, 0x10BD, //GEORGIAN CAPITAL LETTER CHAR (KHUTSURI)	GEORGIAN LETTER CHAR
0x10EE, 0x10BE, //GEORGIAN CAPITAL LETTER XAN (KHUTSURI)	GEORGIAN LETTER XAN
0x10EF, 0x10BF, //GEORGIAN CAPITAL LETTER JHAN (KHUTSURI)	GEORGIAN LETTER JHAN
0x10F0, 0x10C0, //GEORGIAN CAPITAL LETTER HAE (KHUTSURI)	GEORGIAN LETTER HAE
0x10F1, 0x10C1, //GEORGIAN CAPITAL LETTER HE (KHUTSURI)	GEORGIAN LETTER HE
0x10F2, 0x10C2, //GEORGIAN CAPITAL LETTER HIE (KHUTSURI)	GEORGIAN LETTER HIE
0x10F3, 0x10C3, //GEORGIAN CAPITAL LETTER WE (KHUTSURI)	GEORGIAN LETTER WE
0x10F4, 0x10C4, //GEORGIAN CAPITAL LETTER HAR (KHUTSURI)	GEORGIAN LETTER HAR
0x10F5, 0x10C5, //GEORGIAN CAPITAL LETTER HOE (KHUTSURI)	GEORGIAN LETTER HOE
0x1E01, 0x1E00, //LATIN CAPITAL LETTER A WITH RING BELOW	LATIN SMALL LETTER A WITH RING BELOW
0x1E03, 0x1E02, //LATIN CAPITAL LETTER B WITH DOT ABOVE	LATIN SMALL LETTER B WITH DOT ABOVE
0x1E05, 0x1E04, //LATIN CAPITAL LETTER B WITH DOT BELOW	LATIN SMALL LETTER B WITH DOT BELOW
0x1E07, 0x1E06, //LATIN CAPITAL LETTER B WITH LINE BELOW	LATIN SMALL LETTER B WITH LINE BELOW
0x1E09, 0x1E08, //LATIN CAPITAL LETTER C WITH CEDILLA AND ACUTE	LATIN SMALL LETTER C WITH CEDILLA AND ACUTE
0x1E0B, 0x1E0A, //LATIN CAPITAL LETTER D WITH DOT ABOVE	LATIN SMALL LETTER D WITH DOT ABOVE
0x1E0D, 0x1E0C, //LATIN CAPITAL LETTER D WITH DOT BELOW	LATIN SMALL LETTER D WITH DOT BELOW
0x1E0F, 0x1E0E, //LATIN CAPITAL LETTER D WITH LINE BELOW	LATIN SMALL LETTER D WITH LINE BELOW
0x1E11, 0x1E10, //LATIN CAPITAL LETTER D WITH CEDILLA	LATIN SMALL LETTER D WITH CEDILLA
0x1E13, 0x1E12, //LATIN CAPITAL LETTER D WITH CIRCUMFLEX BELOW	LATIN SMALL LETTER D WITH CIRCUMFLEX BELOW
0x1E15, 0x1E14, //LATIN CAPITAL LETTER E WITH MACRON AND GRAVE	LATIN SMALL LETTER E WITH MACRON AND GRAVE
0x1E17, 0x1E16, //LATIN CAPITAL LETTER E WITH MACRON AND ACUTE	LATIN SMALL LETTER E WITH MACRON AND ACUTE
0x1E19, 0x1E18, //LATIN CAPITAL LETTER E WITH CIRCUMFLEX BELOW	LATIN SMALL LETTER E WITH CIRCUMFLEX BELOW
0x1E1B, 0x1E1A, //LATIN CAPITAL LETTER E WITH TILDE BELOW	LATIN SMALL LETTER E WITH TILDE BELOW
0x1E1D, 0x1E1C, //LATIN CAPITAL LETTER E WITH CEDILLA AND BREVE	LATIN SMALL LETTER E WITH CEDILLA AND BREVE
0x1E1F, 0x1E1E, //LATIN CAPITAL LETTER F WITH DOT ABOVE	LATIN SMALL LETTER F WITH DOT ABOVE
0x1E21, 0x1E20, //LATIN CAPITAL LETTER G WITH MACRON	LATIN SMALL LETTER G WITH MACRON
0x1E23, 0x1E22, //LATIN CAPITAL LETTER H WITH DOT ABOVE	LATIN SMALL LETTER H WITH DOT ABOVE
0x1E25, 0x1E24, //LATIN CAPITAL LETTER H WITH DOT BELOW	LATIN SMALL LETTER H WITH DOT BELOW
0x1E27, 0x1E26, //LATIN CAPITAL LETTER H WITH DIAERESIS	LATIN SMALL LETTER H WITH DIAERESIS
0x1E29, 0x1E28, //LATIN CAPITAL LETTER H WITH CEDILLA	LATIN SMALL LETTER H WITH CEDILLA
0x1E2B, 0x1E2A, //LATIN CAPITAL LETTER H WITH BREVE BELOW	LATIN SMALL LETTER H WITH BREVE BELOW
0x1E2D, 0x1E2C, //LATIN CAPITAL LETTER I WITH TILDE BELOW	LATIN SMALL LETTER I WITH TILDE BELOW
0x1E2F, 0x1E2E, //LATIN CAPITAL LETTER I WITH DIAERESIS AND ACUTE	LATIN SMALL LETTER I WITH DIAERESIS AND ACUTE
0x1E31, 0x1E30, //LATIN CAPITAL LETTER K WITH ACUTE	LATIN SMALL LETTER K WITH ACUTE
0x1E33, 0x1E32, //LATIN CAPITAL LETTER K WITH DOT BELOW	LATIN SMALL LETTER K WITH DOT BELOW
0x1E35, 0x1E34, //LATIN CAPITAL LETTER K WITH LINE BELOW	LATIN SMALL LETTER K WITH LINE BELOW
0x1E37, 0x1E36, //LATIN CAPITAL LETTER L WITH DOT BELOW	LATIN SMALL LETTER L WITH DOT BELOW
0x1E39, 0x1E38, //LATIN CAPITAL LETTER L WITH DOT BELOW AND MACRON	LATIN SMALL LETTER L WITH DOT BELOW AND MACRON
0x1E3B, 0x1E3A, //LATIN CAPITAL LETTER L WITH LINE BELOW	LATIN SMALL LETTER L WITH LINE BELOW
0x1E3D, 0x1E3C, //LATIN CAPITAL LETTER L WITH CIRCUMFLEX BELOW	LATIN SMALL LETTER L WITH CIRCUMFLEX BELOW
0x1E3F, 0x1E3E, //LATIN CAPITAL LETTER M WITH ACUTE	LATIN SMALL LETTER M WITH ACUTE
0x1E41, 0x1E40, //LATIN CAPITAL LETTER M WITH DOT ABOVE	LATIN SMALL LETTER M WITH DOT ABOVE
0x1E43, 0x1E42, //LATIN CAPITAL LETTER M WITH DOT BELOW	LATIN SMALL LETTER M WITH DOT BELOW
0x1E45, 0x1E44, //LATIN CAPITAL LETTER N WITH DOT ABOVE	LATIN SMALL LETTER N WITH DOT ABOVE
0x1E47, 0x1E46, //LATIN CAPITAL LETTER N WITH DOT BELOW	LATIN SMALL LETTER N WITH DOT BELOW
0x1E49, 0x1E48, //LATIN CAPITAL LETTER N WITH LINE BELOW	LATIN SMALL LETTER N WITH LINE BELOW
0x1E4B, 0x1E4A, //LATIN CAPITAL LETTER N WITH CIRCUMFLEX BELOW	LATIN SMALL LETTER N WITH CIRCUMFLEX BELOW
0x1E4D, 0x1E4C, //LATIN CAPITAL LETTER O WITH TILDE AND ACUTE	LATIN SMALL LETTER O WITH TILDE AND ACUTE
0x1E4F, 0x1E4E, //LATIN CAPITAL LETTER O WITH TILDE AND DIAERESIS	LATIN SMALL LETTER O WITH TILDE AND DIAERESIS
0x1E51, 0x1E50, //LATIN CAPITAL LETTER O WITH MACRON AND GRAVE	LATIN SMALL LETTER O WITH MACRON AND GRAVE
0x1E53, 0x1E52, //LATIN CAPITAL LETTER O WITH MACRON AND ACUTE	LATIN SMALL LETTER O WITH MACRON AND ACUTE
0x1E55, 0x1E54, //LATIN CAPITAL LETTER P WITH ACUTE	LATIN SMALL LETTER P WITH ACUTE
0x1E57, 0x1E56, //LATIN CAPITAL LETTER P WITH DOT ABOVE	LATIN SMALL LETTER P WITH DOT ABOVE
0x1E59, 0x1E58, //LATIN CAPITAL LETTER R WITH DOT ABOVE	LATIN SMALL LETTER R WITH DOT ABOVE
0x1E5B, 0x1E5A, //LATIN CAPITAL LETTER R WITH DOT BELOW	LATIN SMALL LETTER R WITH DOT BELOW
0x1E5D, 0x1E5C, //LATIN CAPITAL LETTER R WITH DOT BELOW AND MACRON	LATIN SMALL LETTER R WITH DOT BELOW AND MACRON
0x1E5F, 0x1E5E, //LATIN CAPITAL LETTER R WITH LINE BELOW	LATIN SMALL LETTER R WITH LINE BELOW
0x1E61, 0x1E60, //LATIN CAPITAL LETTER S WITH DOT ABOVE	LATIN SMALL LETTER S WITH DOT ABOVE
0x1E63, 0x1E62, //LATIN CAPITAL LETTER S WITH DOT BELOW	LATIN SMALL LETTER S WITH DOT BELOW
0x1E65, 0x1E64, //LATIN CAPITAL LETTER S WITH ACUTE AND DOT ABOVE	LATIN SMALL LETTER S WITH ACUTE AND DOT ABOVE
0x1E67, 0x1E66, //LATIN CAPITAL LETTER S WITH CARON AND DOT ABOVE	LATIN SMALL LETTER S WITH CARON AND DOT ABOVE
0x1E69, 0x1E68, //LATIN CAPITAL LETTER S WITH DOT BELOW AND DOT ABOVE	LATIN SMALL LETTER S WITH DOT BELOW AND DOT ABOVE
0x1E6B, 0x1E6A, //LATIN CAPITAL LETTER T WITH DOT ABOVE	LATIN SMALL LETTER T WITH DOT ABOVE
0x1E6D, 0x1E6C, //LATIN CAPITAL LETTER T WITH DOT BELOW	LATIN SMALL LETTER T WITH DOT BELOW
0x1E6F, 0x1E6E, //LATIN CAPITAL LETTER T WITH LINE BELOW	LATIN SMALL LETTER T WITH LINE BELOW
0x1E71, 0x1E70, //LATIN CAPITAL LETTER T WITH CIRCUMFLEX BELOW	LATIN SMALL LETTER T WITH CIRCUMFLEX BELOW
0x1E73, 0x1E72, //LATIN CAPITAL LETTER U WITH DIAERESIS BELOW	LATIN SMALL LETTER U WITH DIAERESIS BELOW
0x1E75, 0x1E74, //LATIN CAPITAL LETTER U WITH TILDE BELOW	LATIN SMALL LETTER U WITH TILDE BELOW
0x1E77, 0x1E76, //LATIN CAPITAL LETTER U WITH CIRCUMFLEX BELOW	LATIN SMALL LETTER U WITH CIRCUMFLEX BELOW
0x1E79, 0x1E78, //LATIN CAPITAL LETTER U WITH TILDE AND ACUTE	LATIN SMALL LETTER U WITH TILDE AND ACUTE
0x1E7B, 0x1E7A, //LATIN CAPITAL LETTER U WITH MACRON AND DIAERESIS	LATIN SMALL LETTER U WITH MACRON AND DIAERESIS
0x1E7D, 0x1E7C, //LATIN CAPITAL LETTER V WITH TILDE	LATIN SMALL LETTER V WITH TILDE
0x1E7F, 0x1E7E, //LATIN CAPITAL LETTER V WITH DOT BELOW	LATIN SMALL LETTER V WITH DOT BELOW
0x1E81, 0x1E80, //LATIN CAPITAL LETTER W WITH GRAVE	LATIN SMALL LETTER W WITH GRAVE
0x1E83, 0x1E82, //LATIN CAPITAL LETTER W WITH ACUTE	LATIN SMALL LETTER W WITH ACUTE
0x1E85, 0x1E84, //LATIN CAPITAL LETTER W WITH DIAERESIS	LATIN SMALL LETTER W WITH DIAERESIS
0x1E87, 0x1E86, //LATIN CAPITAL LETTER W WITH DOT ABOVE	LATIN SMALL LETTER W WITH DOT ABOVE
0x1E89, 0x1E88, //LATIN CAPITAL LETTER W WITH DOT BELOW	LATIN SMALL LETTER W WITH DOT BELOW
0x1E8B, 0x1E8A, //LATIN CAPITAL LETTER X WITH DOT ABOVE	LATIN SMALL LETTER X WITH DOT ABOVE
0x1E8D, 0x1E8C, //LATIN CAPITAL LETTER X5 WITH DIAERESIS	LATIN SMALL LETTER X WITH DIAERESIS
0x1E8F, 0x1E8E, //LATIN CAPITAL LETTER Y WITH DOT ABOVE	LATIN SMALL LETTER Y WITH DOT ABOVE
0x1E91, 0x1E90, //LATIN CAPITAL LETTER Z WITH CIRCUMFLEX	LATIN SMALL LETTER Z WITH CIRCUMFLEX
0x1E93, 0x1E92, //LATIN CAPITAL LETTER Z WITH DOT BELOW	LATIN SMALL LETTER Z WITH DOT BELOW
0x1E95, 0x1E94, //LATIN CAPITAL LETTER Z WITH LINE BELOW	LATIN SMALL LETTER Z WITH LINE BELOW
0x1EA1, 0x1EA0, //LATIN CAPITAL LETTER A WITH DOT BELOW	LATIN SMALL LETTER A WITH DOT BELOW
0x1EA3, 0x1EA2, //LATIN CAPITAL LETTER A WITH HOOK ABOVE	LATIN SMALL LETTER A WITH HOOK ABOVE
0x1EA5, 0x1EA4, //LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND ACUTE	LATIN SMALL LETTER A WITH CIRCUMFLEX AND ACUTE
0x1EA7, 0x1EA6, //LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND GRAVE	LATIN SMALL LETTER A WITH CIRCUMFLEX AND GRAVE
0x1EA9, 0x1EA8, //LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND HOOK ABOVE	LATIN SMALL LETTER A WITH CIRCUMFLEX AND HOOK ABOVE
0x1EAB, 0x1EAA, //LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND TILDE	LATIN SMALL LETTER A WITH CIRCUMFLEX AND TILDE
0x1EAD, 0x1EAC, //LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND DOT BELOW	LATIN SMALL LETTER A WITH CIRCUMFLEX AND DOT BELOW
0x1EAF, 0x1EAE, //LATIN CAPITAL LETTER A WITH BREVE AND ACUTE	LATIN SMALL LETTER A WITH BREVE AND ACUTE
0x1EB1, 0x1EB0, //LATIN CAPITAL LETTER A WITH BREVE AND GRAVE	LATIN SMALL LETTER A WITH BREVE AND GRAVE
0x1EB3, 0x1EB2, //LATIN CAPITAL LETTER A WITH BREVE AND HOOK ABOVE	LATIN SMALL LETTER A WITH BREVE AND HOOK ABOVE
0x1EB5, 0x1EB4, //LATIN CAPITAL LETTER A WITH BREVE AND TILDE	LATIN SMALL LETTER A WITH BREVE AND TILDE
0x1EB7, 0x1EB6, //LATIN CAPITAL LETTER A WITH BREVE AND DOT BELOW	LATIN SMALL LETTER A WITH BREVE AND DOT BELOW
0x1EB9, 0x1EB8, //LATIN CAPITAL LETTER E WITH DOT BELOW	LATIN SMALL LETTER E WITH DOT BELOW
0x1EBB, 0x1EBA, //LATIN CAPITAL LETTER E WITH HOOK ABOVE	LATIN SMALL LETTER E WITH HOOK ABOVE
0x1EBD, 0x1EBC, //LATIN CAPITAL LETTER E WITH TILDE	LATIN SMALL LETTER E WITH TILDE
0x1EBF, 0x1EBE, //LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND ACUTE	LATIN SMALL LETTER E WITH CIRCUMFLEX AND ACUTE
0x1EC1, 0x1EC0, //LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND GRAVE	LATIN SMALL LETTER E WITH CIRCUMFLEX AND GRAVE
0x1EC3, 0x1EC2, //LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND HOOK ABOVE	LATIN SMALL LETTER E WITH CIRCUMFLEX AND HOOK ABOVE
0x1EC5, 0x1EC4, //LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND TILDE	LATIN SMALL LETTER E WITH CIRCUMFLEX AND TILDE
0x1EC7, 0x1EC6, //LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND DOT BELOW	LATIN SMALL LETTER E WITH CIRCUMFLEX AND DOT BELOW
0x1EC9, 0x1EC8, //LATIN CAPITAL LETTER I WITH HOOK ABOVE	LATIN SMALL LETTER I WITH HOOK ABOVE
0x1ECB, 0x1ECA, //LATIN CAPITAL LETTER I WITH DOT BELOW	LATIN SMALL LETTER I WITH DOT BELOW
0x1ECD, 0x1ECC, //LATIN CAPITAL LETTER O WITH DOT BELOW	LATIN SMALL LETTER O WITH DOT BELOW
0x1ECF, 0x1ECE, //LATIN CAPITAL LETTER O WITH HOOK ABOVE	LATIN SMALL LETTER O WITH HOOK ABOVE
0x1ED1, 0x1ED0, //LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND ACUTE	LATIN SMALL LETTER O WITH CIRCUMFLEX AND ACUTE
0x1ED3, 0x1ED2, //LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND GRAVE	LATIN SMALL LETTER O WITH CIRCUMFLEX AND GRAVE
0x1ED5, 0x1ED4, //LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND HOOK ABOVE	LATIN SMALL LETTER O WITH CIRCUMFLEX AND HOOK ABOVE
0x1ED7, 0x1ED6, //LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND TILDE	LATIN SMALL LETTER O WITH CIRCUMFLEX AND TILDE
0x1ED9, 0x1ED8, //LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND DOT BELOW	LATIN SMALL LETTER O WITH CIRCUMFLEX AND DOT BELOW
0x1EDB, 0x1EDA, //LATIN CAPITAL LETTER O WITH HORN AND ACUTE	LATIN SMALL LETTER O WITH HORN AND ACUTE
0x1EDD, 0x1EDC, //LATIN CAPITAL LETTER O WITH HORN AND GRAVE	LATIN SMALL LETTER O WITH HORN AND GRAVE
0x1EDF, 0x1EDE, //LATIN CAPITAL LETTER O WITH HORN AND HOOK ABOVE	LATIN SMALL LETTER O WITH HORN AND HOOK ABOVE
0x1EE1, 0x1EE0, //LATIN CAPITAL LETTER O WITH HORN AND TILDE	LATIN SMALL LETTER O WITH HORN AND TILDE
0x1EE3, 0x1EE2, //LATIN CAPITAL LETTER O WITH HORN AND DOT BELOW	LATIN SMALL LETTER O WITH HORN AND DOT BELOW
0x1EE5, 0x1EE4, //LATIN CAPITAL LETTER U WITH DOT BELOW	LATIN SMALL LETTER U WITH DOT BELOW
0x1EE7, 0x1EE6, //LATIN CAPITAL LETTER U WITH HOOK ABOVE	LATIN SMALL LETTER U WITH HOOK ABOVE
0x1EE9, 0x1EE8, //LATIN CAPITAL LETTER U WITH HORN AND ACUTE	LATIN SMALL LETTER U WITH HORN AND ACUTE
0x1EEB, 0x1EEA, //LATIN CAPITAL LETTER U WITH HORN AND GRAVE	LATIN SMALL LETTER U WITH HORN AND GRAVE
0x1EED, 0x1EEC, //LATIN CAPITAL LETTER U WITH HORN AND HOOK ABOVE	LATIN SMALL LETTER U WITH HORN AND HOOK ABOVE
0x1EEF, 0x1EEE, //LATIN CAPITAL LETTER U WITH HORN AND TILDE	LATIN SMALL LETTER U WITH HORN AND TILDE
0x1EF1, 0x1EF0, //LATIN CAPITAL LETTER U WITH HORN AND DOT BELOW	LATIN SMALL LETTER U WITH HORN AND DOT BELOW
0x1EF3, 0x1EF2, //LATIN CAPITAL LETTER Y WITH GRAVE	LATIN SMALL LETTER Y WITH GRAVE
0x1EF5, 0x1EF4, //LATIN CAPITAL LETTER Y WITH DOT BELOW	LATIN SMALL LETTER Y WITH DOT BELOW
0x1EF7, 0x1EF6, //LATIN CAPITAL LETTER Y WITH HOOK ABOVE	LATIN SMALL LETTER Y WITH HOOK ABOVE
0x1EF9, 0x1EF8, //LATIN CAPITAL LETTER Y WITH TILDE	LATIN SMALL LETTER Y WITH TILDE
0x1F00, 0x1F08, //GREEK CAPITAL LETTER ALPHA WITH PSILI	GREEK SMALL LETTER ALPHA WITH PSILI
0x1F01, 0x1F09, //GREEK CAPITAL LETTER ALPHA WITH DASIA	GREEK SMALL LETTER ALPHA WITH DASIA
0x1F02, 0x1F0A, //GREEK CAPITAL LETTER ALPHA WITH PSILI AND VARIA	GREEK SMALL LETTER ALPHA WITH PSILI AND VARIA
0x1F03, 0x1F0B, //GREEK CAPITAL LETTER ALPHA WITH DASIA AND VARIA	GREEK SMALL LETTER ALPHA WITH DASIA AND VARIA
0x1F04, 0x1F0C, //GREEK CAPITAL LETTER ALPHA WITH PSILI AND OXIA	GREEK SMALL LETTER ALPHA WITH PSILI AND OXIA
0x1F05, 0x1F0D, //GREEK CAPITAL LETTER ALPHA WITH DASIA AND OXIA	GREEK SMALL LETTER ALPHA WITH DASIA AND OXIA
0x1F06, 0x1F0E, //GREEK CAPITAL LETTER ALPHA WITH PSILI AND PERISPOMENI	GREEK SMALL LETTER ALPHA WITH PSILI AND PERISPOMENI
0x1F07, 0x1F0F, //GREEK CAPITAL LETTER ALPHA WITH DASIA AND PERISPOMENI	GREEK SMALL LETTER ALPHA WITH DASIA AND PERISPOMENI
0x1F10, 0x1F18, //GREEK CAPITAL LETTER EPSILON WITH PSILI	GREEK SMALL LETTER EPSILON WITH PSILI
0x1F11, 0x1F19, //GREEK CAPITAL LETTER EPSILON WITH DASIA	GREEK SMALL LETTER EPSILON WITH DASIA
0x1F12, 0x1F1A, //GREEK CAPITAL LETTER EPSILON WITH PSILI AND VARIA	GREEK SMALL LETTER EPSILON WITH PSILI AND VARIA
0x1F13, 0x1F1B, //GREEK CAPITAL LETTER EPSILON WITH DASIA AND VARIA	GREEK SMALL LETTER EPSILON WITH DASIA AND VARIA
0x1F14, 0x1F1C, //GREEK CAPITAL LETTER EPSILON WITH PSILI AND OXIA	GREEK SMALL LETTER EPSILON WITH PSILI AND OXIA
0x1F15, 0x1F1D, //GREEK CAPITAL LETTER EPSILON WITH DASIA AND OXIA	GREEK SMALL LETTER EPSILON WITH DASIA AND OXIA
0x1F20, 0x1F28, //GREEK CAPITAL LETTER ETA WITH PSILI	GREEK SMALL LETTER ETA WITH PSILI
0x1F21, 0x1F29, //GREEK CAPITAL LETTER ETA WITH DASIA	GREEK SMALL LETTER ETA WITH DASIA
0x1F22, 0x1F2A, //GREEK CAPITAL LETTER ETA WITH PSILI AND VARIA	GREEK SMALL LETTER ETA WITH PSILI AND VARIA
0x1F23, 0x1F2B, //GREEK CAPITAL LETTER ETA WITH DASIA AND VARIA	GREEK SMALL LETTER ETA WITH DASIA AND VARIA
0x1F24, 0x1F2C, //GREEK CAPITAL LETTER ETA WITH PSILI AND OXIA	GREEK SMALL LETTER ETA WITH PSILI AND OXIA
0x1F25, 0x1F2D, //GREEK CAPITAL LETTER ETA WITH DASIA AND OXIA	GREEK SMALL LETTER ETA WITH DASIA AND OXIA
0x1F26, 0x1F2E, //GREEK CAPITAL LETTER ETA WITH PSILI AND PERISPOMENI	GREEK SMALL LETTER ETA WITH PSILI AND PERISPOMENI
0x1F27, 0x1F2F, //GREEK CAPITAL LETTER ETA WITH DASIA AND PERISPOMENI	GREEK SMALL LETTER ETA WITH DASIA AND PERISPOMENI
0x1F30, 0x1F38, //GREEK CAPITAL LETTER IOTA WITH PSILI	GREEK SMALL LETTER IOTA WITH PSILI
0x1F31, 0x1F39, //GREEK CAPITAL LETTER IOTA WITH DASIA	GREEK SMALL LETTER IOTA WITH DASIA
0x1F32, 0x1F3A, //GREEK CAPITAL LETTER IOTA WITH PSILI AND VARIA	GREEK SMALL LETTER IOTA WITH PSILI AND VARIA
0x1F33, 0x1F3B, //GREEK CAPITAL LETTER IOTA WITH DASIA AND VARIA	GREEK SMALL LETTER IOTA WITH DASIA AND VARIA
0x1F34, 0x1F3C, //GREEK CAPITAL LETTER IOTA WITH PSILI AND OXIA	GREEK SMALL LETTER IOTA WITH PSILI AND OXIA
0x1F35, 0x1F3D, //GREEK CAPITAL LETTER IOTA WITH DASIA AND OXIA	GREEK SMALL LETTER IOTA WITH DASIA AND OXIA
0x1F36, 0x1F3E, //GREEK CAPITAL LETTER IOTA WITH PSILI AND PERISPOMENI	GREEK SMALL LETTER IOTA WITH PSILI AND PERISPOMENI
0x1F37, 0x1F3F, //GREEK CAPITAL LETTER IOTA WITH DASIA AND PERISPOMENI	GREEK SMALL LETTER IOTA WITH DASIA AND PERISPOMENI
0x1F40, 0x1F48, //GREEK CAPITAL LETTER OMICRON WITH PSILI	GREEK SMALL LETTER OMICRON WITH PSILI
0x1F41, 0x1F49, //GREEK CAPITAL LETTER OMICRON WITH DASIA	GREEK SMALL LETTER OMICRON WITH DASIA
0x1F42, 0x1F4A, //GREEK CAPITAL LETTER OMICRON WITH PSILI AND VARIA	GREEK SMALL LETTER OMICRON WITH PSILI AND VARIA
0x1F43, 0x1F4B, //GREEK CAPITAL LETTER OMICRON WITH DASIA AND VARIA	GREEK SMALL LETTER OMICRON WITH DASIA AND VARIA
0x1F44, 0x1F4C, //GREEK CAPITAL LETTER OMICRON WITH PSILI AND OXIA	GREEK SMALL LETTER OMICRON WITH PSILI AND OXIA
0x1F45, 0x1F4D, //GREEK CAPITAL LETTER OMICRON WITH DASIA AND OXIA	GREEK SMALL LETTER OMICRON WITH DASIA AND OXIA
0x1F51, 0x1F59, //GREEK CAPITAL LETTER UPSILON WITH OASIS	GREEK SMALL LETTER UPSILON WITH DASIA
0x1F53, 0x1F5B, //GREEK CAPITAL LETTER UPSILON WITH DASIA AND VARIA	GREEK SMALL LETTER UPSILON WITH DASIA AND VARIA
0x1F55, 0x1F5D, //GREEK CAPITAL LETTER UPSILON WITH DASIA AND OXIA	GREEK SMALL LETTER UPSILON WITH DASIA AND OXIA
0x1F57, 0x1F5F, //GREEK CAPITAL LETTER UPSILON WITH DASIA AND PERISPOMENI	GREEK SMALL LETTER UPSILON WITH DASIA AND PERISPOMENI
0x1F60, 0x1F68, //GREEK CAPITAL LETTER OMEGA WITH PSILI	GREEK SMALL LETTER OMEGA WITH PSILI
0x1F61, 0x1F69, //GREEK CAPITAL LETTER OMEGA WITH DASIA	GREEK SMALL LETTER OMEGA WITH DASIA
0x1F62, 0x1F6A, //GREEK CAPITAL LETTER OMEGA WITH PSILI AND VARIA	GREEK SMALL LETTER OMEGA WITH PSILI AND VARIA
0x1F63, 0x1F6B, //GREEK CAPITAL LETTER OMEGA WITH DASIA AND VARIA	GREEK SMALL LETTER OMEGA WITH DASIA AND VARIA
0x1F64, 0x1F6C, //GREEK CAPITAL LETTER OMEGA WITH PSILI AND OXIA	GREEK SMALL LETTER OMEGA WITH PSILI AND OXIA
0x1F65, 0x1F6D, //GREEK CAPITAL LETTER OMEGA WITH DASIA AND OXIA	GREEK SMALL LETTER OMEGA WITH DASIA AND OXIA
0x1F66, 0x1F6E, //GREEK CAPITAL LETTER OMEGA WITH PSILI AND PERISPOMENI	GREEK SMALL LETTER OMEGA WITH PSILI AND PERISPOMENI
0x1F67, 0x1F6F, //GREEK CAPITAL LETTER OMEGA WITH DASIA AND PERISPOMENI	GREEK SMALL LETTER OMEGA WITH DASIA AND PERISPOMENI
0x1F80, 0x1F88, //GREEK CAPITAL LETTER ALPHA WITH PSILI AND PROSGEGRAMMENI	GREEK SMALL LETTER ALPHA WITH PSILI AND YPOGEGRAMMENI
0x1F81, 0x1F89, //GREEK CAPITAL LETTER ALPHA WITH DASIA AND PROSGEGRAMMENI	GREEK SMALL LETTER ALPHA WITH DASIA AND YPOGEGRAMMENI
0x1F82, 0x1F8A, //GREEK CAPITAL LETTER ALPHA WITH PSILI AND VARIA AND PROSGEGRAMMENI	GREEK SMALL LETTER ALPHA WITH PSILI AND VARIA AND YPOGEGRAMMENI
0x1F83, 0x1F8B, //GREEK CAPITAL LETTER ALPHA WITH DASIA AND VARIA AND PROSGEGRAMMENI	GREEK SMALL LETTER ALPHA WITH DASIA AND VARIA AND YPOGEGRAMMENI
0x1F84, 0x1F8C, //GREEK CAPITAL LETTER ALPHA WITH PSILI AND OXIA AND PROSGEGRAMMEN	GREEK SMALL LETTER ALPHA WITH PSILI AND OXIA AND YPOGEGRAMMENI
0x1F85, 0x1F8D, //GREEK CAPITAL LETTER ALPHA WITH DASIA AND OXIA AND PROSGEGRAMMEN	GREEK SMALL LETTER ALPHA WITH DASIA AND OXIA AND YPOGEGRAMMENI
0x1F86, 0x1F8E, //GREEK CAPITAL LETTER ALPHA WITH PSILI AND PERISPOMENI AND PROSGEGRAMMENI	GREEK SMALL LETTER ALPHA WITH PSILI AND PERISPOMENI AND YPOGEGRAMMENI
0x1F87, 0x1F8F, //GREEK CAPITAL LETTER ALPHA WITH DASIA AND PERISPOMENI AND PROSGEGRAMMENI	GREEK SMALL LETTER ALPHA WITH DASIA AND PERISPOMENI AND YPOGEGRAMMENI
0x1F90, 0x1F98, //GREEK CAPITAL LETTER ETA WITH PSILI AND PROSGEGRAMMENI	GREEK SMALL LETTER ETA WITH PSILI AND YPOGEGRAMMENI
0x1F91, 0x1F99, //GREEK CAPITAL LETTER ETA WITH DASIA AND PROSGEGRAMMENI	GREEK SMALL LETTER ETA WITH DASIA AND YPOGEGRAMMENI
0x1F92, 0x1F9A, //GREEK CAPITAL LETTER ETA WITH PSILI AND VARIA AND PROSGEGRAMMENI	GREEK SMALL LETTER ETA WITH PSILI AND VARIA AND YPOGEGRAMMENI
0x1F93, 0x1F9B, //GREEK CAPITAL LETTER ETA WITH DASIA AND VARIA AND PROSGEGRAMMENI	GREEK SMALL LETTER ETA WITH DASIA AND VARIA AND YPOGEGRAMMENI
0x1F94, 0x1F9C, //GREEK CAPITAL LETTER ETA WITH PSILI AND OXIA AND PROSGEGRAMMENI	GREEK SMALL LETTER ETA WITH PSILI AND OXIA AND YPOGEGRAMMENI
0x1F95, 0x1F9D, //GREEK CAPITAL LETTER ETA WITH DASIA AND OXIA AND PROSGEGRAMMENI	GREEK SMALL LETTER ETA WITH DASIA AND OXIA AND YPOGEGRAMMENI
0x1F96, 0x1F9E, //GREEK CAPITAL LETTER ETA WITH PSILI AND PERISPOMENI AND PROSGEGRAMMENI	GREEK SMALL LETTER ETA WITH PSILI AND PERISPOMENI AND YPOGEGRAMMENI
0x1F97, 0x1F9F, //GREEK CAPITAL LETTER ETA WITH DASIA AND PERISPOMENI AND PROSGEGRAMMENI	GREEK SMALL LETTER ETA WITH DASIA AND PERISPOMENI AND YPOGEGRAMMENI
0x1FA0, 0x1FA8, //GREEK CAPITAL LETTER OMEGA WITH PSILI AND PROSGEGRAMMENI	GREEK SMALL LETTER OMEGA WITH PSILI AND YPOGEGRAMMENI
0x1FA1, 0x1FA9, //GREEK CAPITAL LETTER OMEGA WITH DASIA AND PROSGEGRAMMENI	GREEK SMALL LETTER OMEGA WITH DASIA AND YPOGEGRAMMENI
0x1FA2, 0x1FAA, //GREEK CAPITAL LETTER OMEGA WITH PSILI AND VARIA AND PROSGEGRAMMENI	GREEK SMALL LETTER OMEGA WITH PSILI AND VARIA AND YPOGEGRAMMENI
0x1FA3, 0x1FAB, //GREEK CAPITAL LETTER OMEGA WITH DASIA AND VARIA AND PROSGEGRAMMENI	GREEK SMALL LETTER OMEGA WITH DASIA AND VARIA AND YPOGEGRAMMENI
0x1FA4, 0x1FAC, //GREEK CAPITAL LETTER OMEGA WITH PSILI AND OXIA AND PROSGEGRAMMENI	GREEK SMALL LETTER OMEGA WITH PSILI AND OXIA AND YPOGEGRAMMENI
0x1FA5, 0x1FAD, //GREEK CAPITAL LETTER OMEGA WITH DASIA AND OXIA AND PROSGEGRAMMENI	GREEK SMALL LETTER OMEGA WITH DASIA AND OXIA AND YPOGEGRAMMENI
0x1FA6, 0x1FAE, //GREEK CAPITAL LETTER OMEGA WITH PSILI AND PERISPOMENI AND PROSGEGRAMMENI	GREEK SMALL LETTER OMEGA WITH PSILI AND PERISPOMENI AND YPOGEGRAMMENI
0x1FA7, 0x1FAF, //GREEK CAPITAL LETTER OMECA WITH DASIA AND PERISPOMENI AND PROSGEGRAMMENI	GREEK SMALL LETTER OMEGA WITH DASIA AND PEPISPOMENI AND YPOGEGRAMMENI
0x1FB0, 0x1FB8, //GREEK CAPITAL LETTER ALPHA WITH VRACHY	GREEK SMALL LETTER ALPHA WITH VRACHY
0x1FB1, 0x1FB9, //GREEK CAPITAL LETTER ALPHA WITH MACRON	GREEK SMALL LETTER ALPHA WITH MACRON
0x1FD0, 0x1FD8, //GREEK CAPITAL LETTER IOTA WITH VRACHY	GREEK SMALL LETTER IOTA WITH VRACHY
0x1FD1, 0x1FD9, //GREEK CAPITAL LETTER IOTA WITH MACRON	GREEK SMALL LETTER IOTA WITH MACRON
0x1FE0, 0x1FE8, //GREEK CAPITAL LETTER UPSILON WITH VRACHY	GREEK SMALL LETTER UPSILON WITH VRACHY
0x1FE1, 0x1FE9, //GREEK CAPITAL LETTER UPSILON WITH MACRON	GREEK SMALL LETTER UPSILON WITH MACRON
0x24D0, 0x24B6, //CIRCLED LATIN CAPITAL LETTER A	CIRCLED LATIN SMALL LETTER A
0x24D1, 0x24B7, //CIRCLED LATIN CAPITAL LETTER B	CIRCLED LATIN SMALL LETTER B
0x24D2, 0x24B8, //CIRCLED LATIN CAPITAL LETTER C	CIRCLED LATIN SMALL LETTER C
0x24D3, 0x24B9, //CIRCLED LATIN CAPITAL LETTER D	CIRCLED LATIN SMALL LETTER D
0x24D4, 0x24BA, //CIRCLED LATIN CAPITAL LETTER E	CIRCLED LATIN SMALL LETTER E
0x24D5, 0x24BB, //CIRCLED LATIN CAPITAL LETTER F	CIRCLED LATIN SMALL LETTER F
0x24D6, 0x24BC, //CIRCLED LATIN CAPITAL LETTER G	CIRCLED LATIN SMALL LETTER G
0x24D7, 0x24BD, //CIRCLED LATIN CAPITAL LETTER H	CIRCLED LATIN SMALL LETTER H
0x24D8, 0x24BE, //CIRCLED LATIN CAPITAL LETTER I	CIRCLED LATIN SMALL LETTER I
0x24D9, 0x24BF, //CIRCLED LATIN CAPITAL LETTER J	CIRCLED LATIN SMALL LETTER J
0x24DA, 0x24C0, //CIRCLED LATIN CAPITAL LETTER K	CIRCLED LATIN SMALL LETTER K
0x24DB, 0x24C1, //CIRCLED LATIN CAPITAL LETTER L	CIRCLED LATIN SMALL LETTER L
0x24DC, 0x24C2, //CIRCLED LATIN CAPITAL LETTER M	CIRCLED LATIN SMALL LETTER M
0x24DD, 0x24C3, //CIRCLED LATIN CAPITAL LETTER N	CIRCLED LATIN SMALL LETTER N
0x24DE, 0x24C4, //CIRCLED LATIN CAPITAL LETTER O	CIRCLED LATIN SMALL LETTER O
0x24DF, 0x24C5, //CIRCLED LATIN CAPITAL LETTER P	CIRCLED LATIN SMALL LETTER P
0x24E0, 0x24C6, //CIRCLED LATIN CAPITAL LETTER Q	CIRCLED LATIN SMALL LETTER Q
0x24E1, 0x24C7, //CIRCLED LATIN CAPITAL LETTER R	CIRCLED LATIN SMALL LETTER R
0x24E2, 0x24C8, //CIRCLED LATIN CAPITAL LETTER S	CIRCLED LATIN SMALL LETTER S
0x24E3, 0x24C9, //CIRCLED LATIN CAPITAL LETTER T	CIRCLED LATIN SMALL LETTER T
0x24E4, 0x24CA, //CIRCLED LATIN CAPITAL LETTER U	CIRCLED LATIN SMALL LETTER U
0x24E5, 0x24CB, //CIRCLED LATIN CAPITAL LETTER V	CIRCLED LATIN SMALL LETTER V
0x24E6, 0x24CC, //CIRCLED LATIN CAPITAL LETTER W	CIRCLED LATIN SMALL LETTER W
0x24E7, 0x24CD, //CIRCLED LATIN CAPITAL LETTER X	CIRCLED LATIN SMALL LETTER X
0x24E8, 0x24CE, //CIRCLED LATIN CAPITAL LETTER Y	CIRCLED LATIN SMALL LETTER Y
0x24E9, 0x24CF, //CIRCLED LATIN CAPITAL LETTER Z	CIRCLED LATIN SMALL LETTER Z
0xFF41, 0xFF21, //FULLWIDTH LATIN CAPITAL LETTER A	FULLWIDTH LATIN SMALL LETTER A
0xFF42, 0xFF22, //FULLWIDTH LATIN CAPITAL LETTER B	FULLWIDTH LATIN SMALL LETTER B
0xFF43, 0xFF23, //FULLWIDTH LATIN CAPITAL LETTER C	FULLWIDTH LATIN SMALL LETTER C
0xFF44, 0xFF24, //FULLWIDTH LATIN CAPITAL LETTER D	FULLWIDTH LATIN SMALL LETTER D
0xFF45, 0xFF25, //FULLWIDTH LATIN CAPITAL LETTER E	FULLWIDTH LATIN SMALL LETTER E
0xFF46, 0xFF26, //FULLWIDTH LATIN CAPITAL LETTER F	FULLWIDTH LATIN SMALL LETTER F
0xFF47, 0xFF27, //FULLWIDTH LATIN CAPITAL LETTER G	FULLWIDTH LATIN SMALL LETTER G
0xFF48, 0xFF28, //FULLWIDTH LATIN CAPITAL LETTER H	FULLWIDTH LATIN SMALL LETTER H
0xFF49, 0xFF29, //FULLWIDTH LATIN CAPITAL LETTER I	FULLWIDTH LATIN SMALL LETTER I
0xFF4A, 0xFF2A, //FULLWIDTH LATIN CAPITAL LETTER J	FULLWIDTH LATIN SMALL LETTER J
0xFF4B, 0xFF2B, //FULLWIDTH LATIN CAPITAL LETTER K	FULLWIDTH LATIN SMALL LETTER K
0xFF4C, 0xFF2C, //FULLWIDTH LATIN CAPITAL LETTER L	FULLWIDTH LATIN SMALL LETTER L
0xFF4D, 0xFF2D, //FULLWIDTH LATIN CAPITAL LETTER M	FULLWIDTH LATIN SMALL LETTER M
0xFF4E, 0xFF2E, //FULLWIDTH LATIN CAPITAL LETTER N	FULLWIDTH LATIN SMALL LETTER N
0xFF4F, 0xFF2F, //FULLWIDTH LATIN CAPITAL LETTER O	FULLWIDTH LATIN SMALL LETTER O
0xFF50, 0xFF30, //FULLWIDTH LATIN CAPITAL LETTER P	FULLWIDTH LATIN SMALL LETTER P
0xFF51, 0xFF31, //FULLWIDTH LATIN CAPITAL LETTER Q	FULLWIDTH LATIN SMALL LETTER Q
0xFF52, 0xFF32, //FULLWIDTH LATIN CAPITAL LETTER R	FULLWIDTH LATIN SMALL LETTER R
0xFF53, 0xFF33, //FULLWIDTH LATIN CAPITAL LETTER S	FULLWIDTH LATIN SMALL LETTER S
0xFF54, 0xFF34, //FULLWIDTH LATIN CAPITAL LETTER T	FULLWIDTH LATIN SMALL LETTER T
0xFF55, 0xFF35, //FULLWIDTH LATIN CAPITAL LETTER U	FULLWIDTH LATIN SMALL LETTER U
0xFF56, 0xFF36, //FULLWIDTH LATIN CAPITAL LETTER V	FULLWIDTH LATIN SMALL LETTER V
0xFF57, 0xFF37, //FULLWIDTH LATIN CAPITAL LETTER W	FULLWIDTH LATIN SMALL LETTER W
0xFF58, 0xFF38, //FULLWIDTH LATIN CAPITAL LETTER X	FULLWIDTH LATIN SMALL LETTER X
0xFF59, 0xFF39, //FULLWIDTH LATIN CAPITAL LETTER Y	FULLWIDTH LATIN SMALL LETTER Y
0xFF5A, 0xFF3A, //FULLWIDTH LATIN CAPITAL LETTER Z	FULLWIDTH LATIN SMALL LETTER Z
]
