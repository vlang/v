...
fn position_context(l &buffer.Lexer, line, col int) (context string) {
	for {
		c := l.Peek(0)
		if c == 0 && l.Err() != nil || c == '\n' || c == '\r' {
			break
	...
	context += print('    $line: $ellipsisFront' + string(b) + ellipsisRear + '\n')
	context += print('%s' + strings.repeat(` `, col+6) + '^')
	return
}
