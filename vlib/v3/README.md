...
in-process V3 driver. The standard bootstrap does not build the sibling `v1_fallback`
...
failure. On portable cross-VC builds, the V3 driver is not embedded and `cmd/v` retains the
