...
Groups:
- 01_stdlib_services.txt: crypto, db, net, veb, and x modules (82)
- 02_stdlib_other_and_tools.txt: cmd, examples, and other non-vlib/v modules (32)
- 03_v_compiler_infra.txt: vlib/v tests outside vlib/v/tests (31)
- 04_v_tests_generics.txt: vlib/v/tests generics and generic root tests (70)
- 05_v_tests_comptime_and_options.txt: comptime and option tests (50)
- 06_v_tests_fns_and_control_flow.txt: fns, conditions, loops, concurrency (14)
