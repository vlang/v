...
fn test_expand_veb_tr_shorthand_prefix_key_not_corrupted() {
	got := expand_veb_tr_shorthand('%title %title_long', 'ctx')
...
fn test_expand_veb_tr_shorthand_raw_prefix_key_not_corrupted() {
	got := expand_veb_tr_shorthand('%raw title %raw title_long', 'ctx')
...
fn test_expand_veb_tr_shorthand_repeated_key() {
	got := expand_veb_tr_shorthand('%title %title', 'ctx')
...
fn test_expand_veb_tr_shorthand_bare_percent_untouched() {
	assert expand_veb_tr_shorthand('100% done', 'ctx') == '100% done'
}

fn test_expand_veb_tr_shorthand_uses_request_context_binding() {
	got := expand_veb_tr_shorthand('%title', 'context')
	assert got == '@{veb.tr(context.lang.str(), "title")}'
}
