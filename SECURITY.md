...
**How to report:**
1. Please use GitHub's **Private Vulnerability Reporting** feature. Go to the [Security tab](https://github.com/vlang/v/security ) in this repository, click on **Advisories**, and select **Report a vulnerability**.
