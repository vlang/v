...
V *new_v(array_string args) {
  ...
  string v_path= os__getenv ( tos2("V_PATH") ) ;

  string default_v_path=string_add( os__home_dir ( ) , tos2("/code/v/") ) ;

  string lang_dir= (string_eq( v_path , tos2("") ) ) ? ( os__setenv ( tos2("V_PATH") , default_v_path , 0 ) ,  default_v_path ) : ( v_path ) ;
