// V_COMMIT_HASH d1f1c5a
// V_CURRENT_COMMIT_HASH 9d4697c
	...
	string.prototype = {
		...
		*/
		after(dot, s = this) {
			return new string((function() { 
				let result;result = 
				s.str.slice((function() { 
					let result;result = 
					s.str.lastIndexOf(dot.str);
				return result;
				})()
		...
		*/
		capitalize(s = this) {
			...
			const part = new string(new string((function() { 
				let result;result = 
				s.str.slice(1, new int(s.str.length));
			return result;
			})()
			.toString()));
			return new string((function() { 
		...
		*/
		count(substr, s = this) {
			...
			const arr = (function() { 
				let result;result = 
				s.str.split(substr.str);
			return result;
			})()
			;
			return (function() { 
				let result;result = 
				native_str_arr_len(arr);
			return result;
			})()
			;
		},
		...
		*/
		find_between(start, end, s = this) {
			return new string((function() { 
				...
				s.str.slice((function() { 
					let result;result = 
					s.str.indexOf(start.str);
				return result;
				})()
				, (function() { 
					let result;result = 
					s.str.indexOf(end.str);
				return result;
				})()
				 + new int(1));
			return result;
